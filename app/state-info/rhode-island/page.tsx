...
const data: StateData = {
  slug: "south-carolina",
  name: "South Carolina",
  pageTitle: "How to Form an LLC in South Carolina",
  metaDescription:
    "Form a South Carolina LLC for a $110 filing fee. No annual report required for standard LLCs. Complete cost breakdown and formation steps.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$110 (Articles of Organization)" },
    { label: "Processing time", value: "Expedited processing available for an additional fee" },
    { label: "State agency", value: "South Carolina Secretary of State" },
    { label: "Annual report due", value: "Not required for LLCs taxed as partnerships or disregarded entities" },
    { label: "State tax rate", value: "No LLC-level state income tax; individual members taxed at graduated rates (1.99%–5.21% as of 2026 reform)" },
  ],
  introHeading: "How to form an LLC in South Carolina",
  introParagraphs: [
    "South Carolina is one of only a handful of states that doesn't require LLCs to file annual reports. Combined with no franchise tax, the only ongoing state obligations are maintaining a registered agent and paying income taxes. You'll need to file as an LLC with the South Carolina Secretary of State and pay a filing fee when you first formally form your business.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Your LLC name must include "Limited Liability Company," "LLC," or "L.L.C." and be distinguishable from every business already registered or reserved with the Secretary of State. You can reserve a name for 120 days for a $25 fee.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every LLC in South Carolina is required to have a registered agent with a physical street address in the state, present during business hours to receive important documents.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "File your Articles of Organization with the South Carolina Secretary of State using the Business Entities Online system. The state filing fee is $110. South Carolina allows you to pay an expedited fee if you need your LLC formed more quickly.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "Every LLC in the U.S. should obtain a unique EIN from the Internal Revenue Service. You'll use it when you open a business bank account, file taxes, and pay employees.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "No annual report for most LLCs",
      paragraphs: [
        "For the State of South Carolina, LLCs are not required to file an annual report every year — unless you have an LLC that has elected to be taxed as an S Corp or C Corp. In that case, you're required to complete and file the appropriate SC-1120 or SC-1120S form once a year with the Department of Revenue to remain compliant.",
      ],
    },
    {
      heading: "Retail License and business taxes",
      paragraphs: [
        "If your LLC sells tangible goods, you'll need a Retail License from the South Carolina Department of Revenue — a one-time $50 fee that doesn't expire. South Carolina's statewide sales and use tax is 6%, with counties able to add local sales taxes on top.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in South Carolina?",
      a: "The South Carolina Articles of Organization filing fee is $110, paid to the Secretary of State. This is a one-time formation fee — since South Carolina doesn't require an annual report for most LLCs, there's no recurring state filing fee after formation.",
    },
    {
      q: "Does South Carolina require an annual report for LLCs?",
      a: "No, not for LLCs taxed as partnerships or disregarded entities. South Carolina is one of only a handful of states that doesn't require LLCs to file annual reports, biennial reports, or periodic statements with the Secretary of State.",
    },
    {
      q: "Does South Carolina charge a franchise tax for LLCs?",
      a: "No. South Carolina does not impose a franchise tax on LLCs. LLCs that elect C Corporation status do owe an annual corporate License Fee — 0.1% of capital and paid-in surplus plus $15, with a minimum of $25 per year.",
    },
    {
      q: "Does a South Carolina LLC need a registered agent?",
      a: "Yes. Every LLC in South Carolina is required to have a registered agent with a physical South Carolina street address, appointed when you file your Articles of Organization.",
    },
    {
      q: "Does South Carolina require a Retail License?",
      a: "If your LLC sells tangible goods, yes — you'll need a Retail License from the South Carolina Department of Revenue before your first taxable sale. It's a one-time $50 fee that does not expire.",
    },
    {
      q: "How do I register a DBA in South Carolina?",
      a: "South Carolina handles DBA (fictitious name) registration at the county level, not through the Secretary of State. You'll file with the Register of Deeds in the county where your business operates.",
    },
  ],
};

export default function SouthCarolinaLLCPage() {
  return (
    <NavigationWrapper>
