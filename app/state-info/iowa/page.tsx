...
const data: StateData = {
  slug: "iowa",
  name: "Iowa",
  pageTitle: "Iowa LLC Filing Fees and Requirements",
  metaDescription:
    "Forming an LLC in Iowa costs $50 to file a Certificate of Organization with the Iowa Secretary of State. Learn about the biennial report and other requirements.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$50 (Certificate of Organization)" },
    { label: "Processing time", value: "Filed online through the Fast Track Filing system; typically fast" },
    { label: "State agency", value: "Iowa Secretary of State" },
    {
      label: "Annual report due",
      value: "Biennial report every odd-numbered year, due January 1–April 1; $30 online / $45 by paper",
    },
    {
      label: "State tax rate",
      value: "No state-level LLC franchise tax; Iowa's flat individual income tax rate applies to pass-through profits",
    },
  ],
  introHeading: "How to form an LLC in Iowa",
  introParagraphs: [
    "Your Certificate of Organization can be filed online using Iowa's Fast Track Filing system. The Iowa Secretary of State has set up this system for all business entity filings, so you'll need to create an account to file any business-related forms and documents. The Iowa LLC filing fee is $50.",
    "You only need to file your Certificate of Organization once, but you must file a biennial report every odd year, as dictated by Iowa Legislature.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        "You'll need a distinctive and original name for your LLC that isn't used by any other business in the state. Once you've chosen a name, check availability through the Iowa Secretary of State's business search before you file.",
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every LLC in Iowa is required to have a registered agent — someone who receives official legal and tax correspondence and is responsible for filing reports with the Iowa Secretary of State. If your registered agent is a person, they must have a physical street address in Iowa and be present during business hours.",
      ],
    },
    {
      title: "File your Certificate of Organization",
      body: [
        "File your Certificate of Organization online through Iowa's Fast Track Filing system. Unlike most states, Iowa doesn't provide an official document for LLC owners to fill out — you'll build the filing based on the requirements listed in state statute. The state filing fee is $50, the same whether filed online or by mail.",
      ],
    },
    {
      title: "Get your EIN",
  ...
  extraSections: [
    {
      heading: "Biennial report requirements",
      paragraphs: [
        "All LLCs in Iowa must file biennial reports with the state every 2 years, in odd-numbered years. The filing fee is $30 if filed online through Fast Track Filing, or $45 if submitted by paper. The filing window opens January 1 and closes April 1.",
        "There's no official biennial report document to fill out for paper filers — you'll need to draft your own report using the guidelines provided in state statute. Missed reports can lead to administrative dissolution under Iowa law.",
      ],
    },
    {
      heading: "Business licenses in Iowa",
      paragraphs: [
        "Iowa doesn't have a general statewide business license requirement. What you need depends on the industry your LLC operates in and where it's located — check with your city or county for local permit requirements.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Iowa?",
      a: "The Iowa LLC filing fee is $50 for the Certificate of Organization, the same price online or by mail. After formation, the biennial report costs $30 online or $45 by paper, filed every odd-numbered year.",
    },
    {
      q: "Does Iowa require an annual report for LLCs?",
      a: "Iowa requires a biennial report rather than an annual one — filed once every odd year. The filing fee is $30 online or $45 by paper, due between January 1 and April 1.",
    },
    {
      q: "Does Iowa charge a franchise tax for LLCs?",
      a: "No. Iowa does not impose a state-level LLC franchise tax. Iowa's flat individual income tax rate applies to pass-through income that flows to LLC members' personal returns.",
    },
    {
      q: "Does an Iowa LLC need a registered agent?",
      a: "Yes. Every LLC in Iowa is required to have a registered agent with a physical street address in Iowa, available during business hours to receive legal correspondence on the LLC's behalf.",
    },
    {
      q: "What happens if I miss Iowa's biennial report deadline?",
      a: "Missed biennial reports can lead to administrative dissolution under Iowa law. Reinstatement is possible but requires filing the past-due report and paying a $5 reinstatement fee, so it's worth tracking the January 1–April 1 filing window each odd year.",
    },
    {
      q: "How do I file an Iowa LLC name change?",
      a: "You can file an amendment with the Iowa Secretary of State to update your LLC's legal name. Check name availability through the state's business search tool first to make sure your new name doesn't conflict with an existing entity.",
    },
  ],
};

export default function IowaLLCPage() {
  return (
    <NavigationWrapper>
