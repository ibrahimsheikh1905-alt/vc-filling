...
const data: StateData = {
  slug: "minnesota",
  name: "Minnesota",
  pageTitle: "Minnesota LLC Filing Fees and Requirements",
  metaDescription:
    "Forming an LLC in Minnesota costs $135 if you file by mail or $155 if you file online or in person with the Minnesota Secretary of State.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$135 by mail or $155 online/in person (Articles of Organization)" },
    { label: "Processing time", value: "Online and in-person filings are treated as expedited" },
    { label: "State agency", value: "Minnesota Secretary of State" },
    { label: "Annual report due", value: "Annual renewal by December 31 each year; no state fee for active LLCs" },
    { label: "State tax rate", value: "No state-level LLC franchise tax; members pay Minnesota individual income tax on their share" },
  ],
  introHeading: "How to form an LLC in Minnesota",
  introParagraphs: [
    "To form a Minnesota LLC, you need to file Articles of Organization with the Minnesota Secretary of State under Minnesota Statutes Chapter 322C. The state fee depends on how you file: $135 by mail or $155 online or in person. Beyond the formation fee, Minnesota requires a registered agent with a physical in-state address, a free annual renewal filed by December 31 each year, and an Employer Identification Number (EIN) from the IRS.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Your LLC name must include an approved designator — "Limited Liability Company," "LLC," or "L.L.C." — and be distinguishable from every other business name already on file with the Minnesota Secretary of State. Run a name availability search through the state\'s online portal before you file.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every Minnesota LLC must designate a registered agent and maintain a registered office address in the state. A P.O. box alone does not satisfy this requirement — the address must be a physical street address in Minnesota. The agent must be available at the registered office during normal business hours.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "You can file online through the Secretary of State's business services portal, by mail, or in person by appointment. Online filing costs $155 and is treated as expedited; mail filing costs $135. Most entrepreneurs file online since the fee difference is modest and it's faster.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "Every LLC needs an Employer Identification Number (EIN) from the IRS. You'll use your EIN to open a business bank account, file federal taxes, and hire employees. You can apply for an EIN at no cost directly through the IRS website.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "Annual renewal requirements",
      paragraphs: [
        "Minnesota requires all LLCs — domestic and foreign — to file an annual renewal with the Secretary of State to stay in good standing. The renewal is due by December 31 each year. There's no state fee to file the annual renewal as long as your LLC is active. Missing the December 31 deadline can put your LLC's active status at risk.",
      ],
    },
    {
      heading: "Business licenses in Minnesota",
      paragraphs: [
        "Forming your LLC with the Secretary of State is separate from getting the licenses and permits you need to operate. Common sources for Minnesota business licenses include the Department of Revenue for sales tax permits, relevant state licensing boards, and your city or county for local business licenses.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Minnesota?",
      a: "The Minnesota state filing fee is $135 if you file by mail, or $155 if you file online or in person (treated as expedited). After formation, the annual renewal is free as long as your LLC stays active.",
    },
    {
      q: "Does Minnesota require an annual report for LLCs?",
      a: "Minnesota requires an annual renewal rather than a paid annual report. It's due by December 31 each year and there's no state fee for active LLCs — you just need to confirm your information is current.",
    },
    {
      q: "Does Minnesota require an operating agreement?",
      a: "No. You're not legally required to have an LLC Operating Agreement in Minnesota, but creating one can be extremely helpful for keeping your business organized and prepared for future events.",
    },
    {
      q: "Does a Minnesota LLC need a registered agent?",
      a: "Yes. Every Minnesota LLC must designate a registered agent with a physical Minnesota street address, available during normal business hours to receive legal documents on the LLC's behalf.",
    },
    {
      q: "How do I register a foreign LLC in Minnesota?",
      a: "File the Certificate of Authority to Transact Business in Minnesota form with the Secretary of State and pay a $205 filing fee.",
    },
    {
      q: "Does Minnesota charge a franchise tax for LLCs?",
      a: "No. In Minnesota, C Corporations are required to pay a Corporation Franchise Tax, but LLCs are exempt from this tax unless they elect to file as C Corporations.",
    },
  ],
};

export default function MinnesotaLLCPage() {
  return (
    <NavigationWrapper>
