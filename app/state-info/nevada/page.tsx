...
const data: StateData = {
  slug: "nevada",
  name: "Nevada",
  pageTitle: "Nevada LLC Filing Requirements & Fees",
  metaDescription:
    "Total Nevada LLC formation cost is $425: $75 Articles of Organization, $150 Initial List of Managers, and $200 State Business License. $350 recurring annually.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$425 total ($75 Articles of Organization + $150 Initial List + $200 State Business License)" },
    { label: "Processing time", value: "Most online transactions processed the same day through SilverFlume" },
    { label: "State agency", value: "Nevada Secretary of State (SilverFlume portal)" },
    { label: "Annual report due", value: "Annual List + Business License renewal by anniversary month; $350 total" },
    { label: "State tax rate", value: "No state personal or corporate income tax; Commerce Tax applies only above $4M in Nevada gross revenue" },
  ],
  introHeading: "How to form an LLC in Nevada",
  introParagraphs: [
    "Your Nevada Articles of Organization can be filed online with Nevada SilverFlume, the state's unified business portal. The Nevada LLC filing fee is $75. Your initial annual report (which the state refers to as the \"initial list\" of members or managers) and Nevada business license are also filed with your Articles of Organization for additional fees of $150 and $200, respectively — bringing the total formation cost to $425.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'You\'ll need a distinctive and original name for your LLC that\'s not used by any other business in the state. Nevada restricts the use of certain words, such as "engineer" or "professional engineer," unless you get approval from the relevant state board first.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every LLC in Nevada is required to have a registered agent — a person or entity who receives official legal and tax correspondence on the LLC's behalf. If your registered agent is a person, they must reside and have a physical street address in Nevada.",
      ],
    },
    {
      title: "File Articles of Organization, Initial List, and Business License",
      body: [
        "File all 3 together through SilverFlume: Articles of Organization ($75), Initial List of Managers or Managing Members ($150), and the State Business License ($200). Most transactions are processed the same day. Because processing is so fast, Nevada doesn't offer an additional expedited filing option.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "You'll need an EIN to identify your business to the IRS. You use this number when filing and paying taxes or submitting payroll information. You can obtain one directly from the IRS at no cost.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "Annual List and Business License renewal",
      paragraphs: [
        "You only need to file your Articles of Organization once, but every year after, you must file an Annual List and renew your state business license. Together these cost $350 per year, due by the last day of the LLC's anniversary month — one of the higher recurring costs among all states.",
      ],
    },
    {
      heading: "Why Nevada LLCs cost more to maintain",
      paragraphs: [
        "Nevada is known for strong privacy protections and no state income tax, which is why some business owners choose it even without operating there. But a Nevada LLC with no employees or Nevada operations still owes $350 every year for the Annual List and Business License renewal — a meaningful ongoing cost compared to states like Wyoming or Missouri.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Nevada?",
      a: "Total Nevada LLC formation cost is $425: $75 for the Articles of Organization, $150 for the Initial List of Managers or Members, and $200 for the State Business License, all filed together. After that, the recurring annual cost is $350.",
    },
    {
      q: "Does Nevada require an annual report for LLCs?",
      a: "Yes. Nevada requires an Annual List (its version of an annual report) plus a Business License renewal each year, due by the last day of the LLC's anniversary month. Together these cost $350 per year.",
    },
    {
      q: "Does Nevada have a state income tax?",
      a: "No. Nevada has no state personal income tax and no state corporate income tax. Nevada does have a Commerce Tax that applies only to businesses with Nevada gross revenue exceeding $4 million per year.",
    },
    {
      q: "Does a Nevada LLC need a registered agent?",
      a: "Yes. Every LLC in Nevada is required to have a registered agent with a physical Nevada street address, appointed when you file your Articles of Organization.",
    },
    {
      q: "Does Nevada allow Series LLCs?",
      a: "Yes. To form a Series LLC in Nevada, fill out the domestic Articles of Organization form indicating that it's a Series LLC and file it with the Secretary of State. The fee is $75, the same as a standard LLC.",
    },
    {
      q: "How do I register a foreign LLC in Nevada?",
      a: "File an Application for Registration as a Foreign LLC, which requires the $75 filing fee, a $150 Initial List, and a $200 State Business License ($425 all-in), plus a Certificate of Existence from your home state dated within 90 days and a Nevada registered agent.",
    },
  ],
};

export default function NevadaLLCPage() {
  return (
    <NavigationWrapper>
