...
const data: StateData = {
  slug: "kansas",
  name: "Kansas",
  pageTitle: "Kansas LLC Filing Fees and Requirements",
  metaDescription:
    "Forming an LLC in Kansas costs $160 online or $165 by mail. Learn the fees, forms, resident agent rules, biennial report deadlines, and tax requirements.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$160 online or $165 by mail (Articles of Organization)" },
    { label: "Processing time", value: "Immediate for online filings; 2–3 business days by mail" },
    { label: "State agency", value: "Kansas Secretary of State" },
    {
      label: "Annual report due",
      value: "Biennial Information Report by April 15 (odd or even year matching your formation year); $50 fee",
    },
    {
      label: "State tax rate",
      value: "No state franchise tax; Kansas individual income tax (3.1%–5.7%) applies to pass-through income",
    },
  ],
  introHeading: "How to form an LLC in Kansas",
  introParagraphs: [
    "Forming an LLC in Kansas requires filing Articles of Organization with the Kansas Secretary of State, paying a state filing fee of $160 online or $165 by mail, designating a resident agent with a Kansas street address, and meeting ongoing requirements that include a biennial Information Report. Kansas has no state franchise tax, which keeps the long-term cost of staying in good standing lower than in many other states.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Your LLC\'s name must be distinguishable from all other business entities on file with the Kansas Secretary of State. Check availability using the Name Availability search tool before you file. Kansas law requires the name to include a word of formation — "Limited Liability Company," "LLC," or "L.L.C."',
      ],
    },
    {
      title: "Appoint a resident agent",
      body: [
        'Every Kansas LLC must maintain a registered agent — called a "resident agent" in Kansas — with a physical street address in the state. A P.O. box does not satisfy this requirement. You can serve as your own resident agent, or use a professional registered agent service.',
      ],
    },
    {
      title: "File Articles of Organization",
      body: [
        "File Articles of Organization (form DL) with the Kansas Secretary of State. Online filing costs $160 and is processed immediately. Mailing a paper form costs $165 and adds 2–3 business days to processing after the state receives it.",
        "The form asks for your LLC's legal name, the name and Kansas street address of your resident agent, your principal office mailing address, and whether the LLC will be member-managed or manager-managed.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "An Employer Identification Number (EIN) is a federal tax ID issued by the IRS. You'll need one to open a business bank account, hire employees, and file federal and state taxes. The IRS issues EINs at no cost through its online application.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "Biennial Information Report",
      paragraphs: [
        ...
        "The switch from annual to biennial reporting is one of the things that catches Kansas LLC owners off guard — especially those who formed their business before the change took effect.",
      ],
    },
    {
      heading: "Series LLCs in Kansas",
      paragraphs: [
        "Kansas allows the formation of Series LLCs. To form one, file the Series LLC Articles of Organization form along with a Certificate of Designation for each series with the Secretary of State. The fee is $165 plus $35 for each series established.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Kansas?",
      a: "The Kansas state filing fee is $160 if you file online, or $165 if you file a paper form. After formation, the biennial Information Report costs $50, filed every 2 years by April 15.",
    },
    {
      q: "Does Kansas require an annual report for LLCs?",
      a: "No — Kansas replaced the annual report with a biennial Information Report starting with filings in 2024. For-profit LLCs file every 2 years by April 15, with the exact cycle (odd or even years) determined by when the LLC was formed.",
    },
    {
      q: "Does Kansas allow expedited LLC processing?",
      a: "Kansas doesn't offer a separate expedited processing option because online filings are already processed immediately. Because of this fast online process, there's no premium rush fee like in some other states.",
    },
    {
      q: "Does a Kansas LLC need a resident agent?",
      a: 'Yes. Every Kansas LLC must maintain what the state calls a "resident agent" — equivalent to a registered agent in other states — with a physical Kansas street address. A P.O. box doesn\'t satisfy the requirement.',
    },
    {
      q: "Does Kansas allow Series LLCs?",
      a: "Yes. Kansas allows the formation of Series LLCs. You file a Series LLC Articles of Organization form along with a Certificate of Designation for each series, with a total fee of $165 plus $35 per series.",
    },
    {
      q: "Does Kansas charge a franchise tax for LLCs?",
      a: "No. Kansas has no state-level LLC franchise tax. Kansas individual income tax, ranging from 3.1% to 5.7% depending on income, applies to the pass-through profits that flow to LLC members.",
    },
  ],
};

export default function KansasLLCPage() {
  return (
    <NavigationWrapper>
