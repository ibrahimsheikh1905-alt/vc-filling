...
const data: StateData = {
  slug: "michigan",
  name: "Michigan",
  pageTitle: "Michigan LLC Filing Fees and Requirements",
  metaDescription:
    "Forming an LLC in Michigan costs $50 to file Articles of Organization with LARA. Learn the fees, annual statement requirements, and registered agent rules.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$50 (Articles of Organization, Form CSCL/CD-700)" },
    { label: "Processing time", value: "Standard processing; expedited options available for a rush fee" },
    { label: "State agency", value: "Michigan Department of Licensing and Regulatory Affairs (LARA)" },
    { label: "Annual report due", value: "Annual statement by February 15 each year; $25 fee" },
    { label: "State tax rate", value: "Michigan flat individual income tax rate: 4.25% on pass-through LLC income" },
  ],
  introHeading: "How to form an LLC in Michigan",
  introParagraphs: [
    "Forming an LLC in Michigan requires filing Articles of Organization (form CSCL/CD-700) with the Michigan Department of Licensing and Regulatory Affairs (LARA) and paying a $50 state filing fee. After formation, Michigan LLCs must file an annual statement by February 15 each year for $25 and maintain a resident agent with a Michigan street address.",
    "Michigan's $50 formation fee is one of the lower state fees in the country, which makes it a relatively affordable state to get started in.",
  ],
  steps: [
    {
      title: "File Articles of Organization",
      body: [
        "You can file online through LARA's MiBusiness Registry Portal or by mailing a paper form. The state filing fee is $50, and Michigan allows you to pay a rush fee if you want your LLC formed more quickly.",
      ],
    },
    {
      title: "Appoint a resident agent",
      body: [
        "Michigan calls this role a resident agent rather than a registered agent, but the function is the same: your LLC must designate someone to receive legal documents and official state correspondence on its behalf. The resident agent must have a physical Michigan street address — a P.O. box doesn't qualify.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "Every Michigan LLC needs an Employer Identification Number (EIN) from the IRS. You'll use it to open a business bank account, file federal and state taxes, and pay employees. The IRS issues EINs at no cost and you can get your number the same day online.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "Annual statement requirements",
      paragraphs: [
        "Michigan LLCs must file an annual statement with LARA each year by February 15. The filing fee is $25. Online filing opens October 15, so you can file early and get it off your plate before the deadline.",
        "One thing that catches people off guard: if your LLC was formed or qualified after September 30, you don't have to file an annual statement on the February 15 immediately following formation. Your first annual statement is due the February 15 after that.",
      ],
    },
    {
      heading: "Foreign LLC registration in Michigan",
      paragraphs: [
        "If your LLC is formed in another state but you want to do business in Michigan, you need to register as a foreign LLC with LARA using a separate Articles of Organization form for foreign LLCs. A foreign LLC registered in Michigan must also maintain a resident agent with a Michigan street address, the same as a domestic LLC.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Michigan?",
      a: "The Michigan state filing fee is $50 for Articles of Organization. After formation, the annual statement costs $25, due by February 15 each year.",
    },
    {
      q: "Does Michigan require an annual report for LLCs?",
      a: "Yes — Michigan calls it an annual statement rather than an annual report. It's due each year by February 15 for a $25 fee, filed through LARA's MiBusiness Registry Portal, which opens for filing on October 15.",
    },
    {
      q: "Does a Michigan LLC need a resident agent?",
      a: "Yes. Every Michigan LLC needs a resident agent — Michigan's term for a registered agent — with a physical Michigan street address to receive legal documents and official state correspondence.",
    },
    {
      q: "Does Michigan charge a franchise tax for LLCs?",
      a: "No single-entity franchise tax on LLCs. Michigan LLC members pay Michigan's 4.25% flat state income tax rate on their share of pass-through profits, in addition to federal taxes.",
    },
    {
      q: "How do I register a foreign LLC in Michigan?",
      a: "File a separate Articles of Organization form for foreign LLCs with LARA and designate a resident agent with a Michigan street address. The filing fee and requirements differ from domestic formation, so check LARA's current fee schedule before filing.",
    },
    {
      q: "Does Michigan have a general business license?",
      a: "No. Michigan doesn't issue a single general business license. Costs and requirements vary based on the type of license, the issuing agency, and your profession — check with your local municipality and any relevant state licensing board.",
    },
  ],
};

export default function MichiganLLCPage() {
  return (
    <NavigationWrapper>
