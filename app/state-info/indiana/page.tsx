...
const data: StateData = {
  slug: "indiana",
  name: "Indiana",
  pageTitle: "How to Start an LLC in Indiana",
  metaDescription:
    "Learn how to start an LLC in Indiana: Articles of Organization, the $95 online state filing fee, registered agent requirements, EIN, and biennial Business Entity Report deadlines.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$95 online or $100 by mail (Articles of Organization)" },
    { label: "Processing time", value: "Expedited processing available for an additional fee" },
    { label: "State agency", value: "Indiana Secretary of State, Business Services Division" },
    {
      label: "Annual report due",
      value: "Business Entity Report every 2 years (biennial) in the anniversary month of formation; $50 fee",
    },
    {
      label: "State tax rate",
      value: "Indiana corporate income tax rate is 4.9%; pass-through income taxed at individual rates",
    },
  ],
  introHeading: "How to start an LLC in Indiana",
  introParagraphs: [
    "To form an LLC in Indiana, you file Articles of Organization with the Indiana Secretary of State's Business Services Division through the INBiz portal and pay a $95 filing fee online, or $100 by mail. You'll also need a registered agent with an Indiana address, and you'll file a Business Entity Report every 2 years instead of annually.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Your LLC name must be distinguishable from other registered Indiana businesses and include "Limited Liability Company," "LLC," or "L.L.C." You can check name availability through the Secretary of State\'s business search before you file.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every Indiana LLC needs a registered agent with a physical Indiana street address — no P.O. boxes. Any individual at least 18 years old with a physical Indiana address can serve, or you can use a commercial registered agent service to keep your personal address off public records.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "Go to INBiz at inbiz.in.gov, or download the paper Articles of Organization form from the Indiana Secretary of State. Complete the form with your registered agent's full name and Indiana street address, then pay the state filing fee — $95 online or $100 by mail.",
      ],
    },
    {
      title: "Create an operating agreement",
      body: [
        "The State of Indiana doesn't require you to have an LLC Operating Agreement in place, but it's a document worth having. It covers how the business will be run, how managers and members are chosen, and the rights and duties of members.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "Every LLC in the U.S. should obtain a unique Employer Identification Number (EIN) from the IRS. You'll use it when you open a business bank account, file taxes, and pay employees. It's available at no cost directly from the IRS.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "Business Entity Report requirements",
      paragraphs: [
        "There is no Indiana annual report. Instead, the state requires businesses to file a Business Entity Report biennially (every other year) in the anniversary month of the business forming. The filing fee is $50. This report is also where you can confirm or update your registered agent and registered office information.",
      ],
    },
    {
      heading: "Business licenses in Indiana",
      paragraphs: [
        "As a business owner, it's your responsibility to make sure you have the proper state, federal, or local business licenses to operate your Indiana LLC. Requirements vary based on the industry your LLC operates in and its location.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Indiana?",
      a: "The Indiana state filing fee is $95 if you file online through INBiz, or $100 by mail. After formation, the Business Entity Report costs $50, filed every 2 years rather than annually.",
    },
    {
      q: "Does Indiana require an annual report for LLCs?",
      a: "No — Indiana requires a Business Entity Report every 2 years (biennial), not annually. The $50 fee is due in the anniversary month of the business forming, filed with the Indiana Secretary of State.",
    },
    {
      q: "Does an Indiana LLC need a registered agent?",
      a: "Yes. Every Indiana LLC must appoint a registered agent with a physical Indiana street address. Any individual at least 18 years old with an Indiana address can serve, or you can use a commercial registered agent service.",
    },
    {
      q: "Does Indiana require an operating agreement?",
      a: "No. The State of Indiana doesn't require you to have an LLC Operating Agreement in place, but having one is still worth doing since it covers how the business will be run and the rights and duties of members.",
    },
    {
      q: "How do I change my registered agent in Indiana?",
      a: "You can file a standalone Statement of Change of Registered Agent form, or update the agent information as part of your biennial Business Entity Report. If your agent changes between report due dates, it's better to file the standalone form rather than waiting.",
    },
    {
      q: "Does Indiana charge a sales tax?",
      a: "Yes. Indiana's sales tax rate is 7%. If you sell physical products or certain taxable services, you'll typically need to collect and remit Indiana sales tax through the Indiana Department of Revenue.",
    },
  ],
};

export default function IndianaLLCPage() {
  return (
    <NavigationWrapper>
