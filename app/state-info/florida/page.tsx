...
const data: StateData = {
  slug: "florida",
  name: "Florida",
  pageTitle: "Florida LLC Filing Fees and Requirements",
  metaDescription:
    "Forming an LLC in Florida costs $125 in state fees. See the full fee breakdown, Articles of Organization requirements, annual report deadlines, and other filing requirements.",
  readTime: "7 min read",
  glance: [
    {
      label: "Filing fee",
      value: "$125 total — $100 (Articles of Organization) + $25 (registered agent designation)",
    },
    { label: "Processing time", value: "Online filings are typically approved within about 5 business days" },
    {
      label: "State agency",
      value: "Florida Department of State, Division of Corporations (Sunbiz)",
    },
    {
      label: "Annual report due",
      value: "Every year between January 1 and May 1; $138.75 filing fee ($538.75 if filed late)",
    },
    {
      label: "State tax rate",
      value:
        "No state income tax on LLC pass-through income; Florida corporate income tax applies only if the LLC elects C Corporation tax treatment",
    },
  ],
  introHeading: "Florida LLC filing fees and requirements",
  introParagraphs: [
    "Forming an LLC in Florida costs $125 in required state fees: $100 to file your Articles of Organization and $25 for the registered agent designation. Both are paid to the Florida Department of State, Division of Corporations — known as Sunbiz — at the time of filing.",
    "There are no expedited processing fees because Florida doesn't offer a rush option; online filings are typically approved within about 5 business days.",
  ],
  steps: [
    {
      title: "File your Articles of Organization",
      body: [
        "File your Articles of Organization with the Florida Department of State, Division of Corporations through the Sunbiz online portal. The state fee is $100, plus a $25 registered agent designation fee, for a total of $125.",
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Your registered agent can be an individual who lives in Florida or a business entity with an active Florida filing and a Florida street address. Either way, the agent must sign an acceptance statement confirming they understand the obligations of the role, included in your Articles of Organization filing.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "Every LLC should get an Employer Identification Number (EIN) from the IRS. You'll need it to open a business bank account, file taxes, and pay employees. You can apply for free at irs.gov/ein.",
      ],
    },
    {
      title: "Create an operating agreement",
      body: [
        "Florida doesn't legally require an LLC operating agreement, but having one in writing protects how your business is run and how decisions get made — especially if you have multiple members.",
      ],
    },
    {
      title: "Check business license requirements",
      body: [
        "Florida doesn't have a single statewide general business license, but many businesses need industry-specific or local licenses. Requirements vary by business type, location, and governing body.",
      ],
    },
  ],
  extraSections: [
    {
      ...
      paragraphs: [
        ...
        "The annual report is filed through Sunbiz and can be paid by credit card, debit card, check, or money order.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Florida?",
      a: "Forming a Florida LLC costs $125 in required state fees — $100 for the Articles of Organization and $25 for the registered agent designation. After that, the annual report costs $138.75 per year if filed on time.",
    },
    {
      q: "Does Florida require an annual report for LLCs?",
      a: "Yes. Florida LLCs must file an annual report between January 1 and May 1 each year. The fee is $138.75 if filed on time; missing the May 1 deadline adds a $400 late fee, bringing the total to $538.75.",
    },
    {
      q: "Does Florida allow Series LLCs?",
      a: "No. Florida does not allow for the formation of Series LLCs. Series LLCs are currently only available in a limited number of states.",
    },
    {
      q: "Does a Florida LLC need an EIN?",
      a: "Single-member Florida LLCs don't strictly need an Employer Identification Number (EIN) unless they plan to hire employees, but getting one anyway is recommended — it's free from the IRS and keeps your Social Security number off business documents.",
    },
    {
      q: "Does Florida have a state income tax for LLCs?",
      a: "No. Florida does not charge a state income tax. Your Florida LLC may be liable for sales tax if you sell taxable goods or services, and you'll still need to pay federal estimated taxes to the IRS.",
    },
    {
      q: "Where do I file Florida LLC paperwork?",
      a: "You can file most Florida LLC business paperwork through Sunbiz.org, the Florida Division of Corporations' online portal. This includes Articles of Organization, annual reports, fictitious names, dissolutions, and Certificates of Status.",
    },
  ],
};
