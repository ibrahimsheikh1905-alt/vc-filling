...
const data: StateData = {
  slug: "new-jersey",
  name: "New Jersey",
  pageTitle: "New Jersey LLC Filing Fees and Requirements",
  metaDescription:
    "The state filing fee to form a New Jersey LLC is $125–$130. Get the full breakdown of formation costs, annual report fees, and registered agent requirements.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$125–$130 (Certificate of Formation/Authorization)" },
    { label: "Processing time", value: "Standard processing through the online Business Formation portal; 5–10 business days typical" },
    { label: "State agency", value: "New Jersey Department of the Treasury, Division of Revenue and Enterprise Services" },
    { label: "Annual report due", value: "$75 per year; due on the last day of the month the LLC originally formed" },
    { label: "State tax rate", value: "No separate LLC-level income tax; members pay NJ Gross Income Tax on their share of profits" },
  ],
  introHeading: "How to form an LLC in New Jersey",
  introParagraphs: [
    "Forming an LLC in New Jersey requires filing a Certificate of Formation with the New Jersey Division of Revenue and Enterprise Services and paying a state filing fee (typically cited as $125–$130 depending on the source and payment method). New Jersey processes formation filings online through its Business Formation portal.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Your LLC name must be distinguishable from other registered New Jersey businesses and include "Limited Liability Company" or an accepted abbreviation like "LLC" or "L.L.C." New Jersey lets you reserve a name before filing by submitting Form UNRR-1 for a $50 fee.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every New Jersey LLC must designate a registered agent as part of the formation process. New Jersey requires the registered agent's address to be a physical address within the state. Your registered agent can be an individual with a New Jersey address or a registered business entity.",
      ],
    },
    {
      title: "File your Certificate of Formation",
      body: [
        "You file the Certificate of Formation/Authorization — also called the Public Records Filing for New Business Entity — with the Division of Revenue and Enterprise Services, done online through the state's Business Formation portal. If you pay by credit card, expect a small convenience fee on top of the state fee.",
      ],
    },
    {
      title: "File your NJ-REG",
      body: [
        "After filing, you'll need to complete Form NJ-REG — the state's tax and employer registration form — within 60 days of forming your business entity. There's no separate fee for NJ-REG, but it's a required step before your LLC can operate and collect or remit state taxes.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "An EIN identifies your business to the IRS. You use it for filing and paying taxes, submitting payroll, and opening a business bank account. You can obtain one directly from the IRS at no cost.",
      ],
    },
  ],
  extraSections: [
    {
      ...
      paragraphs: [
        "Every New Jersey LLC must file an annual report with the Division of Revenue and Enterprise Services. The filing fee is $75 per year. The report is due on the last day of the month in which your LLC was originally formed — so if you formed in March, your annual report is due every March 31. There's no paper option for most LLCs; reports are filed online.",
      ],
    },
  ],
  faqs: [
    {
      ...
      a: "The New Jersey state filing fee for a Certificate of Formation is typically cited as $125–$130 depending on filing method and payment surcharges. After formation, the annual report costs $75 per year.",
    },
    {
      q: "Does New Jersey require an annual report for LLCs?",
      a: "Yes. Every New Jersey LLC must file an annual report with the Division of Revenue and Enterprise Services for $75 per year, due on the last day of the month your LLC was originally formed.",
    },
    {
      q: "What is Form NJ-REG?",
      a: "NJ-REG is New Jersey's business registration form for state tax purposes. After your LLC is formed, you file the NJ-REG with the Division of Revenue to register for applicable state taxes — sales tax, employer withholding, and other business taxes. It must be filed within 60 days of formation and there's no fee.",
    },
    {
      q: "Can I form a New Jersey LLC by myself?",
      a: "Yes. New Jersey allows single-member LLCs, so you can form and own an LLC entirely on your own. You'll still need to appoint a registered agent with a New Jersey address and file the Certificate of Formation.",
    },
    {
      q: "Does New Jersey require an operating agreement?",
      a: "No, it isn't legally required in New Jersey, but having one is a good idea nonetheless — it documents member roles, responsibilities, and how the LLC is managed.",
    },
    {
      q: "Does New Jersey charge a minimum LLC fee based on gross receipts?",
      a: "Multi-member LLCs taxed as partnerships may owe a minimum partner tax of around $150 per member per year, and some sources cite a minimum annual LLC fee ranging from $500 to $2,000 based on gross receipts. A tax professional can clarify what applies to your specific LLC.",
    },
  ],
};

export default function NewJerseyLLCPage() {
  return (
    <NavigationWrapper>
