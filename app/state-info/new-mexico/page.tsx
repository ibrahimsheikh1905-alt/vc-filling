...
const data: StateData = {
  slug: "new-mexico",
  name: "New Mexico",
  pageTitle: "How to Form an LLC in New Mexico",
  metaDescription:
    "Learn the steps, fees, and privacy advantages — including no annual report requirement — for forming an LLC in New Mexico. Get started for $0 + state fee.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$50 (Articles of Organization)" },
    { label: "Processing time", value: "Often same-day to a few business days for online filing; longer by mail" },
    { label: "State agency", value: "New Mexico Secretary of State, Corporations Bureau" },
    { label: "Annual report due", value: "None — New Mexico does not require LLCs to file an annual or periodic report" },
    {
      label: "State tax rate",
      value: "No state franchise tax on LLCs; profits pass through to members' personal income tax; Gross Receipts Tax applies to sales of goods and services",
    },
  ],
  introHeading: "How to form an LLC in New Mexico",
  introParagraphs: [
    "Forming an LLC in New Mexico means filing Articles of Organization with the New Mexico Secretary of State and paying a $50 state fee — one of the lowest filing fees in the country. New Mexico is also known for strong LLC privacy protections: member and manager names aren't required on the public Articles of Organization, and there's no annual report requirement, which keeps ongoing compliance minimal.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Search the New Mexico Secretary of State\'s business name database before you file to confirm your name is available. Your name must include "Limited Liability Company" or an abbreviation such as "LLC" or "L.L.C." If you\'re not ready to file yet, you can reserve a name for 120 days by filing a Name Reservation and paying a small fee.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every New Mexico LLC must designate a registered agent with a physical street address in the state who is available during business hours to receive legal notices and state correspondence on the LLC's behalf.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "File the Articles of Organization with the Secretary of State's Corporations Bureau and pay the $50 filing fee. New Mexico is unusual in that it doesn't require you to list members' or managers' names on this public filing, giving LLC owners a strong layer of privacy. Filings can typically be submitted online, by mail, or in person.",
      ],
    },
    {
      title: "Skip the annual report — there isn't one",
      body: [
        "Unlike most states, New Mexico does not require LLCs to file a periodic or annual report. Once your Articles of Organization are approved, there's no recurring state filing needed to keep the entity in good standing beyond your tax obligations.",
      ],
    },
    {
      title: "Draft an operating agreement",
      body: [
        "New Mexico doesn't require an operating agreement to be filed with the state, but having one in place is strongly recommended to spell out ownership, management, and profit-sharing among members.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "New Mexico's LLC privacy advantage",
      paragraphs: [
        "New Mexico is one of a handful of states — alongside Wyoming and Delaware — where LLC owners aren't named in the public Articles of Organization. Combined with no annual report requirement, this makes New Mexico a popular choice for founders who want to keep their ownership information out of public records.",
      ],
    },
    {
      heading: "Gross Receipts Tax (GRT)",
      paragraphs: [
        "New Mexico doesn't have a traditional sales tax; instead it levies a Gross Receipts Tax on most goods and services sold in the state. Combined state and local GRT rates vary by location, generally falling somewhere between about 5% and 9%. LLC owners should register with the New Mexico Taxation and Revenue Department to collect and remit GRT if they sell taxable goods or services.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in New Mexico?",
      a: "The one-time state filing fee for the Articles of Organization is $50, one of the lowest filing fees of any state.",
    },
    {
      q: "Does New Mexico require an annual report for LLCs?",
      a: "No. New Mexico is one of the few states that doesn't require LLCs to file an annual or periodic report, which keeps ongoing compliance costs low.",
    },
    {
      q: "Are LLC owners' names public in New Mexico?",
      a: "Not necessarily. New Mexico's Articles of Organization don't require you to list members' or managers' names, giving LLC owners more privacy than in most states.",
    },
    {
      q: "Does New Mexico require an operating agreement?",
      a: "No, an operating agreement isn't required to be filed with the state, but it's still recommended to document ownership and management terms among members.",
    },
    {
      q: "How do I register a foreign LLC in New Mexico?",
      a: "File an Application for Registration with the Secretary of State and pay the required filing fee, along with a Certificate of Good Standing from your LLC's home state.",
    },
    {
      q: "Does a New Mexico LLC need a registered agent?",
      a: "Yes. Every New Mexico LLC must maintain a registered agent with a physical street address in the state to receive legal and state correspondence.",
    },
  ],
};
