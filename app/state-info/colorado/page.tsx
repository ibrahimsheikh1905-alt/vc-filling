...
const data: StateData = {
  slug: "colorado",
  name: "Colorado",
  pageTitle: "Colorado LLC Filing Fees and Requirements",
  metaDescription:
    "Forming an LLC in Colorado costs $50 to file Articles of Organization with the Colorado Secretary of State. See fees, annual report deadlines, and formation steps.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$50 (Articles of Organization)" },
    {
      label: "Processing time",
      value: "Typically 1–3 business days for online filings; expedited options available",
    },
    { label: "State agency", value: "Colorado Secretary of State (sos.state.co.us)" },
    { label: "Annual report due", value: "Annually, within the anniversary month of formation; $10 fee" },
    {
      label: "State tax rate",
      value: "Colorado state income tax: 4.4% flat rate; no state-level LLC franchise tax",
    },
  ],
  introHeading: "How to form a Colorado LLC",
  introParagraphs: [
  ...
  steps: [
    ...
    },
    {
      title: "Get your EIN",
      body: [
        "An Employer Identification Number (EIN) is your LLC's federal tax ID. You need one to open a business bank account, hire employees, and file federal taxes. Even if your LLC has no employees, an EIN keeps your Social Security number off business documents.",
      ],
    },
    {
      title: "File your periodic report",
      body: [
        "Colorado LLCs file a periodic report — the state's version of an annual report — each year through the Secretary of State's online portal. The report is due within the anniversary month of your LLC's formation date. The filing fee is $10.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "Business licenses in Colorado",
      paragraphs: [
        "Colorado doesn't have a single statewide general business license, but your LLC may need licenses or permits depending on your industry, location, and the type of work you do. Common requirements include a sales tax license from the Colorado Department of Revenue if you sell taxable goods or services, professional licenses for regulated industries, and local business licenses from your city or county.",
      ],
    },
    {
      heading: "Foreign LLC registration in Colorado",
      paragraphs: [
        "If your LLC was formed in another state but you want to do business in Colorado, you need to register as a foreign LLC with the Colorado Secretary of State. The filing fee for foreign LLC registration is $100, and you'll need to maintain a registered agent with a Colorado address.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Colorado?",
      a: "The minimum cost to form an LLC in Colorado is $50 — that's the state filing fee for the Articles of Organization filed with the Colorado Secretary of State. After that, you'll owe a $10 periodic report fee each year.",
    },
    {
      q: "Does Colorado require an annual report for LLCs?",
      a: "Yes. Colorado LLCs file a periodic report — the state's version of an annual report — each year through the Secretary of State's online portal, due within the anniversary month of your LLC's formation. The filing fee is $10.",
    },
    {
      q: "How long does it take to form an LLC in Colorado?",
      a: "Online filings are typically processed in 1–2 business days, and Colorado's real-time online filing system means most LLCs are approved quickly. Colorado does not offer an additional expedited fee option since filings already process so fast.",
    },
    {
      q: "Does Colorado require an operating agreement?",
      a: "Colorado doesn't legally require an operating agreement, but the Colorado Revised Limited Liability Company Act encourages LLCs to adopt one to define ownership, management, and how decisions get made. Without one, state default rules apply.",
    },
    {
      q: "Does Colorado charge a franchise tax for LLCs?",
      a: "No. Colorado does not impose a state-level LLC franchise tax. Colorado does have a 4.4% flat state income tax rate that applies to pass-through income at the individual level.",
    },
    {
      q: "How do I register a foreign LLC in Colorado?",
      a: "File a Statement of Foreign Entity Authority with the Colorado Secretary of State, accompanied by a Certificate of Good Standing or Certificate of Existence from your LLC's home state. The filing fee for foreign LLC registration is $100.",
    },
  ],
};

export default function ColoradoLLCPage() {
  return (
    <NavigationWrapper>
