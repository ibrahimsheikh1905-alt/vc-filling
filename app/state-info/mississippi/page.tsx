...
const data: StateData = {
  slug: "mississippi",
  name: "Mississippi",
  pageTitle: "Mississippi LLC Filing Fees and Requirements",
  metaDescription:
    "The Mississippi LLC filing fee is $50 to file a Certificate of Formation with the Secretary of State. Annual reports are free for domestic LLCs.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$50 (Certificate of Formation, Form F0100)" },
    { label: "Processing time", value: "Filed entirely online through the Secretary of State's business portal" },
    { label: "State agency", value: "Mississippi Secretary of State" },
    {
      label: "Annual report due",
      value: "April 15 each year (filing window opens January 1); $0 for domestic LLCs, $250 for foreign LLCs",
    },
    {
      label: "State tax rate",
      value: "No state-level LLC franchise tax; Mississippi has a flat individual income tax rate",
    },
  ],
  introHeading: "How to form an LLC in Mississippi",
  introParagraphs: [
  ...
  steps: [
    {
      ...
      body: [
        ...
        "Your LLC name must include a designator like \"Limited Liability Company\" or \"LLC,\" and you'll need a registered agent with a physical Mississippi address to receive legal notices.",
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every LLC in Mississippi is required to have a registered agent — someone who receives official legal and tax correspondence and is responsible for filing reports with the Secretary of State. If your registered agent is a person, they must have a physical street address in Mississippi.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "Every LLC should get a federal Employer Identification Number (EIN) from the IRS. An EIN is required if your LLC has employees, has more than 1 member, or files certain federal excise tax returns. Applying is free and takes minutes at irs.gov/ein.",
      ],
    },
  ],
  extraSections: [
    {
      ...
      paragraphs: [
        "Mississippi requires both domestic and foreign LLCs to file an annual report with the Secretary of State. For domestic LLCs, the annual report carries no state filing fee — it's $0. The filing window opens January 1 and the deadline is April 15 each year.",
        "Mississippi doesn't accept paper or mailed annual reports; everything goes through the Secretary of State's online portal. Foreign LLCs registered to do business in Mississippi pay $250 for their annual report. If your LLC misses the deadline and lapses, reinstatement costs $50.",
      ],
    },
    {
      heading: "Operating agreements in Mississippi",
      paragraphs: [
        "The state of Mississippi does not require businesses to have an LLC Operating Agreement in place. That said, this document can be extremely helpful in making sure you're organized and prepared for any future events that may affect your business.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Mississippi?",
      a: "The Mississippi LLC filing fee is $50 for the Certificate of Formation. Annual reports are free for domestic LLCs, due each year by April 15 — one of the more budget-friendly states for ongoing LLC maintenance.",
    },
    {
      q: "Does Mississippi require an annual report for LLCs?",
      a: "Yes, but for domestic LLCs it's free. The report must be filed online through the Secretary of State's Business Services portal each year by April 15. Foreign LLCs pay a $250 filing fee for the same report.",
    },
    {
      q: "Does Mississippi charge a franchise tax for LLCs?",
      a: "No entity-level franchise tax on standard LLCs. Mississippi's flat individual income tax rate applies to pass-through profits that flow through to LLC owners' personal returns, unless the LLC elects corporate tax treatment.",
    },
    {
      q: "Does a Mississippi LLC need a registered agent?",
      a: "Yes. Every LLC in Mississippi is required to have a registered agent with a physical Mississippi street address, appointed when you file your Certificate of Formation.",
    },
    {
      q: "How do I register a foreign LLC in Mississippi?",
      a: "File an Application for Registration with the Mississippi Secretary of State, accompanied by a certificate of good standing or certificate of existence from your LLC's home state.",
    },
    {
      q: "What happens if I miss Mississippi's annual report deadline?",
      a: "If your LLC's annual report lapses, reinstatement costs $50. It's worth filing on time since the report itself is free for domestic LLCs — there's no cost reason to let it slip.",
    },
  ],
};

export default function MississippiLLCPage() {
  return (
    <NavigationWrapper>
