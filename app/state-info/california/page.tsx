...
const data: StateData = {
  slug: "california",
  name: "California",
  pageTitle: "California LLC Filing Forms, Fees, and Deadlines",
  metaDescription:
    "Learn how to form an LLC in California — Articles of Organization, the $70 state filing fee, Statement of Information, and the $800 annual franchise tax.",
  readTime: "8 min read",
  glance: [
    { label: "Filing fee", value: "$70 (Articles of Organization, Form LLC-1)" },
    { label: "Processing time", value: "Typically 3–5 business days for online filings" },
    { label: "State agency", value: "California Secretary of State" },
    {
      label: "Annual report due",
      value:
        "Statement of Information (Form LLC-12) within 90 days of formation, then every 2 years; $20 filing fee",
    },
    {
      label: "State tax rate",
      value:
        "$800 minimum annual franchise tax (Franchise Tax Board); additional LLC fee applies if gross receipts exceed $250,000",
    },
  ],
  introHeading: "How to form an LLC in California",
  introParagraphs: [
    "To form an LLC in California, you file Form LLC-1 (Articles of Organization) with the California Secretary of State and pay the $70 state filing fee. After formation, you'll file a Statement of Information (Form LLC-12) within 90 days and pay the $800 annual franchise tax to the Franchise Tax Board.",
  ...
  steps: [
    {
      ...
      body: [
        'Your LLC name must be distinguishable from other registered California entities and include "Limited Liability Company," "LLC," or "L.L.C." Certain words — like "bank," "trust," and "insurance" — require additional approval. California also allows you to reserve an LLC name before filing for $10, holding the name for 60 days.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every California LLC needs a registered agent — a person or business with a physical California address who accepts legal documents and official state mail on your behalf. You can serve as your own registered agent, but many business owners use a registered agent service to keep their personal address off public records.",
      ],
    },
    {
      title: "File Articles of Organization",
      body: [
        "File Form LLC-1 (Articles of Organization) with the California Secretary of State. The state filing fee is $70. You can file online through bizfileonline.sos.ca.gov, by mail, or in person. Online filing is generally faster, typically processed in 3–5 business days.",
      ],
    },
    {
      title: "Create an operating agreement",
      body: [
        "California law requires LLC members to adopt an operating agreement either before or after filing the Articles of Organization. If your LLC has more than 1 member, the agreement must be in writing. Without one, California's default rules under the Corporations Code govern your LLC.",
      ],
    },
    {
      title: "File your Statement of Information",
      body: [
    ...
    {
      title: "Get your EIN and pay the franchise tax",
      body: [
        "An EIN is a 9-digit tax ID the IRS assigns to your business — you'll need it to open a bank account, file taxes, and hire employees. California also charges every LLC doing business in the state a minimum $800 franchise tax each year, regardless of income. For newly formed LLCs, the first payment is due by the 15th day of the 4th month after formation.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "Ongoing compliance in California",
      paragraphs: [
        "After the initial Statement of Information, you'll file it again every 2 years for $20. California LLCs also file Form 568 — the Limited Liability Company Return of Income — with the Franchise Tax Board each year. If your LLC's gross receipts exceed $250,000, an additional LLC fee applies on top of the $800 minimum franchise tax.",
  ...
  faqs: [
    {
      ...
      a: "The minimum upfront cost is $90: $70 for the Articles of Organization and $20 for the initial Statement of Information, due within 90 days of formation. After that, you'll owe an $800 minimum annual franchise tax to the Franchise Tax Board each year.",
    },
    {
      q: "Does California require an annual report for LLCs?",
      a: "California calls its version of an annual report a Statement of Information. Your first filing is due within 90 days of forming your LLC, and after that it's due every 2 years. The filing fee is $20 each time.",
    },
    {
      q: "Why is the California franchise tax so high?",
      a: "California charges every LLC doing business in the state a minimum $800 franchise tax each year, regardless of income or profit. It's one of the higher state costs in the country and is due annually to the Franchise Tax Board, separate from your Statement of Information filing.",
    },
    {
      q: "Can I avoid California's $800 franchise tax by forming my LLC in another state?",
      a: "Generally, no. If your business is actually operating in California — has employees here, makes sales to California customers, or holds property here — the Franchise Tax Board considers you to be doing business in California and requires you to register as a foreign LLC and pay the $800 tax anyway.",
    },
    {
      q: "Does California require an operating agreement?",
      a: "Yes, technically. California law requires LLC members to adopt an operating agreement, though it doesn't have to be written or filed with the state for single-member LLCs. Multi-member LLCs must have a written agreement.",
    },
    {
      q: "How do I dissolve a California LLC?",
      a: "File a Certificate of Cancellation (Form LLC-4/7) with the California Secretary of State. If your LLC has more than 1 member, you may also need to file a Certificate of Dissolution (Form LLC-3) first, depending on whether all members agree to dissolve.",
    },
  ],
};

export default function CaliforniaLLCPage() {
  return (
    <NavigationWrapper>
