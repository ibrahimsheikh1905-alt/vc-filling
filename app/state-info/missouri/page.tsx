...
const data: StateData = {
  slug: "missouri",
  name: "Missouri",
  pageTitle: "Missouri LLC Filing Fees and Requirements",
  metaDescription:
    "The Missouri LLC filing fee is $50 online or $105 by paper. Missouri has no annual report requirement for LLCs and no franchise tax.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$50 online or $105 by paper (Articles of Organization)" },
    { label: "Processing time", value: "Under 24 hours online; 4–6 weeks by mail" },
    { label: "State agency", value: "Missouri Secretary of State" },
    { label: "Annual report due", value: "Not required for LLCs at this time" },
    { label: "State tax rate", value: "No state-level LLC franchise tax; pass-through income taxed at individual rates" },
  ],
  introHeading: "How to form an LLC in Missouri",
  introParagraphs: [
    "Your Articles of Organization can be filed online using an online business system provided by the Missouri Secretary of State, filed in person, or filed by mailing a printed form. The Missouri LLC filing fee is $105 if you choose to submit a paper version, or $50 if you complete the application online.",
    "You only need to file your Articles of Organization once — Missouri has no annual report requirement for LLCs.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Your name must include "Limited Liability Company" or an acceptable abbreviation such as "LLC" or "L.L.C." Under Missouri law, you cannot use any word or phrase that indicates a connection with a government agency or the necessity of business or professional licensing.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every LLC formed or registered to do business in Missouri must designate and continuously maintain a registered agent in the state. The registered agent must have a physical Missouri street address — P.O. boxes and commercial mailbox services don't satisfy the requirement — and be available during normal business hours.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "File online through the Missouri Secretary of State's online business system for $50, or by mail for $105. Online filing is much faster — you could have your LLC formed in under 24 hours, compared to 4–6 weeks by mail. Because the online process is so quick, Missouri doesn't offer a separate expedited filing service.",
      ],
    },
    {
      title: "Get your EIN",
  ...
  extraSections: [
    {
      ...
      paragraphs: [
        "Missouri does not require LLCs to file annual reports or pay annual fees to the state — one of only a handful of states with this policy. This makes Missouri one of the most low-maintenance states for LLC operations. You only need to file with the state when making changes to your LLC's basic information, such as registered agent or address changes.",
      ],
    },
    {
      heading: "Series LLCs in Missouri",
      paragraphs: [
        "Missouri allows the formation of Series LLCs. To form one, fill out the typical domestic LLC Articles of Organization form, mark the appropriate spot indicating you're creating a Series LLC, and file it with the Secretary of State. For each separate series, you must also file an Attachment Form LLC 1A. The fee for a Series LLC formation is the same as a standard domestic LLC.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Missouri?",
      a: "The Missouri LLC filing fee is $50 if you file online, or $105 if you submit a paper version. Since there's no annual report requirement, this one-time fee is essentially the only required state cost.",
    },
    {
      q: "Does Missouri require an annual report for LLCs?",
      a: "No. Missouri does not require LLCs to file annual reports or pay annual fees — one of only a handful of states nationwide with no ongoing reporting requirement for LLCs.",
    },
    {
      q: "How long does it take to form an LLC in Missouri?",
      a: "Online filings can be processed in under 24 hours. Mail filings take 4–6 weeks. Because online filing is already so fast, Missouri doesn't offer a separate expedited filing option.",
    },
    {
      q: "Does a Missouri LLC need a registered agent?",
      a: "Yes. Every LLC formed or registered to do business in Missouri must designate and continuously maintain a registered agent with a physical Missouri street address.",
    },
    {
      q: "Does Missouri allow Series LLCs?",
      a: "Yes. Missouri allows Series LLC formation using the standard Articles of Organization form marked for a series, plus an Attachment Form LLC 1A for each separate series. The fee is the same as a standard domestic LLC.",
    },
    {
      q: "Does Missouri charge a franchise tax for LLCs?",
      a: "No. Missouri does not impose a state-level LLC franchise tax, which keeps ongoing costs minimal alongside the lack of an annual report requirement.",
    },
  ],
};

export default function MissouriLLCPage() {
  return (
    <NavigationWrapper>
