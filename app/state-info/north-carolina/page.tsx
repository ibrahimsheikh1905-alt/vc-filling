...
const data: StateData = {
  slug: "north-carolina",
  name: "North Carolina",
  pageTitle: "North Carolina LLC Filing Fees and Requirements",
  metaDescription:
    "Forming an LLC in North Carolina costs $125 in state fees. Learn the filing requirements, annual report deadlines, registered agent rules, and EIN steps.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$125 (Articles of Organization, Form L-01)" },
    { label: "Processing time", value: "3–5 business days; expedited options available for an additional fee" },
    { label: "State agency", value: "North Carolina Secretary of State" },
    { label: "Annual report due", value: "April 15 each year; $200 by paper or $203 online" },
    { label: "State tax rate", value: "No state-level LLC franchise tax; pass-through income taxed at individual rates" },
  ],
  introHeading: "How to form an LLC in North Carolina",
  introParagraphs: [
  ...
  steps: [
    {
      ...
      body: [
        'Your LLC name must include a designator — "Limited Liability Company," "LLC," or "L.L.C." — and it must be distinguishable from all other business names already on file with the North Carolina Secretary of State. Before filing, search the Secretary of State\'s online business database to check availability.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "You'll need a registered agent with a physical North Carolina street address to receive legal documents and official state correspondence on your LLC's behalf.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "To file, you'll need your LLC's legal name (including the required designator), the name and address of each person signing the document, and your registered agent's contact information. Online filing is the fastest option and takes only a few minutes once you have your information ready. It generally takes 3–5 business days for the Secretary of State to process and approve your filing.",
      ],
    },
    {
      title: "Get your EIN",
  ...
  extraSections: [
    {
      ...
      paragraphs: [
        "North Carolina LLCs must file an annual report with the Secretary of State each year to stay in good standing. The fee is $203 when filed online or $200 when filed by paper. Annual reports are due by April 15 each year, with the first report due in the calendar year after your LLC was formed — using a fixed deadline rather than an anniversary-based one.",
      ],
    },
    {
      heading: "Operating agreements in North Carolina",
      paragraphs: [
        "North Carolina does not require an LLC to have an operating agreement, and there's no state filing fee associated with one. That said, having a written operating agreement is worth doing — it defines how your LLC is managed, how profits are split, and how decisions get made.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in North Carolina?",
      a: "The state filing fee to form a North Carolina LLC is $125, paid when you file Articles of Organization. After formation, you'll also owe an annual report fee of $200 (paper) or $203 (online) each year to keep your LLC in good standing.",
    },
    {
      q: "Does North Carolina require an annual report for LLCs?",
      a: "Yes. North Carolina LLCs must file an annual report each year by April 15, regardless of when during the year the LLC was formed. The fee is $203 online or $200 by paper.",
    },
    {
      q: "How long does it take to form an LLC in North Carolina?",
      a: "It generally takes 3–5 business days for the North Carolina Secretary of State to process and approve Articles of Organization after you file. Online filings tend to move through the queue faster than paper filings sent by mail.",
    },
    {
      q: "Does North Carolina require an operating agreement?",
      a: "No. North Carolina does not require an LLC to have an operating agreement, and there's no state filing fee associated with one. It's still worth having for internal clarity and dispute prevention.",
    },
    {
      q: "Does a North Carolina LLC need a registered agent?",
      a: "Yes. Every North Carolina LLC is required to have a registered agent with a physical North Carolina address, appointed when you file your Articles of Organization.",
    },
    {
      q: "What happens if I miss North Carolina's annual report deadline?",
      a: "There's no flat late fee, but the LLC can face administrative dissolution under North Carolina law if the report stays unfiled. It's worth marking April 15 as a fixed yearly compliance date.",
    },
  ],
};

export default function NorthCarolinaLLCPage() {
  return (
    <NavigationWrapper>
