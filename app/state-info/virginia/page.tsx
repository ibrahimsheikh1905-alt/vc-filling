...
const data: StateData = {
  slug: "virginia",
  name: "Virginia",
  pageTitle: "How to Form a Virginia LLC — Steps, Fees, and Requirements",
  metaDescription:
    "Learn how to form an LLC in Virginia in 6 steps. File Articles of Organization with the SCC, pay the $100 state fee, and get your business official.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$100 (Articles of Organization, Form LLC-1011)" },
    { label: "Processing time", value: "1–2 business days for online filings; mail filings take longer" },
    { label: "State agency", value: "Virginia State Corporation Commission (SCC)" },
    { label: "Annual report due", value: "$50 annual registration fee due by the last day of the LLC's anniversary month, starting the year after formation" },
    { label: "State tax rate", value: "No separate LLC franchise tax; Virginia flat individual income tax rate of 5.75% on pass-through income" },
  ],
  introHeading: "How to form an LLC in Virginia",
  introParagraphs: [
    "Forming a Virginia LLC takes 6 steps: choose a name that meets SCC naming rules, designate a registered agent with a Virginia street address, file Articles of Organization (Form LLC-1011) with the State Corporation Commission and pay the $100 state fee, get an Employer Identification Number (EIN), draft an operating agreement, and register for any required state taxes.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        "Your LLC name must meet SCC naming rules and be distinguishable from other registered Virginia entities. Check availability through the SCC's business search tool before you file.",
      ],
    },
    {
      title: "Designate a registered agent",
      body: [
        "Your registered agent must be either an individual Virginia resident who is a member, manager, or Virginia State Bar member, or a business entity authorized to transact business in Virginia. The registered office address must be a physical Virginia street address — not a P.O. Box.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "Filing Form LLC-1011 with the Virginia State Corporation Commission is the step that legally creates your LLC. The $100 filing fee applies whether you file online through the SCC's Clerk's Information System (CIS) or submit a paper form by mail. Online filing through CIS is faster — typically processed within 1–2 business days.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "An Employer Identification Number (EIN) is a 9-digit federal tax ID issued by the IRS. You'll need one to open a business bank account, hire employees, and file federal taxes. Applying is free and the IRS online application issues your EIN immediately upon approval.",
      ],
    },
    {
      title: "Draft an operating agreement",
      body: [
        "Virginia law doesn't require an operating agreement, but going without one means your LLC's internal rules default to Virginia's LLC statutes, which may not match what you and your co-owners actually agreed to.",
      ],
    },
    {
      title: "Register for state taxes",
      body: [
        "You'll also need to register with the Virginia Department of Taxation if your LLC collects sales tax or has employees.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "Annual registration fee",
      paragraphs: [
        "Every Virginia LLC pays a $50 annual registration fee to the State Corporation Commission to stay in good standing. The fee is due by the last day of your LLC's anniversary month, starting the calendar year after formation. Virginia's annual registration is a fee payment, not a full information report like some states require. Not paying on time puts your LLC at risk of administrative dissolution — if the fee isn't paid within 3 months of the due date, the LLC's existence is automatically canceled by operation of law.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Virginia?",
      a: "The Virginia SCC charges a $100 one-time filing fee to form an LLC. After formation, you'll owe a $50 annual registration fee each year to keep your LLC in good standing with the SCC.",
    },
    {
      q: "Does Virginia require an annual report for LLCs?",
      a: "Virginia requires a $50 annual registration fee rather than a full information report. It's due by the last day of your LLC's anniversary month, starting the year after formation. A $25 penalty applies if payment is late.",
    },
    {
      q: "How long does it take to form an LLC in Virginia?",
      a: "Online filings through the SCC's Clerk's Information System are typically processed within 1–2 business days. Paper filings submitted by mail take longer.",
    },
    {
      q: "Does a Virginia LLC need a registered agent?",
      a: "Yes. Every Virginia LLC must designate a registered agent with a physical street address in Virginia. It's a required field on Form LLC-1011, not optional.",
    },
    {
      q: "Does Virginia require an operating agreement?",
      a: "No, Virginia law doesn't require one. But going without a written operating agreement means your LLC's internal rules default to Virginia's LLC statutes — worth having for any multi-member LLC.",
    },
    {
      q: "What happens if I don't pay Virginia's annual registration fee?",
      a: "If the annual registration fee is not paid within 3 months of its due date, the LLC's existence is automatically canceled by operation of law. A $25 late penalty applies before that point.",
    },
  ],
};

export default function VirginiaLLCPage() {
  return (
    <NavigationWrapper>
