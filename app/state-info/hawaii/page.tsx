...
const data: StateData = {
  slug: "hawaii",
  name: "Hawaii",
  pageTitle: "Hawaii LLC Filing Fees and Requirements",
  metaDescription:
    "Hawaii LLCs pay a $50 state filing fee plus a $1 state archives fee to form. Annual reports cost $15 and are due quarterly based on your registration date.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$51 total ($50 filing fee + $1 state archives fee)" },
    { label: "Processing time", value: "Standard processing; expedited available for an additional $25" },
    {
      label: "State agency",
      value: "Hawaii Department of Commerce and Consumer Affairs (DCCA), Business Registration Division (BREG)",
    },
    {
      label: "Annual report due",
      value:
        "$15 fee; due by the last day of the calendar quarter containing your LLC's registration anniversary date",
    },
    {
      label: "State tax rate",
      value: "No franchise tax; Hawaii state income tax applies to pass-through LLC income",
    },
  ],
  introHeading: "How to form an LLC in Hawaii",
  introParagraphs: [
  ...
  steps: [
    {
      ...
      body: [
        "To form a domestic LLC in Hawaii, you file Articles of Organization with the DCCA Business Registration Division and pay a $50 state filing fee. Hawaii adds a mandatory $1 state archives fee, bringing the total to $51. The $50 fee is nonrefundable whether your filing is accepted or rejected. If you need faster review, Hawaii offers expedited processing for an additional $25.",
        "The Articles of Organization must include your LLC's exact legal name, the street address of your principal office, and the name and Hawaii street address of your registered agent. A P.O. box alone is not acceptable for the registered agent address.",
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every Hawaii LLC — domestic or foreign — must maintain a registered agent in the state at all times. The registered agent must have a physical street address in Hawaii and be available during normal business hours. You can serve as your own registered agent, appoint a Hawaii resident, or hire a commercial registered agent service.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "Every LLC needs an Employer Identification Number (EIN) from the IRS to open a business bank account, hire employees, and file federal taxes. The IRS issues EINs at no cost — you can apply at irs.gov/ein. Using your Social Security number instead is technically possible for single-member LLCs, but an EIN keeps your personal number off business documents.",
      ],
    },
    {
      title: "File your annual report",
      body: [
        "Hawaii LLCs must file an annual report with the DCCA Business Registration Division each year. The filing fee is $15. Hawaii's due date system is tied to your registration anniversary — your report is due by the last day of the calendar quarter that contains the date your LLC was originally registered. If your LLC was registered on February 10, your annual report is due by March 31 every year.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "Business licenses in Hawaii",
      paragraphs: [
        "Forming your LLC is separate from getting the licenses and permits you need to operate. Requirements vary depending on your industry, location, and the type of business you run — check with the relevant state or county agency for your specific activity.",
      ],
    },
    {
      heading: "Foreign LLC registration in Hawaii",
      paragraphs: [
        "If your LLC was formed in another state but you want to do business in Hawaii, you need to register as a foreign LLC with the DCCA Business Registration Division by filing an Application for Certificate of Authority (Form FLLC-1). The state filing fee is $25, plus the mandatory $1 state archives fee, for a total of $26. Expedited processing adds another $25.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Hawaii?",
      a: "Forming an LLC in Hawaii costs $51 total — a $50 Articles of Organization filing fee plus a mandatory $1 state archives fee. After formation, the annual report costs $15 per year, due by the last day of the calendar quarter containing your registration anniversary.",
    },
    {
      q: "Does Hawaii require an annual report for LLCs?",
      a: "Yes. Hawaii LLCs must file an annual report with the DCCA Business Registration Division each year for a $15 fee. The due date is tied to your registration anniversary quarter, not a fixed calendar date — a system that catches some business owners off guard.",
    },
    {
      q: "Does Hawaii charge an LLC franchise tax?",
      a: "No. Unlike many other states, Hawaii does not have a franchise tax. Hawaii LLC owners do pay Hawaii state income tax on pass-through profits, along with applicable general excise tax (GET) on business activity.",
    },
    {
      q: "Does a Hawaii LLC need a registered agent?",
      a: "Yes. Every Hawaii LLC, domestic or foreign, must appoint and continuously maintain a registered agent with a physical street address in the state — a P.O. box doesn't qualify. You can serve as your own registered agent if you meet the address and availability requirements.",
    },
    {
      q: "How do I register a foreign LLC in Hawaii?",
      a: "File an Application for Certificate of Authority (Form FLLC-1) with the DCCA Business Registration Division. The filing fee is $25 plus the $1 state archives fee, for a total of $26. You can file online through Hawaii Business Express, or by mail, email, fax, or in person.",
    },
    {
      q: "How long does it take to form an LLC in Hawaii?",
      a: "Standard processing times vary, but Hawaii offers expedited service for an additional $25 if you need faster approval. Filing online through Hawaii Business Express is typically the quickest method available.",
    },
  ],
};

export default function HawaiiLLCPage() {
  return (
    <NavigationWrapper>
