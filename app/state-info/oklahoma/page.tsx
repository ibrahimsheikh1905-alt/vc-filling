...
const data: StateData = {
  slug: "oklahoma",
  name: "Oklahoma",
  pageTitle: "How to Form an LLC in Oklahoma",
  metaDescription:
  ...
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$100 (Articles of Organization)" },
    { label: "Processing time", value: "1–2 business days online; 10–15 business days by mail; +$25 for same-day in-person" },
    { label: "State agency", value: "Oklahoma Secretary of State" },
    { label: "Annual report due", value: "By the LLC's anniversary month each year (Annual Certificate); $25 fee" },
    { label: "State tax rate", value: "No state-level LLC franchise tax; Oklahoma corporate income tax rate is 4% for corporations electing that status" },
  ],
  introHeading: "How to form an LLC in Oklahoma",
  introParagraphs: [
    "Forming an LLC in Oklahoma takes 6 steps: choose a unique business name, provide a business address, assign a registered agent, file Articles of Organization with the Oklahoma Secretary of State (state fee: $100), get an Employer Identification Number (EIN) from the IRS, and create an operating agreement. Oklahoma is a straightforward state for LLC formation — the filing fee is low, the process is online, and there's no state-level franchise tax on LLCs.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        "Your Oklahoma LLC name needs to be unique — no other registered business in the state can have the same name. Check availability through the Oklahoma Secretary of State's website before you file.",
      ],
    },
    {
      title: "Provide a business address and assign a registered agent",
      body: [
        "Designate a registered agent with an Oklahoma street address, and provide a principal business address for your LLC as part of the filing.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "The Articles of Organization is the document that officially creates your LLC in Oklahoma. You file it with the Oklahoma Secretary of State. The state filing fee is $100. The form asks for your LLC name, principal business address, registered agent name and address, and the names of the organizers. Online filings are generally processed in 1–2 business days; mail filings take around 10–15 business days.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "An Employer Identification Number (EIN) is a federal tax ID issued by the IRS. You'll need one to open a business bank account, hire employees, and file certain tax returns. The IRS issues EINs free of charge. Multi-member LLCs are required to have an EIN.",
      ],
    },
    {
      title: "Create an operating agreement",
      body: [
        "An operating agreement isn't required by Oklahoma law, but it's worth having to define how your LLC will be run and how members' rights and responsibilities work.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "Annual Certificate requirements",
      paragraphs: [
        "Oklahoma LLCs are required to file an Annual Certificate with the Secretary of State each year to stay in good standing. The filing fee is $25 for domestic LLCs. The due date is based on your LLC's anniversary month — the month you originally filed your Articles of Organization. Missing the deadline can result in your LLC losing its good standing with the state.",
      ],
    },
    {
      heading: "Business taxes in Oklahoma",
      paragraphs: [
        "Oklahoma has a state sales tax rate of 4.5%. If your LLC sells taxable goods or services, you need to register with the Oklahoma Tax Commission to collect and remit sales tax. Members of pass-through LLCs pay Oklahoma individual income tax at rates from 0% to 4.75% on their share of profits.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Oklahoma?",
      a: "The Oklahoma Secretary of State charges a $100 state filing fee to form an LLC. If you file in person and want same-day processing, you can pay an additional $25 expedited fee. After formation, the Annual Certificate costs $25 per year.",
    },
    {
      q: "Does Oklahoma require an annual report for LLCs?",
      a: "Yes. Oklahoma calls it an Annual Certificate rather than an annual report. It's due by the anniversary date of your LLC's Articles of Organization each year, and the fee is $25 for domestic LLCs.",
    },
    {
      q: "How long does it take to form an LLC in Oklahoma?",
      a: "Online filings are generally processed in 1–2 business days. Mail filings take around 10–15 business days. If you file in person and pay the $25 expedited fee, your LLC can be formed the same day.",
    },
    {
      q: "Does an Oklahoma LLC need an EIN?",
      a: "Multi-member LLCs are required to have an EIN to file partnership tax returns. Single-member LLCs that are disregarded for tax purposes can technically use the owner's Social Security number, but getting an EIN is still worth doing.",
    },
    {
      q: "Does Oklahoma charge a franchise tax for LLCs?",
      a: "No. Oklahoma does not impose a franchise tax on LLCs. LLCs are subject to state income tax on business profits passed through to members, but there's no separate franchise or privilege tax on the LLC itself.",
    },
    {
      q: "Does Oklahoma allow Series LLCs?",
      a: "Yes. If you want to manage multiple LLCs under one umbrella LLC, you'll need to create a Series LLC. To do so, simply indicate that intention in your Oklahoma Articles of Organization when you file the form.",
    },
  ],
};

export default function OklahomaLLCPage() {
  return (
    <NavigationWrapper>
