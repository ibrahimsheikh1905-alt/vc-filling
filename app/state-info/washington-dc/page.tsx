...
const data: StateData = {
  slug: "washington-dc",
  name: "Washington DC",
  pageTitle: "How to Form an LLC in Washington, D.C.",
  metaDescription:
    "Learn the forms, fees, and filing procedures for a Washington, D.C. LLC. Biennial report fee is $300, filed once every other year.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$99 (Articles of Organization)" },
    { label: "Processing time", value: "Expedited processing available for an additional fee" },
    { label: "State agency", value: "DC Department of Consumer and Regulatory Affairs (DCRA), Corporations Division" },
    { label: "Annual report due", value: "Biennial report every other year; $300 fee" },
    { label: "State tax rate", value: "No franchise tax on standard LLCs; DC unincorporated business franchise tax may apply above income thresholds" },
  ],
  introHeading: "How to form an LLC in Washington, D.C.",
  introParagraphs: [
    "You'll need to file as an LLC with the District of Columbia's Department of Consumer and Regulatory Affairs and pay a filing fee when you first formally form your business. The District of Columbia allows you to form your LLC more quickly by paying an expedited fee.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        "Your LLC name must be distinguishable from other registered District of Columbia entities. Check availability through the DCRA's business search tool before you file.",
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every D.C. LLC needs a registered agent with a physical D.C. address to receive legal notices and official correspondence on your LLC's behalf.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "File your Articles of Organization with the DC Department of Consumer and Regulatory Affairs, Corporations Division. You can pay an expedited fee if you want your LLC formed more quickly.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "Every LLC in the U.S. should obtain a unique Employer Identification Number (EIN) from the Internal Revenue Service. You'll use it when you open a business bank account, file taxes, and pay employees.",
      ],
    },
  ],
  extraSections: [
    {
      ...
      paragraphs: [
        "Most states require an annual report, but the District of Columbia requires a biennial report — filed once every other year — with the Department of Consumer and Regulatory Affairs. The filing fee is $300, one of the higher biennial report fees in the country.",
      ],
    },
    {
      heading: "Operating agreements in D.C.",
      paragraphs: [
        "The District of Columbia doesn't require you to have an LLC Operating Agreement in place. Even so, having one is worth doing to define ownership, management structure, and how profits are divided among members.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Washington, D.C.?",
      a: "The Articles of Organization filing fee is $99, paid to the DC Department of Consumer and Regulatory Affairs. After formation, the biennial report costs $300, filed once every 2 years.",
    },
    {
      q: "Does D.C. require an annual report for LLCs?",
      a: "No, not annually — D.C. requires a biennial report instead, filed once every other year for a $300 fee.",
    },
    {
      q: "Does D.C. require an operating agreement?",
      a: "No. The District of Columbia doesn't require you to have an LLC Operating Agreement in place, though having one is still a good idea for internal clarity.",
    },
    {
      q: "How do I register a foreign LLC in D.C.?",
      a: "File a Foreign Registration Statement with the D.C. Department of Consumer and Regulatory Affairs, accompanied by a certificate of good standing or certificate of existence from your LLC's home state.",
    },
    {
      q: "Does a D.C. LLC need a registered agent?",
      a: "Yes. Every LLC in the District of Columbia needs a registered agent with a physical D.C. address to receive legal documents and official correspondence.",
    },
    {
      q: "Does D.C. offer expedited LLC processing?",
      a: "Yes. The District of Columbia allows you to form your LLC more quickly by paying an expedited fee on top of the standard filing fee.",
    },
  ],
};

export default function WashingtonDCLLCPage() {
  return (
    <NavigationWrapper>
