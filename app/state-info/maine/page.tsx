...
const data: StateData = {
  slug: "maine",
  name: "Maine",
  pageTitle: "How to Start an LLC in Maine",
  metaDescription:
    "Learn how to start an LLC in Maine: Certificate of Formation, the $175 state filing fee, mandatory operating agreement, EIN, and annual report deadlines.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$175 (Certificate of Formation)" },
    { label: "Processing time", value: "Standard processing; expedited options available for an additional fee" },
    { label: "State agency", value: "Maine Secretary of State, Bureau of Corporations, Elections and Commissions (BCEC)" },
    { label: "Annual report due", value: "By June 1 each year; $85 filing fee online" },
    {
      label: "State tax rate",
      value: "No franchise tax; Maine state income tax (5.8%–7.15% graduated) applies to pass-through profits",
    },
  ],
  introHeading: "How to start an LLC in Maine",
  introParagraphs: [
    ...
    "Maine also requires LLCs to have an operating agreement — that's not the case in most states. The operating agreement doesn't get filed with the state, but you need to have one in place.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Your name must include "Limited Liability Company," "LLC," "L.L.C.," or another accepted abbreviation. Maine may reject names that include obscenities or imitate public institutions. If your preferred name is taken, you can file a Certificate of Amendment later to change your LLC\'s legal name.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every Maine LLC needs a registered agent with a physical street address in Maine, and the agent's name and address must appear on your Certificate of Formation.",
      ],
    },
    {
      title: "File your Certificate of Formation",
      body: [
        "File a Certificate of Formation with the Maine Secretary of State, Division of Corporations. The form requires your LLC's legal name, the name and physical Maine address of your registered agent, and the effective date of the filing. The state filing fee is $175.",
      ],
    },
    {
      title: "Create your operating agreement",
      body: [
        "Unlike most states, Maine requires LLCs to have an operating agreement in place. It doesn't get filed with the state, but you need to have one — it's not optional. Draft it before or shortly after you file your Certificate of Formation.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "A Maine LLC that has employees is required to get a federal EIN from the IRS. Even without employees, you'll need an EIN to open a business bank account and register for Maine state tax accounts. The IRS issues EINs at no charge.",
      ],
    },
  ],
  extraSections: [
    {
      ...
      paragraphs: [
        "Maine LLCs must file an annual report with the Maine Secretary of State by June 1 each year. The filing fee is $85 for online submissions. This isn't a tax filing — it's a compliance requirement to keep your LLC in good standing — but missing it can result in administrative dissolution.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Maine?",
      a: "The state filing fee to form a domestic LLC in Maine is $175, paid to the Maine Secretary of State, Division of Corporations. After formation, the annual report costs $85 per year online, due by June 1.",
    },
    {
      q: "Does Maine require an annual report for LLCs?",
      a: "Yes. Maine LLCs must file an annual report with the Secretary of State by June 1 each year. The filing fee is $85 online. Missing it can result in administrative dissolution of your LLC.",
    },
    {
      q: "Does Maine require an operating agreement?",
      a: "Yes — Maine is one of the few states that requires LLCs to have an operating agreement. It doesn't need to be filed with the state, but you must have one in place, unlike most other states where it's optional.",
    },
    {
      q: "Does a Maine LLC need an EIN?",
      a: "Yes, in most cases. A Maine LLC with employees is required to get an EIN from the IRS. Even without employees, you'll need one to open a business bank account and register for Maine state tax accounts.",
    },
    {
      q: "Does Maine charge a franchise tax for LLCs?",
      a: "No. Maine does not have a franchise tax on LLCs, unlike states such as California. Your main recurring state obligation is the annual report due June 1, with an $85 filing fee.",
    },
    {
      q: "What is the document called that forms an LLC in Maine?",
      a: "In Maine, it's called a Certificate of Formation — not Articles of Organization, which is the term used in many other states. Both perform the same legal function of creating your LLC.",
    },
  ],
};

export default function MaineLLCPage() {
  return (
    <NavigationWrapper>
