...
const data: StateData = {
  slug: "pennsylvania",
  name: "Pennsylvania",
  pageTitle: "How to Form an LLC in Pennsylvania",
  metaDescription:
    "The Pennsylvania LLC filing fee is $125 for a Certificate of Organization. Learn the annual report requirements, registered agent rules, and expedited options.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$125 (Certificate of Organization, plus $3 per page for paper copies)" },
    { label: "Processing time", value: "Up to 15 business days standard; expedited options for +$100 to +$1,000 (in-person only)" },
    { label: "State agency", value: "Pennsylvania Department of State, Bureau of Corporations and Charitable Organizations" },
    { label: "Annual report due", value: "By September 30 each year; $7 fee" },
    { label: "State tax rate", value: "9.99% Corporate Net Income Tax applies only if taxed as a corporation; pass-through income taxed at individual rates" },
  ],
  introHeading: "How to form an LLC in Pennsylvania",
  introParagraphs: [
    "In Pennsylvania, you register a business by completing and filing your Certificate of Organization with the Pennsylvania Department of State, Bureau of Corporations and Charitable Organizations. You will need to gather information about your business, fill out the form, and send it to the Department of State with your filing fee. Pennsylvania law changed in 2025 to require an annual report ($7 fee) rather than the older decennial (every-10-years) report.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        "Your Pennsylvania LLC name needs to be unique, so check availability via the Pennsylvania Department of State website before filing.",
      ],
    },
    {
      title: "Appoint a Commercial Registered Office Provider",
      body: [
        "Every LLC in Pennsylvania is required to have a registered agent — known in the state as a Commercial Registered Office Provider. If your agent is a person, they must reside in and have a physical street address in Pennsylvania.",
      ],
    },
    {
      title: "File your Certificate of Organization and Docketing Statement",
      body: [
        "File your Certificate of Organization and a required Docketing Statement (which provides the state with your business tax information) through the state's online portal, Penn File, or by mail. The Pennsylvania LLC filing fee is $125, plus $3 per page if you file paper copies.",
      ],
    },
    {
      title: "Get your EIN",
  ...
  extraSections: [
    {
      ...
      paragraphs: [
        "Pennsylvania previously required LLCs to file a decennial report only once every 10 years. Under a 2025 law change, Pennsylvania now requires an annual report instead, due each year by September 30, with a modest $7 filing fee. Failing to file required paperwork or pay fees on time may result in penalties and late fees.",
      ],
    },
    {
      heading: "Restricted professional services",
      paragraphs: [
        "Certain restricted professional services — chiropractic, dentistry, law, medicine and surgery, optometry, osteopathic medicine and surgery, podiatric medicine, public accounting, psychology, or veterinary medicine — have additional annual registration requirements with the state, separate from the standard LLC annual report.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Pennsylvania?",
      a: "The Pennsylvania LLC filing fee is $125 for the Certificate of Organization, plus $3 per page if you file paper copies. After formation, the annual report costs $7 per year, due by September 30.",
    },
    {
      q: "Does Pennsylvania require an annual report for LLCs?",
      a: "Yes, as of a 2025 law change. Pennsylvania now requires LLCs to file an annual report each year by September 30 for a $7 fee, replacing the older decennial (every-10-years) report system.",
    },
    {
      q: "How long does it take to form an LLC in Pennsylvania?",
      a: "Standard processing can take up to 15 business days. Expedited service is available if you file in person: $100 for same-day, $300 for 3-hour, or $1,000 for 1-hour service.",
    },
    {
      q: "Does Pennsylvania allow Series LLCs?",
      a: "No. Although Pennsylvania recognizes foreign series LLCs formed elsewhere, the state does not have a domestic Series LLC offering of its own.",
    },
    {
      q: "Does a Pennsylvania LLC need a registered agent?",
      a: 'Yes. Pennsylvania uses the term "Commercial Registered Office Provider" for what most states call a registered agent. Every LLC must have one with a physical Pennsylvania street address.',
    },
    {
      q: "What is the Docketing Statement in Pennsylvania?",
      a: "When you file your Certificate of Organization with the PA Department of State, you're also required to fill out and submit a Docketing Statement, which provides the state with your business tax information.",
    },
  ],
};

export default function PennsylvaniaLLCPage() {
  return (
    <NavigationWrapper>
