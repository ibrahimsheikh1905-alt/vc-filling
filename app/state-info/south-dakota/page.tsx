...
const data: StateData = {
  slug: "south-dakota",
  name: "South Dakota",
  pageTitle: "South Dakota LLC Filing Fees and Requirements",
  metaDescription:
    "The South Dakota LLC filing fee is $150 ($165 by paper). Annual reports cost $50 online, due by the first day of your LLC's anniversary month.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$150 online or $165 by paper (Articles of Organization)" },
    { label: "Processing time", value: "About 1 business day online; roughly 5 business days by mail" },
    { label: "State agency", value: "South Dakota Secretary of State" },
    { label: "Annual report due", value: "By the first day of the anniversary month; $50 online / $65 by paper" },
    { label: "State tax rate", value: "No state individual or corporate income tax" },
  ],
  introHeading: "How to form an LLC in South Dakota",
  introParagraphs: [
    "Your Articles of Organization can be filed online, by mail, or in person with the South Dakota Secretary of State. The filing fee for a South Dakota LLC is $150 online, with an additional $15 charge if you choose to file via a paper form.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'You\'ll need a name for your LLC that\'s unique and stands out, and isn\'t being used by any other business in the state. All LLCs must have the words "Limited Liability Company," "L.L.C.," or "LLC" in their names, normally at the end.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every South Dakota LLC is obligated to designate a registered agent with a physical street address in South Dakota, present during business hours to receive important documents on behalf of your business.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "File online through the South Dakota Secretary of State's business portal for $150, or by mail for $165. Online filing is processed in about 1 business day; mail filings take about 5 business days.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "An Employer Identification Number (EIN) is essential for IRS identification of your business. This number is used during tax filing, payroll submissions, and employee payments, and is required to establish a business bank account.",
      ],
    },
  ],
  extraSections: [
    {
      ...
      paragraphs: [
        "All South Dakota LLCs must submit an annual report annually to uphold compliance with the Secretary of State. The fee is $50 if filed online, with an additional $15 charge for paper filing. South Dakota annual reports are due every year on the first day of the anniversary month of the date your business was filed. Late filings incur additional penalties.",
      ],
    },
    {
      heading: "Foreign LLC registration in South Dakota",
      paragraphs: [
        "If your LLC was formed in another state but you want to do business in South Dakota, you need to file an Application for Certificate of Authority. The filing fee for a South Dakota Foreign LLC is $750 — among the highest foreign registration fees in the country — with an additional $15 charge for paper filing.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in South Dakota?",
      a: "The South Dakota LLC filing fee is $150 online or $165 by paper. After formation, the annual report costs $50 online or $65 by paper.",
    },
    {
      q: "Does South Dakota require an annual report for LLCs?",
      a: "Yes. All South Dakota LLCs must file an annual report each year by the first day of their anniversary month, for a $50 fee online (or $65 by paper).",
    },
    {
      q: "Does South Dakota have a state income tax?",
      a: "No. South Dakota has no state individual or corporate income tax, which is a significant advantage for LLC owners who live and operate in the state.",
    },
    {
      q: "How expensive is it to register a foreign LLC in South Dakota?",
      a: "Registering a foreign LLC in South Dakota costs $750 — roughly five times the domestic formation fee and one of the highest foreign LLC registration fees in the country. This makes South Dakota a strong choice for residents but a costly option for out-of-state business owners.",
    },
    {
      q: "Does a South Dakota LLC need a registered agent?",
      a: "Yes. Every South Dakota LLC must maintain a registered agent with a physical street address in the state, available during normal business hours.",
    },
    {
      q: "Does South Dakota require an operating agreement?",
      a: "No, South Dakota does not require LLCs to file an operating agreement with the Secretary of State. Even so, many LLC owners create one because it sets internal rules for ownership, management, and profit distribution.",
    },
  ],
};

export default function SouthDakotaLLCPage() {
  return (
    <NavigationWrapper>
