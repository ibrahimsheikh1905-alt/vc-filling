...
const data: StateData = {
  slug: "kentucky",
  name: "Kentucky",
  pageTitle: "Kentucky LLC Filing Fees and Requirements",
  metaDescription:
    "The state filing fee to form a Kentucky LLC is $40 — one of the lowest in the country. Learn every cost and requirement: annual reports, registered agents, EINs, and more.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$40 (Articles of Organization)" },
    { label: "Processing time", value: "Same day or next business day for online filings" },
    { label: "State agency", value: "Kentucky Secretary of State — Kentucky Business One Stop portal (onestop.ky.gov)" },
    { label: "Annual report due", value: "$15 fee; due between January 1 and June 30 each year" },
    {
      label: "State tax rate",
      value: "No separate LLC franchise tax; LLCs taxed based on their federal tax classification",
    },
  ],
  introHeading: "How to form an LLC in Kentucky",
  introParagraphs: [
  ...
  steps: [
    {
      ...
      body: [
        'Your LLC name must be distinguishable from all other business entities on file with the Kentucky Secretary of State and must include an LLC designator like "LLC" or "Limited Liability Company." Check availability using the Secretary of State\'s Business Entity Search before you file.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every Kentucky LLC must appoint and continuously maintain a registered agent with a physical street address in Kentucky. The agent must be available during standard business hours to receive legal documents and official state correspondence.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "The state filing fee to form a Kentucky LLC is $40. That fee applies whether you file online through the Kentucky Business One Stop portal, by mail, or in person — the method doesn't change the cost. Online filings are processed the same day or the next business day.",
        "If you file by mail, make your check payable to \"Kentucky State Treasurer\" and include the original Articles of Organization plus one exact copy.",
      ],
    },
    {
      title: "Create an operating agreement",
      body: [
        "Kentucky does not require an LLC to have an operating agreement, and you don't file one with the state. But having one is worth it — without an operating agreement, your LLC is governed by Kentucky's default statutory rules, which may not match how you want to run your business.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "You'll need an EIN to identify your business to the IRS. You use this number when filing and paying taxes or when submitting payroll information, and it's also required to open a business bank account. It's available at no cost directly from the IRS.",
      ],
    },
  ],
  extraSections: [
    {
      ...
      paragraphs: [
        "Kentucky LLCs must file an annual report with the Secretary of State each year and pay a $15 filing fee. Annual reports are filed online via the state's portal, Kentucky One Stop, and are due between January 1 and June 30 each year.",
      ],
    },
    {
      heading: "Business licenses in Kentucky",
      paragraphs: [
        "Kentucky doesn't have a single statewide general business license. Costs vary based on what licenses your specific business needs — some are free, others carry fees set by state agencies or local governments. Check with your city or county clerk and any relevant state licensing board.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Kentucky?",
      a: "The state filing fee to form a Kentucky LLC is $40 — one of the lowest filing fees in the country. After formation, the annual report costs $15, due between January 1 and June 30 each year.",
    },
    {
      q: "Does Kentucky require an annual report for LLCs?",
      a: "Yes. Kentucky LLCs must file an annual report with the Secretary of State each year for a $15 fee, filed online through the Kentucky Business One Stop portal, due between January 1 and June 30.",
    },
    {
      q: "How long does it take to form an LLC in Kentucky?",
      a: "Online filings through the Kentucky Business One Stop portal are typically processed the same day or the next business day. Mail filings take longer — plan for at least a week if you're not filing online.",
    },
    {
      q: "Does Kentucky require an operating agreement?",
      a: "No. Kentucky does not require an LLC to have an operating agreement, and you don't file one with the state. Having one anyway is recommended, since without it your LLC defaults to Kentucky's statutory rules.",
    },
    {
      q: "Does a Kentucky LLC need a registered agent?",
      a: "Yes. Every Kentucky LLC must appoint and continuously maintain a registered agent with a physical Kentucky street address, available during business hours to receive legal documents.",
    },
    {
      q: "Why is Kentucky's LLC filing fee so low?",
      a: "Kentucky's $40 filing fee is set by the state and has remained one of the lowest in the country. Along with the modest $15 annual report fee, it makes Kentucky one of the more budget-friendly states for both forming and maintaining an LLC.",
    },
  ],
};
