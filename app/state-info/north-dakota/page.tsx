...
const data: StateData = {
  slug: "north-dakota",
  name: "North Dakota",
  pageTitle: "North Dakota LLC Filing Fees and Requirements",
  metaDescription:
    "The North Dakota LLC filing fee is $135, filed through the Secretary of State's FirstStop portal. Annual report costs $50, due by November 15.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$135 (Articles of Organization, FirstStop portal)" },
    { label: "Processing time", value: "Up to 4 weeks; North Dakota does not offer expedited filing" },
    { label: "State agency", value: "North Dakota Secretary of State" },
    { label: "Annual report due", value: "By November 15 each year (farm/ranch LLCs use April 15); $50 fee" },
    { label: "State tax rate", value: "No franchise tax on LLCs; corporate income tax applies only if taxed as a C Corp" },
  ],
  introHeading: "How to form an LLC in North Dakota",
  introParagraphs: [
    "In North Dakota, you register a business by creating a FirstStop account, logging in, and completing and filing your Articles of Organization with the North Dakota Secretary of State. The North Dakota LLC filing fee is $135. Unfortunately, North Dakota does not offer expedited filing like many other states.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Your name must be unique, so check if another business is already using it via the North Dakota Secretary of State website. The name must end with "Limited Liability Company," "LLC," or "L.L.C."',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every North Dakota LLC must appoint a registered agent with a physical North Dakota address (no P.O. boxes) to receive legal notices and official state correspondence.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "File your Articles of Organization on the Secretary of State's FirstStop business portal. The filing fee is $135. It can take up to 4 weeks for the North Dakota Secretary of State to legally create your LLC.",
      ],
    },
    {
      title: "Get your EIN",
  ...
  extraSections: [
    {
      ...
      paragraphs: [
        "For the state of North Dakota, the Secretary of State requires you to file an annual report every year. You'll log in to the FirstStop portal to file and pay a fee of $50. The deadline is November 15 for most LLCs (farm and ranch LLCs use an April 15 deadline instead). Filing late adds a $50 penalty.",
        "Missing the annual report is not just a late penalty — the state can move your LLC into Not Good Standing, and can terminate or revoke it within 6 to 12 months if the past-due report stays unresolved.",
      ],
    },
    {
      heading: "Business licenses in North Dakota",
      paragraphs: [
        "As a business owner, it's your responsibility to make sure you have the proper state, federal, or local business licenses to operate your North Dakota LLC. Requirements vary based on the industry your LLC operates in and its location.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in North Dakota?",
      a: "The North Dakota LLC filing fee is $135 for Articles of Organization. After formation, the annual report costs $50, due by November 15 each year for most LLCs.",
    },
    {
      q: "Does North Dakota require an annual report for LLCs?",
      a: "Yes. North Dakota requires an annual report filed through the FirstStop portal each year for a $50 fee, due by November 15 (or April 15 for farm and ranch LLCs).",
    },
    {
      q: "How long does it take to form an LLC in North Dakota?",
      a: "It can take up to 4 weeks for the North Dakota Secretary of State to legally create your LLC. North Dakota does not offer expedited filing.",
    },
    {
      q: "Does North Dakota charge a franchise tax for LLCs?",
      a: "No. North Dakota does not have a franchise tax for the privilege of doing business. LLCs are not subject to the state's corporate income tax unless treated as a C Corporation for tax purposes.",
    },
    {
      q: "Does a North Dakota LLC need a registered agent?",
      a: "Yes. Every LLC in North Dakota is required to have a registered agent with a physical North Dakota street address, appointed when you file your Articles of Organization.",
    },
    {
      q: "What happens if I miss North Dakota's annual report deadline?",
      a: "Filing late adds a $50 penalty. If the past-due report stays unresolved, the state can move your LLC into Not Good Standing and eventually terminate or revoke it, after which you generally have 1 year to reinstate.",
    },
  ],
};

export default function NorthDakotaLLCPage() {
  return (
    <NavigationWrapper>
