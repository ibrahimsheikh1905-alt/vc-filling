...
const data: StateData = {
  slug: "texas",
  name: "Texas",
  pageTitle: "How to Form a Texas LLC: Steps, Costs, and Benefits",
  metaDescription:
    "Learn how to form a Texas LLC. File your Certificate of Formation for the $300 state fee, with a free first year of registered agent service.",
  readTime: "7 min read",
  glance: [
    { label: "Filing fee", value: "$300 online through SOSDirect, or $308 by mail (Certificate of Formation, Form 205)" },
    { label: "Processing time", value: "Standard: 5–7 business days; expedited: same day or next day for +$25" },
    { label: "State agency", value: "Texas Secretary of State" },
    { label: "Annual report due", value: "No traditional annual report; Franchise Tax Report + Public Information Report due May 15 each year" },
    { label: "State tax rate", value: "No state income tax; franchise tax 0.375% (retail/wholesale) or 0.75% (most other businesses) of taxable margin" },
  ],
  introHeading: "How to form an LLC in Texas",
  introParagraphs: [
    "Forming a Texas LLC means filing a Certificate of Formation (Form 205) with the Texas Secretary of State, paying the $300 state fee, and appointing a registered agent with a Texas street address. Texas has no state income tax, and most small LLCs fall below the franchise tax threshold — making it one of the more business-friendly states to form in.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Your LLC name must be distinguishable from existing Texas business names and include "Limited Liability Company," "LLC," or "L.L.C." You can reserve a name for 120 days by filing Form 501 with the Texas Secretary of State.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every Texas LLC needs a registered agent with a physical Texas street address — not a P.O. Box — available during normal business hours to receive legal documents and official correspondence.",
      ],
    },
    {
      title: "File your Certificate of Formation",
      body: [
        "You file Form 205 with the Texas Secretary of State and pay a $300 filing fee. You can file online through SOSDirect or by mail — online filing is faster, though a small card-processing fee applies. Standard processing through SOSDirect runs 5–7 business days.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "The online IRS application typically assigns your EIN immediately. You'll need it to open a business bank account, hire employees, and file taxes.",
      ],
    },
    {
      title: "Register for state taxes if needed",
      body: [
        "If your LLC sells taxable goods or services in Texas, you need a Sales and Use Tax Permit from the Texas Comptroller before making your first taxable sale.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "Texas franchise tax and Public Information Report",
      paragraphs: [
        "Texas LLCs don't file a traditional annual report with the Secretary of State. Instead, most owe the Texas franchise tax annually (due May 15). The franchise tax rate is 0.75% of taxable margin for most businesses, or 0.375% for qualifying retail and wholesale businesses. Businesses with annualized total revenue at or below the no-tax-due threshold (around $2.47–$2.65 million) owe no franchise tax but still must file a No Tax Due Report along with a Public Information Report.",
      ],
    },
    {
      heading: "Business licenses in Texas",
      paragraphs: [
  ...
  faqs: [
    {
      ...
      a: "The state filing fee is $300 if you file online through SOSDirect, or $308 by mail. That's the only required upfront cost. An EIN from the IRS is free.",
    },
    {
      q: "Does Texas require an annual report for LLCs?",
      a: "Texas LLCs don't file a traditional annual report with the Secretary of State. Instead, most owe the Texas franchise tax annually (due May 15) along with a Public Information Report, even if no tax is owed.",
    },
    {
      q: "Does Texas have a state income tax?",
      a: "No. Texas has no state personal income tax and no state corporate income tax. The main state-level cost is the franchise tax, though many small LLCs fall below the no-tax-due threshold and owe nothing.",
    },
    {
      q: "Does a Texas LLC need a registered agent?",
      a: "Yes. Every LLC formed or registered to do business in Texas must maintain a registered agent at all times, with a physical Texas street address — not a P.O. Box.",
    },
    {
      q: "How long does it take to form an LLC in Texas?",
      a: "Standard processing through SOSDirect runs 5–7 business days. Expedited same-day or next-day processing is available for an additional $25.",
    },
    {
      q: "Are there fee waivers for veteran-owned Texas LLCs?",
      a: "Yes. Qualifying new veteran-owned businesses that are 100% veteran-owned and formed within a specific window can form a Texas LLC with a $0 state filing fee and pay $0 franchise tax for the first five years, per Texas Comptroller rules.",
    },
  ],
};

export default function TexasLLCPage() {
  return (
    <NavigationWrapper>
