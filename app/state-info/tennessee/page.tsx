...
const data: StateData = {
  slug: "tennessee",
  name: "Tennessee",
  pageTitle: "How to Form an LLC in Tennessee",
  metaDescription:
    "Learn how to form an LLC in Tennessee: Articles of Organization, state filing fees ($300 minimum), registered agent requirements, and post-formation steps.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$50 per member ($300 minimum, $3,000 maximum)" },
    { label: "Processing time", value: "As little as 1 day for online filings through TNBear" },
    { label: "State agency", value: "Tennessee Secretary of State, Business Services Division" },
    { label: "Annual report due", value: "April 1 for calendar-year LLCs; same $50-per-member fee structure ($300 min, $3,000 max)" },
    { label: "State tax rate", value: "Franchise tax: 0.25% of net worth ($100 minimum); Excise tax: 6.5% of net earnings" },
  ],
  introHeading: "How to form an LLC in Tennessee",
  introParagraphs: [
    "To form an LLC in Tennessee, you file Articles of Organization with the Tennessee Secretary of State's Business Services Division and pay a state filing fee of at least $300. The fee is calculated at $50 per member, with a $300 minimum and a $3,000 maximum. Tennessee's per-member fee structure is different from most states — it's based on how many members your LLC has, not a flat rate.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Your LLC name must include "Limited Liability Company," "LLC," or "L.L.C." at the end, and be distinguishable from other business names already on file. If you want to hold a name before filing, Tennessee lets you reserve it for a $20 fee.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every Tennessee LLC must designate a registered agent — a person or business entity with a physical street address in Tennessee where legal documents can be received during normal business hours. A P.O. Box does not qualify.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "File online through the Tennessee Secretary of State's TNBear portal at tnbear.tn.gov, by mail, or by email. The filing fee is $50 per member, with a $300 minimum and a $3,000 maximum. A single-member LLC pays $300. An LLC with 10 members pays $500.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "An Employer Identification Number (EIN) is a federal tax ID issued by the IRS. Every LLC should have one — it's required to open a business bank account, hire employees, and file federal taxes.",
      ],
    },
  ],
  extraSections: [
    {
      ...
      paragraphs: [
        "Tennessee LLCs must file an annual report with the Secretary of State each year to stay in good standing. The fee uses the same member-based structure as the formation filing: $50 per member, with a $300 minimum and $3,000 maximum. For LLCs on a calendar fiscal year, the annual report is due April 1.",
      ],
    },
    {
      heading: "Franchise and excise tax",
      paragraphs: [
        "Tennessee imposes both a franchise tax and an excise tax on LLCs registered to do business in the state. The franchise tax is 0.25% of Tennessee net worth, with a $100 minimum. The excise tax is 6.5% of net earnings. Both apply even if your LLC is inactive, unless it has been dissolved or qualifies for an exemption.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Tennessee?",
      a: "The Tennessee filing fee is $50 per member, with a $300 minimum and a $3,000 maximum. Most single-member and small LLCs pay the $300 minimum. The annual report uses the same fee structure.",
    },
    {
      q: "Does Tennessee require an annual report for LLCs?",
      a: "Yes. Tennessee LLCs must file an annual report each year using the same $50-per-member fee structure ($300 minimum, $3,000 maximum). For calendar-year LLCs, it's due April 1.",
    },
    {
      q: "Does Tennessee charge a franchise tax for LLCs?",
      a: "Yes. Tennessee imposes a franchise tax of 0.25% of Tennessee net worth ($100 minimum) plus an excise tax of 6.5% of net earnings. Both apply even if your LLC is inactive, unless dissolved or exempt.",
    },
    {
      q: "Does a Tennessee LLC need a registered agent?",
      a: "Yes. Every LLC formed in Tennessee is required by state law to maintain a registered agent at all times, with a physical Tennessee street address — a P.O. box doesn't qualify.",
    },
    {
      q: "Does Tennessee allow Series LLCs?",
      a: "Yes. To create a Series LLC in Tennessee, you indicate that intent when you file your Articles of Organization, and you'll be required to pay an additional fee for the series designation.",
    },
    {
      q: "Does Tennessee require an operating agreement?",
      a: "No, the Tennessee Limited Liability Company Act doesn't require operating agreements, but the Act itself runs over 100 pages of rules, so many LLC owners create their own agreement for more flexibility and clarity.",
    },
  ],
};

export default function TennesseeLLCPage() {
  return (
    <NavigationWrapper>
