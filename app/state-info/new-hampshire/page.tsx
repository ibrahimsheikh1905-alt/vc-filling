...
const data: StateData = {
  slug: "new-hampshire",
  name: "New Hampshire",
  pageTitle: "New Hampshire LLC Filing Fees and Requirements",
  metaDescription:
    "Forming an LLC in New Hampshire starts with a Certificate of Formation: $100 by mail or $102 online through NH QuickStart. Annual report due April 1.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$100 by mail or $102 online (Certificate of Formation, Form LLC-1)" },
    { label: "Processing time", value: "10 business days or less standard; expedited available for +$25" },
    { label: "State agency", value: "New Hampshire Secretary of State, Corporation Division" },
    { label: "Annual report due", value: "April 1 each year (first report due the calendar year after formation); $100 fee" },
    { label: "State tax rate", value: "No state income tax on wages; Business Profits Tax and Business Enterprise Tax apply to qualifying businesses" },
  ],
  introHeading: "How to form an LLC in New Hampshire",
  introParagraphs: [
    "Forming an LLC in New Hampshire starts with filing a Certificate of Formation (Form LLC-1) with the New Hampshire Secretary of State and paying a $100 state fee — or $102 if you file online through the NH QuickStart system. Beyond formation, you'll need a registered agent, an annual report filed by April 1 each year, and any business licenses your industry requires.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Your LLC name must contain "Limited Liability Company," "LLC," or "L.L.C." and must be distinguishable from any existing entity on file with the Secretary of State. If you want to lock in a name before filing, New Hampshire lets you reserve it for $15 for 120 days.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every New Hampshire LLC must designate a registered agent with a physical street address in New Hampshire — P.O. Box addresses don't qualify. The registered agent needs to be available during normal business hours to receive service of process and official state correspondence.",
      ],
    },
    {
      title: "File your Certificate of Formation",
      body: [
        "You file the Certificate of Formation (Form LLC-1) with the New Hampshire Secretary of State, Corporation Division. The state fee is $100 for paper filing or $102 online — the extra $2 is an electronic processing charge. Standard processing takes 10 business days or less; expedited service is available for an additional $25.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "An EIN is required for LLCs that will have employees, and most banks require one to open a business bank account. You can apply directly through the IRS at no cost.",
      ],
    },
  ],
  extraSections: [
    {
      ...
      paragraphs: [
        "New Hampshire requires LLCs to file an annual report between January 1 and April 1 each year. The filing fee is $100, and late filings are subject to a $50 penalty.",
      ],
    },
    {
      heading: "Business licenses in New Hampshire",
      paragraphs: [
        "New Hampshire doesn't have a single statewide general business license, but your LLC may need specific licenses or permits depending on your industry, location, and the type of work you do. Check with the Secretary of State's office and your local municipality.",
      ],
    },
  ],
  faqs: [
    {
      ...
      a: "The New Hampshire Certificate of Formation fee is $100 for paper filing and $102 for online filing through NH QuickStart. After formation, the annual report costs $100 per year, due by April 1.",
    },
    {
      q: "Does New Hampshire require an annual report for LLCs?",
      a: "Yes. New Hampshire LLCs must file an annual report with the Secretary of State by April 1 each year. The filing fee is $100, and late filings carry a $50 penalty.",
    },
    {
      q: "Does New Hampshire require an operating agreement?",
      a: "No. New Hampshire law does not require an LLC to have a written operating agreement, and you don't file one with the state. Most attorneys recommend having one anyway to document ownership and management.",
    },
    {
      q: "Does a New Hampshire LLC need a registered agent?",
      a: "Yes. Every New Hampshire LLC must designate a registered agent with a physical street address in the state, available during normal business hours to receive legal and government correspondence.",
    },
    {
      q: "How do I register a foreign LLC in New Hampshire?",
      a: "File an Application for Foreign Limited Liability Company Registration (Form FLLC-1) with the New Hampshire Secretary of State. The filing fee is $100 by mail or $102 online, the same as domestic formation.",
    },
    {
      q: "Does New Hampshire have a state income tax?",
      a: "No, not on wages. New Hampshire's Business Profits Tax and Business Enterprise Tax apply to qualifying businesses instead — a tax professional can help you figure out whether your LLC is subject to either.",
    },
  ],
};

export default function NewHampshireLLCPage() {
  return (
    <NavigationWrapper>
