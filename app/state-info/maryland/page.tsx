...
const data: StateData = {
  slug: "maryland",
  name: "Maryland",
  pageTitle: "Maryland LLC Filing Fees and Requirements",
  metaDescription:
    "Forming an LLC in Maryland costs $100 in state fees, with a $300 annual report due every April 15. See every fee, form, and deadline you need to know.",
  readTime: "7 min read",
  glance: [
    { label: "Filing fee", value: "$100 online (or $150 by mail) — Articles of Organization" },
    {
      label: "Processing time",
      value: "6–8 weeks standard; 7–10 business days expedited (+$50); same-day if filed online by 2:30 PM (+$325)",
    },
    { label: "State agency", value: "Maryland State Department of Assessments and Taxation (SDAT)" },
    { label: "Annual report due", value: "April 15 each year; $300 filing fee" },
    {
      label: "State tax rate",
      value: "No franchise tax; pass-through income taxed at Maryland individual rates (2%–5.75%)",
    },
  ],
  introHeading: "How to form an LLC in Maryland",
  introParagraphs: [
    "To form an LLC in Maryland, you file Articles of Organization with the Maryland State Department of Assessments and Taxation (SDAT), pay the $100 online filing fee, appoint a registered agent with a Maryland address, and get a federal EIN from the IRS. Most online filings are processed in 7–10 business days.",
  ...
  steps: [
    {
      ...
      body: [
        'Your LLC name must include "Limited Liability Company," "LLC," or "L.L.C." and can\'t duplicate a name already on file with SDAT. You can reserve a business name for $25 by filing the Corporate Name Reservation Application with SDAT.',
      ],
    },
    {
      title: "Appoint a resident agent",
      body: [
        "Every Maryland LLC needs a registered agent — called a Resident Agent in Maryland — with a physical Maryland street address. A P.O. box doesn't qualify. You can serve as your own resident agent if you have a Maryland address and are available during business hours.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "The Articles of Organization is the formation document you file with SDAT. You can file online through Maryland Business Express for $100, or by mail for $150. Online is faster — most filings are processed in 7–10 business days, or 6–8 weeks for standard mail processing.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "An Employer Identification Number (EIN) is your LLC's federal tax ID. You'll need it to open a business bank account, file taxes, and pay employees. The IRS issues EINs at no cost.",
      ],
    },
    {
      title: "Check business license requirements",
      body: [
        "Depending on your industry and location, you may need a state business license, a county license, or both. Maryland's OneStop portal at onestop.md.gov is a good starting point for figuring out which licenses apply to your business.",
      ],
    },
  ],
  extraSections: [
    {
      ...
      paragraphs: [
        "Maryland LLCs must file an annual report with SDAT by April 15 each year. The filing fee is $300 — among the higher annual entity fees in the country. Missing the deadline doesn't immediately dissolve your LLC, but SDAT can forfeit your business's good standing, and reinstating a forfeited LLC costs more than staying current.",
        "If you need more time for the personal property portion of the filing, you can request an electronic extension through Maryland Business Express by April 15. The $300 annual report fee is still due by April 15 even if you get the extension — the extension covers the personal property return, not the fee itself.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Maryland?",
      a: "The base state fee is $100 to file Articles of Organization online through Maryland Business Express, or $150 by mail. After formation, the annual report costs $300 per year, due by April 15.",
    },
    {
      q: "Does Maryland require an annual report for LLCs?",
      a: "Yes. Maryland LLCs must file an annual report with SDAT by April 15 each year for a $300 fee — one of the higher annual report fees among all states. Missing the deadline can put your LLC out of good standing.",
    },
    {
      q: "How long does it take to form an LLC in Maryland?",
      a: "Standard processing takes 6–8 weeks. If you need faster approval, expedited review (7–10 business days) costs an additional $50, and same-day service costs an additional $325 if filed online through Maryland Business Express by 2:30 PM.",
    },
    {
      q: "Does Maryland charge a franchise tax for LLCs?",
      a: "No. Maryland does not have a franchise tax on LLCs. Maryland LLC owners pay Maryland state income tax on pass-through profits at individual rates, plus a 6% state sales tax on taxable goods and services.",
    },
    {
      q: "Does a Maryland LLC need a resident agent?",
      a: "Yes. Maryland law requires every LLC to designate a resident agent — Maryland's term for a registered agent — with a physical Maryland street address, listed in your Articles of Organization.",
    },
    {
      q: "How do I register a foreign LLC in Maryland?",
      a: "If your LLC was formed in another state but you want to do business in Maryland, you need to register with SDAT using a Limited Liability Company Registration for non-Maryland LLC form and pay a $100 filing fee. Foreign LLCs are also subject to the same $300 annual report requirement.",
    },
  ],
};

export default function MarylandLLCPage() {
  return (
    <NavigationWrapper>
