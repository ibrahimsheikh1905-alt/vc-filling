...
const data: StateData = {
  slug: "ohio",
  name: "Ohio",
  pageTitle: "Ohio LLC Filing Fees and Requirements",
  metaDescription:
    "Forming an LLC in Ohio costs $99 to file Articles of Organization with the Ohio Secretary of State. Ohio doesn't require LLCs to file annual reports.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$99 (Articles of Organization, Form 610)" },
    { label: "Processing time", value: "3–7 business days; expedited options for +$100, +$200, or +$300" },
    { label: "State agency", value: "Ohio Secretary of State" },
    { label: "Annual report due", value: "Not required — Ohio LLCs don't file periodic reports" },
    { label: "State tax rate", value: "No state income tax on LLCs directly; Commercial Activity Tax (CAT) may apply if gross receipts exceed $150,000" },
  ],
  introHeading: "How to form an LLC in Ohio",
  introParagraphs: [
    "To form an LLC in Ohio, you file Articles of Organization (Form 610) with the Ohio Secretary of State and pay the $99 state filing fee. You can file online through Ohio Business Central, by mail, or in person. Ohio skips the annual report requirement, which keeps ongoing costs lower than many other states.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Your LLC name must include "Limited Liability Company," "LLC," or "L.L.C." and be distinguishable from other registered businesses in the state.',
      ],
    },
    {
      title: "Appoint a statutory agent",
      body: [
        "Every Ohio LLC must designate a statutory agent — Ohio's term for a registered agent — with a physical Ohio address who can receive legal documents and official state correspondence on your behalf.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "Your Articles of Organization need to include your LLC's name, the name and address of your registered agent, and the signature of an authorized organizer. Over 90% of Ohio business filings are submitted online through Ohio Business Central. The base filing fee is $99, and online filings are generally processed within about 1 business day. Mail filings take about 1 week.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "An Employer Identification Number (EIN) is a nine-digit number the IRS assigns to identify your business for tax purposes. You'll need one to open a business bank account, hire employees, and file federal taxes.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "No annual report required",
      paragraphs: [
        "Ohio does not require LLCs to file annual reports. That's one of the more business-friendly aspects of forming an LLC here — no recurring state filing fee just to stay in good standing. You still need to keep your statutory agent information current with the Secretary of State.",
      ],
    },
    {
      heading: "Ohio's Commercial Activity Tax",
      paragraphs: [
        "Ohio does not impose a state income tax directly on LLCs. Instead, LLC income passes through to members, who report it on their personal Ohio income tax returns. If your LLC's gross receipts exceed $150,000 per year, the Commercial Activity Tax (CAT) may apply. If your business sells taxable goods or services, you'll also need an Ohio vendor's license.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Ohio?",
      a: "The base filing fee to form an Ohio LLC is $99, paid to the Ohio Secretary of State. Ohio also offers expedited processing for an additional $100, $200, or $300 above the base fee if you need faster approval.",
    },
    {
      q: "Does Ohio require an annual report for LLCs?",
      a: "No. Ohio doesn't charge an annual report fee for LLCs because Ohio LLCs aren't required to file periodic reports with the Secretary of State — the $99 formation fee is the main state cost at startup.",
    },
    {
      q: "How long does it take to form an LLC in Ohio?",
      a: "Online filings through Ohio Business Central are generally processed within about 1 business day. Mail filings take about 1 week from when the Secretary of State receives the documents. Expedited processing (1-2 business days or 4 hours) is available for an additional fee.",
    },
    {
      q: "Does Ohio charge a franchise tax for LLCs?",
      a: "No, not directly. Ohio LLC income passes through to members' personal returns. If your LLC's gross receipts exceed $150,000 per year, the Commercial Activity Tax (CAT) may apply instead.",
    },
    {
      q: "Does an Ohio LLC need a statutory agent?",
      a: "Yes. Every LLC in Ohio is required to have a statutory agent (Ohio's term for a registered agent) with a physical Ohio street address, appointed when you file your Articles of Organization.",
    },
    {
      q: "Does Ohio require a business license?",
      a: "Most likely, yes, though it depends on your industry. If your LLC sells taxable goods or services, you'll need an Ohio vendor's license from the Ohio Department of Taxation. Industry-specific licenses vary by field.",
    },
  ],
};

export default function OhioLLCPage() {
  return (
    <NavigationWrapper>
