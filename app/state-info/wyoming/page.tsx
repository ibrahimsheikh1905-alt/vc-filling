...
const data: StateData = {
  slug: "wyoming",
  name: "Wyoming",
  pageTitle: "How to Form an LLC in Wyoming",
  metaDescription:
    "Learn how to form an LLC in Wyoming: $100 state filing fee, Articles of Organization, registered agent requirements, annual report deadlines, and EIN.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$100 online (+2.4% card fee, min $1) or $102 by paper (Articles of Organization)" },
    { label: "Processing time", value: "Up to 15 business days; Wyoming does not offer expedited filing" },
    { label: "State agency", value: "Wyoming Secretary of State" },
    { label: "Annual report due", value: "First day of the LLC's anniversary month; greater of $60 or $0.0002 per dollar of Wyoming assets" },
    { label: "State tax rate", value: "No state income tax — personal or corporate" },
  ],
  introHeading: "How to form an LLC in Wyoming",
  introParagraphs: [
    "To form an LLC in Wyoming, you file Articles of Organization with the Wyoming Secretary of State, pay the $100 state filing fee, and designate a registered agent with a physical Wyoming address. Wyoming was the first state in the U.S. to recognize LLCs, and has no personal or corporate income tax, a low formation fee, and consistently ranks at or near the top of the Tax Foundation's State Business Tax Climate Index.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Wyoming law (Wyo. Stat. § 17-29-108) requires your name to include a designator — "limited liability company," "limited company," "LLC," "L.L.C.," "LC," or "L.C." — and be distinguishable from every other business name on file with the Secretary of State. You can reserve a name for $60 by mail if you\'re not ready to file yet.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Wyoming law requires every LLC to maintain a registered agent in the state at all times. The agent must be either a Wyoming resident or a business entity authorized to operate in Wyoming, with a physical street address — not a P.O. box.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "File through the WyoBiz Online Services portal or by paper form. The state filing fee is $100. Online filers pay an additional 2.4% credit card processing fee (minimum $1). The Articles must include your LLC name, registered agent information, and management structure.",
      ],
    },
    {
      title: "Draft an operating agreement",
      body: [
        "Wyoming doesn't require LLCs to file an operating agreement with the state, but having one is worth the effort — it sets out how the business is owned, how decisions get made, and how profits are split.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "An Employer Identification Number (EIN) is your LLC's federal tax ID. You'll need one to open a business bank account, hire employees, and file federal taxes. Apply online at irs.gov/ein — the IRS issues the EIN immediately upon completion.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "Annual report and license tax",
      paragraphs: [
        "Wyoming LLCs must file an annual report with the Secretary of State every year. The report is due on the first day of the LLC's anniversary month. The filing includes payment of an annual license tax — the greater of $60 or $0.0002 per dollar of assets located and employed in Wyoming.",
      ],
    },
    {
      heading: "Business licenses in Wyoming",
      paragraphs: [
        "Wyoming doesn't have a general statewide business license, but your LLC may need specific licenses or permits depending on your industry and location. Requirements vary by business type, city, and county.",
      ],
    },
  ],
  faqs: [
    {
      ...
      a: "The Wyoming LLC filing fee is $100 online (plus a 2.4% credit card processing fee, minimum $1) or $102 by paper. After formation, the annual report license tax is the greater of $60 or $0.0002 per dollar of Wyoming assets.",
    },
    {
      q: "Does Wyoming require an annual report for LLCs?",
      a: "Yes. Wyoming LLCs must file an annual report each year, due on the first day of the LLC's anniversary month, along with the annual license tax (minimum $60).",
    },
    {
      q: "Why do people form LLCs in Wyoming?",
      a: "Wyoming was the first state to recognize LLCs and has no personal or corporate income tax, a $100 formation fee, and consistently ranks at or near the top of the Tax Foundation's State Business Tax Climate Index — making it popular for privacy-conscious and out-of-state filers.",
    },
    {
      q: "How long does it take to form an LLC in Wyoming?",
      a: "It can take up to 15 business days for the Wyoming Secretary of State to legally create your LLC. Wyoming statutes do not currently allow for expedited filing — filings are processed in the order received.",
    },
    {
      q: "Does a Wyoming LLC need a registered agent?",
      a: "Yes. Wyoming law requires every LLC to maintain a registered agent in the state at all times, with a physical Wyoming street address and written consent to the appointment.",
    },
    {
      q: "Does Wyoming require an operating agreement?",
      a: "No, Wyoming doesn't require LLCs to file an operating agreement with the state, but having one is worth the effort to define ownership and management structure.",
    },
  ],
};
