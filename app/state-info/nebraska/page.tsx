...
const data: StateData = {
  slug: "nebraska",
  name: "Nebraska",
  pageTitle: "Nebraska LLC Filing Fees and Requirements",
  metaDescription:
    "Forming an LLC in Nebraska starts with a Certificate of Organization: $100 online or $110 by mail. Nebraska also requires a 3-week newspaper publication.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$100 online or $110 by mail (Certificate of Organization)" },
    { label: "Processing time", value: "5–7 business days online; 7–10 business days by mail" },
    { label: "State agency", value: "Nebraska Secretary of State, Business Services Division" },
    {
      label: "Annual report due",
      value: "Biennial report, filed January 1–April 1 of odd-numbered years; $25 online / $30 by mail",
    },
    { label: "State tax rate", value: "No state-level LLC franchise tax; Nebraska individual income tax rates apply to pass-through income" },
  ],
  introHeading: "How to form an LLC in Nebraska",
  introParagraphs: [
  ...
  steps: [
    {
      ...
      body: [
        "The Certificate of Organization is the primary formation document for a Nebraska LLC. You file it with the Nebraska Secretary of State, Business Services Division — either online through the Secretary of State's eDelivery system or by mailing a signed PDF. Online filing costs $100; paper filing costs $110.",
      ],
    },
    {
      title: "Publish your Notice of Organization",
      body: [
        "Nebraska is one of a small number of states that requires new LLCs to publish a Notice of Organization in a newspaper. Under Nebraska Revised Statute § 21-193, you need to publish the notice once per week for 3 consecutive weeks in a legal newspaper of general circulation in the county where your LLC's designated office is located. Publication costs vary by newspaper and county — budget for this separately from your state filing fee.",
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Nebraska requires all LLCs to maintain a registered agent with a Nebraska street address, available during normal business hours to receive legal documents and official state correspondence.",
      ],
    },
    {
      title: "Get your EIN",
  ...
  extraSections: [
    {
      ...
      paragraphs: [
        "Nebraska doesn't require an annual report — it requires a biennial report, filed every other year. The filing window runs from January 1 through April 1 of each odd-numbered year. The biennial report fee is $25 if filed online through the Secretary of State's Online Filing System, or $30 if filed in writing. Missing the April 1 deadline can put your LLC out of good standing with the state.",
      ],
    },
    {
      heading: "Operating agreements in Nebraska",
      paragraphs: [
        "Nebraska doesn't legally require an LLC operating agreement, but having one is worth the effort. It sets out how your business is run, how profits are split, and what happens if the business dissolves. Without one, Nebraska's default LLC statutes fill in the gaps.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Nebraska?",
      a: "The Nebraska state filing fee for a Certificate of Organization is $100 when filed online and $110 when filed by paper. Add the cost of the required newspaper publication, which varies by county.",
    },
    {
      q: "Does Nebraska require an annual report for LLCs?",
      a: "No — Nebraska requires a biennial report instead, filed every other year between January 1 and April 1 of odd-numbered years. The fee is $25 online or $30 by mail.",
    },
    {
      q: "Why does Nebraska require newspaper publication?",
      a: "Under Nebraska Revised Statute § 21-193, new LLCs must publish a Notice of Organization once a week for 3 consecutive weeks in a legal newspaper of general circulation in the county of the LLC's designated office. This is a step most states don't require and often catches first-time filers off guard.",
    },
    {
      q: "Does a Nebraska LLC need a registered agent?",
      a: "Yes. Nebraska requires all LLCs to maintain a registered agent with a physical Nebraska street address, available during normal business hours.",
    },
    {
      q: "How do I register a foreign LLC in Nebraska?",
      a: "Complete an Application for Certificate of Authority form and pay a $100 filing fee, plus $10 for the certificate and a $5 per-page filing fee.",
    },
    {
      q: "Does Nebraska charge a franchise tax for LLCs?",
      a: "LLCs are generally exempt from Nebraska's corporate income tax (sometimes referred to as a franchise-style tax) unless they elect to file taxes as a corporation. A tax professional can help you figure out whether it applies to your situation.",
    },
  ],
};

export default function NebraskaLLCPage() {
  return (
    <NavigationWrapper>
