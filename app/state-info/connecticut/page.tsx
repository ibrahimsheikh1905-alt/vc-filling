...
const data: StateData = {
  slug: "connecticut",
  name: "Connecticut",
  pageTitle: "How to Start an LLC in Connecticut",
  metaDescription:
    "Learn how to start an LLC in Connecticut: Certificate of Organization, the $120 state filing fee, registered agent requirements, EIN, and annual report deadlines.",
  readTime: "7 min read",
  glance: [
    { label: "Filing fee", value: "$120 (Certificate of Organization)" },
    { label: "Processing time", value: "Typically 3–5 business days for online filings" },
    { label: "State agency", value: "Connecticut Secretary of the State" },
    { label: "Annual report due", value: "Annually by March 31; $80 filing fee" },
    {
      label: "State tax rate",
      value:
        "No state-level LLC franchise tax; pass-through income taxed at individual rates (6.99% top marginal rate)",
    },
  ],
  introHeading: "How to start an LLC in Connecticut",
  introParagraphs: [
    "To start an LLC in Connecticut, you file a Certificate of Organization with the Connecticut Secretary of the State, pay the $120 state filing fee, and designate a registered agent with a Connecticut address. Most online filings are processed in 3–5 business days.",
    "Connecticut doesn't impose a separate franchise tax on LLCs, which keeps ongoing costs lower than in states like California. Pass-through income flows to members and gets taxed at individual rates, so the business itself doesn't pay state income tax.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Your LLC name must include "Limited Liability Company," "LLC," or "L.L.C." and be distinguishable from every other business name already registered with the Connecticut Secretary of the State. Before you file, search the state\'s business name database to check availability. Connecticut doesn\'t require you to reserve a name before filing, but reservation is available if you want to lock in a name while you prepare your paperwork.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Your registered agent must be either a Connecticut resident who is at least 18 years old or a business entity registered with the Secretary of the State with a Connecticut address. You can serve as your own registered agent if you meet those requirements, or appoint a friend, family member, or professional service.",
      ],
    },
    {
      title: "File your Certificate of Organization",
      body: [
        "The Certificate of Organization is the document that officially forms your LLC in Connecticut. You file it with the Connecticut Secretary of the State and pay the $120 state filing fee. Online filing through business.ct.gov is the fastest option and typically processes in 3–5 business days.",
        "The Certificate needs to include your LLC's name, its mailing address and principal office address in Connecticut, the name and address of your registered agent, and a statement of purpose.",
      ],
    },
    {
      title: "Create an operating agreement",
      body: [
        "Connecticut doesn't require you to file an operating agreement with the state, but you should have one before your LLC does any business. It's the internal document that spells out how your LLC is owned and managed — member contributions, profit and loss allocation, voting rights, and what happens if a member wants to leave.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "If your LLC has employees or is taxed as a corporation or partnership, you need an Employer Identification Number (EIN) from the IRS. Even single-member LLCs with no employees benefit from an EIN — it keeps your Social Security number off business documents and bank applications. Applications are free at irs.gov.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "Annual report and ongoing compliance",
      paragraphs: [
        "Connecticut requires all domestic and foreign LLCs to file an annual report with the Secretary of the State by March 31 each year. The filing fee is $80. Annual reports must be filed online through business.ct.gov — the state doesn't offer a standard mail-in option for routine LLC annual report filings.",
      ],
    },
    {
      heading: "Business licenses in Connecticut",
      paragraphs: [
        "Connecticut doesn't issue a single general business license — what you need depends on your industry, location, and the type of goods or services you sell. If your LLC sells taxable goods or services, leases taxable property, or operates a hotel or lodging facility, you'll need to register for a Sales and Use Tax Permit through the Connecticut Department of Revenue Services.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to start an LLC in Connecticut?",
      a: "The state filing fee to form a Connecticut LLC is $120 for the Certificate of Organization. If you want to reserve your business name before filing, there's a separate $60 fee for a Name Reservation. After formation, the annual report costs $80 per year.",
    },
    {
      q: "Does Connecticut require an annual report for LLCs?",
      a: "Yes. Connecticut requires all domestic and foreign LLCs to file an annual report with the Secretary of the State by March 31 each year. The filing fee is $80, and it must be filed online through business.ct.gov.",
    },
    {
      q: "Can I start a Connecticut LLC online?",
      a: "Yes. You can file the Certificate of Organization directly through business.ct.gov without hiring an attorney. You'll need to complete the form, pay the $120 state fee, and designate a registered agent before you file.",
    },
    {
      q: "Does a Connecticut LLC need an EIN?",
      a: "Generally, yes — if your LLC has employees or is taxed as a corporation or partnership, you need an EIN from the IRS. Even single-member LLCs with no employees benefit from having one, since it's free and keeps your Social Security number off business paperwork.",
    },
    {
      q: "Who can be a registered agent in Connecticut?",
      a: "Your registered agent must be either a Connecticut resident who is at least 18 years old or a business entity registered with the Connecticut Secretary of the State with a Connecticut address. You can serve as your own registered agent if you meet those requirements.",
    },
    {
      q: "Does Connecticut require a written operating agreement?",
      a: "No. Connecticut law doesn't require a written operating agreement, but having one is strongly recommended — it documents how your LLC is owned and managed and protects members if a dispute comes up later.",
    },
  ],
};

export default function ConnecticutLLCPage() {
  return (
    <NavigationWrapper>
