...
const data: StateData = {
  slug: "arkansas",
  name: "Arkansas",
  pageTitle: "Arkansas LLC Filing Fees and Requirements",
  metaDescription:
    "Forming an LLC in Arkansas requires filing a Certificate of Organization with the Arkansas Secretary of State. Learn the fees, franchise tax, and filing steps.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$45 online or $50 by mail" },
    {
      label: "Processing time",
      value: "Faster for online filings through the Arkansas Corporations Online Filing System",
    },
    {
      label: "State agency",
      value: "Arkansas Secretary of State, Business and Commercial Services Division",
    },
    {
      label: "Annual report due",
      value: "Annual LLC Franchise Tax Report due May 1 each year; $150 franchise tax",
    },
    {
      label: "State tax rate",
      value: "$150 annual franchise tax applies to all domestic and foreign LLCs",
    },
  ],
  introHeading: "Arkansas LLC filing fees and requirements",
  introParagraphs: [
  ...
  steps: [
    {
      ...
      body: [
        "The formation document for an Arkansas LLC is called the Certificate of Organization — not Articles of Organization, which is the name used in many other states. You file it with the Arkansas Secretary of State, Business and Commercial Services Division.",
        "The fee is $45 when filed online through the Arkansas Corporations Online Filing System, or $50 when submitted by mail or in person. Filing online is the faster and cheaper route.",
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every Arkansas LLC needs a registered agent with a physical Arkansas street address. If you change your registered agent or registered office address after formation, you need to file a statement of change with the Secretary of State.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "You'll need an EIN to identify your business to the IRS. You use this number when filing and paying taxes, submitting payroll, and opening a business bank account. You can obtain one directly from the IRS at no cost.",
      ],
    },
    {
      title: "Create an operating agreement",
      body: [
        "An operating agreement is an internal document that outlines how decisions will be made, how the business is divided among members, and what happens if a member leaves the company. Arkansas doesn't require you to file one, but having one in writing is worth doing.",
      ],
    },
    {
      title: "File your Annual Franchise Tax Report",
      body: [
        "Arkansas requires all LLCs — domestic and foreign — to file an Annual LLC Franchise Tax Report and pay a $150 franchise tax each year. The deadline is May 1. Your first report is due in the calendar year after the year your LLC was formed.",
      ],
    },
  ],
  extraSections: [
    {
      heading: "Foreign LLC registration in Arkansas",
      paragraphs: [
        "If your LLC was formed in another state but you want to do business in Arkansas, you need to register as a foreign LLC. The filing is called an Application for Certificate of Registration of Foreign Limited Liability Company, and the fee is $270 online or $300 by mail or in person — higher than domestic formation. Foreign LLCs are subject to the same $150 annual franchise tax and May 1 deadline as domestic LLCs.",
      ],
    },
    {
      heading: "Business licenses",
      paragraphs: [
        "Arkansas doesn't issue a single statewide general business license. What you need depends on your industry and location — check with your city or county clerk for local requirements, and review state licensing boards for industry-specific permits.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Arkansas?",
      a: "The state filing fee is $45 if you file online or $50 by mail for your Certificate of Organization. After formation, you'll owe a $150 annual franchise tax each year, due by May 1. Those are the core state costs for a domestic Arkansas LLC.",
    },
    {
      q: "Does Arkansas require an annual report for LLCs?",
      a: "Yes. Arkansas requires all LLCs — domestic and foreign — to file an Annual LLC Franchise Tax Report and pay a $150 franchise tax each year. The deadline is May 1. Missing the deadline can put your LLC out of good standing with the state.",
    },
    {
      q: "How do I register a foreign LLC in Arkansas?",
      a: "File an Application for Certificate of Registration of Foreign Limited Liability Company with the Arkansas Secretary of State. The fee is $270 online or $300 by mail or in person. You'll also need a registered agent with a physical Arkansas address and will owe the same $150 annual franchise tax as domestic LLCs.",
    },
    {
      q: "Does an Arkansas LLC need a business license?",
      a: "It depends on your industry and location. Arkansas doesn't have a single statewide general business license. What you need is determined by the type of work you do, where you operate, and which state or local agencies regulate your industry.",
    },
    {
      q: "What is the difference between a Certificate of Organization and Articles of Organization?",
      a: "They're the same type of document under different names. Arkansas calls its LLC formation document a Certificate of Organization, while many other states call it Articles of Organization. Both perform the same legal function — creating your LLC with the state.",
    },
    {
      q: "Does Arkansas allow Series LLCs?",
      a: "Yes. To form a Series LLC in Arkansas, you file the Certificate of Organization for a Series LLC form with the Secretary of State. The filing fee is $50, the same as a typical domestic LLC formation.",
    },
  ],
};

export default function ArkansasLLCPage() {
  return (
    <NavigationWrapper>
