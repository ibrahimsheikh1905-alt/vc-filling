...
const data: StateData = {
  slug: "louisiana",
  name: "Louisiana",
  pageTitle: "Louisiana LLC Filing Fees and Requirements",
  metaDescription:
    "The Louisiana LLC filing fee is $100 by mail or $105 online through geauxBIZ. Learn the annual report requirements, registered agent rules, and business taxes.",
  readTime: "6 min read",
  glance: [
    { label: "Filing fee", value: "$100 by mail or $105 online (Articles of Organization, geauxBIZ)" },
    { label: "Processing time", value: "1–2 business days online; up to a week by mail" },
    { label: "State agency", value: "Louisiana Secretary of State, Commercial Division" },
    { label: "Annual report due", value: "Annually, by the LLC's anniversary date; roughly $30–35 fee" },
    {
      label: "State tax rate",
      value: "Pass-through income taxed at individual rates; corporate income and franchise tax applies only if the LLC elects corporate tax treatment",
    },
  ],
  introHeading: "How to form an LLC in Louisiana",
  introParagraphs: [
    "You can file your Louisiana Articles of Organization online with the Secretary of State's geauxBIZ online business portal, or mail a form to the Office of the Secretary of State. The Louisiana LLC filing fee is $100 by mail or $105 online — the extra $5 online covers the Initial Report, which is otherwise a separate filing for mail submissions.",
    "You only need to file your Articles of Organization once, but every year after, you'll need to file an annual report.",
  ],
  steps: [
    {
      title: "Choose and check your LLC name",
      body: [
        'Every Louisiana LLC name must include one of the following designators: the full phrase "limited liability company," or the abbreviation "L.L.C." or "L.C." Your name must be distinguishable from every other business already on record with the Secretary of State. If you want to lock in a name before filing, you can reserve it for $25 for 120 days.',
      ],
    },
    {
      title: "Appoint a registered agent",
      body: [
        "Every LLC in Louisiana is required to have a registered agent — someone who receives official legal and tax correspondence and has responsibility for filing reports with the Secretary of State. If your registered agent is a person, they must reside and have a physical street address in Louisiana.",
      ],
    },
    {
      title: "File your Articles of Organization",
      body: [
        "File online through the Secretary of State's geauxBIZ portal for $105 (includes the Initial Report), or mail a paper form for $100. Filing online is faster — typically within 1–2 business days — while filing by paper may take up to a week.",
      ],
    },
    {
      title: "Get your EIN",
      body: [
        "You'll need an EIN to identify your business to the IRS. You use this number when filing and paying taxes or submitting payroll information, and it's also required to open a business bank account. You can obtain one directly from the IRS at no cost.",
      ],
    },
  ],
  extraSections: [
    {
      ...
      paragraphs: [
        "Louisiana requires businesses to file an annual report with the Secretary of State each year. When you file your annual report, you'll need to pay a fee of around $30–35, due by the anniversary date of your LLC's formation.",
      ],
    },
    {
      heading: "Louisiana franchise tax and Annual Tax Statement",
      paragraphs: [
        "LLCs subject to Louisiana corporate income and franchise tax may also need to file an Annual Tax Statement and pay a $250 fee, due on or before June 1 each year. This only applies to LLCs taxed as corporations for Louisiana purposes — LLCs taxed as sole proprietorships or partnerships at the federal level are generally not subject to the corporate franchise tax at the entity level.",
      ],
    },
  ],
  faqs: [
    {
      q: "How much does it cost to form an LLC in Louisiana?",
      a: "The Louisiana LLC filing fee is $100 if you file by mail, or $105 if you file online through geauxBIZ (the extra $5 covers the Initial Report). After formation, the annual report costs roughly $30–35 per year.",
    },
    {
      q: "Does Louisiana require an annual report for LLCs?",
      a: "Yes. Louisiana requires businesses to file an annual report with the Secretary of State each year, due by the anniversary date of formation, for a fee of roughly $30–35.",
    },
    {
      q: "Does Louisiana charge a franchise tax for LLCs?",
      a: "Only for LLCs taxed as corporations for Louisiana purposes. Those LLCs may need to file an Annual Tax Statement and pay a $250 fee by June 1 each year. LLCs taxed as sole proprietorships or partnerships generally aren't subject to the corporate franchise tax.",
    },
    {
      q: "Does a Louisiana LLC need a registered agent?",
      a: "Yes. Every LLC in Louisiana is required to have a registered agent with a physical street address in the state, appointed when you file your Articles of Organization.",
    },
    {
      q: "How do I reserve a Louisiana LLC name?",
      a: "File an Application for Reservation of a Limited Liability Company Name with the Louisiana Secretary of State. The state fee is $25, and the reservation holds your name for 120 days. Reservation is optional — you can file your Articles of Organization directly without reserving first.",
    },
    {
      q: "How do I register a foreign LLC in Louisiana?",
      a: "Complete an Application for Authority to Transact Business in Louisiana and pay a $150 filing fee with the Louisiana Secretary of State. You'll also need a Louisiana registered agent as part of the registration.",
    },
  ],
};

export default function LouisianaLLCPage() {
  return (
    <NavigationWrapper>
