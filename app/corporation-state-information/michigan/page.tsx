...
const toc = [
  "How to Form a Michigan Corporation Yourself in Six Steps",
    ...
    <aside style={{
      ...
      <div style={{ padding: "28px 32px 32px" }}>
        ...
        <div style={{ marginTop: 14, display: "flex", flexDirection: "column", gap: 18 }}>
          {["Business Names", "Resident Agent", "Filing Fees & Requirements", "Start a Corporation"].map(label => (
        ...
        <div style={{
          ...
          <p style={{ marginTop: 8, fontSize: 13, lineHeight: 1.4 }}>
            Form for $0 (+ State Fee) with a Free 1st Year of Resident Agent
          </p>
          <button style={{
  ...
  return (
    <div style={{ marginTop: 32, overflow: "hidden", borderRadius: 12, background: "#e9edf2" }}>
      ...
      <div style={{ borderTop: "1px solid #d5dbe3", padding: "24px 44px", fontSize: 16, lineHeight: 1.6, color: "#1f2c45" }}>
        Incorp Bay can take care of all your Michigan corporation formation paperwork — and we'll do it for free. Just pay the required Michigan state fee ($60).
      </div>
    </div>
  );
}
...
function FilingBox() {
  ...
  return (
    <div style={{ margin: "40px 0", borderRadius: 12, border: "1px solid #d5dde7", background: "#f5f7f9", padding: "36px", boxShadow: "0 2px 8px rgba(0,0,0,0.05)" }}>
      <h4 style={{ marginBottom: 32, fontSize: 18, fontWeight: 800 }}>Here's what is required by the Michigan Michigan Department of Licensing and Regulatory Affairs (LARA):</h4>
...
function FeesTable() {
  const complianceRows = [
    ...
    ["Formation Filing Fee", "$60"],
    ["Filing Authority", "Michigan Department of Licensing and Regulatory Affairs (LARA)"],
    ["Resident Agent", "Required with an eligible physical address in Michigan"],
    ["Important", "Fees, forms and processing times can change. Confirm current requirements before filing."],
  ];
  return (
    <>
      <h3 style={{ marginBottom: 24, marginTop: 64, fontSize: 26, fontWeight: 800 }}>What are the Fees and Requirements to Incorporate in Michigan?</h3>
      ...
      <h3 style={{ marginBottom: 24, marginTop: 48, fontSize: 24, fontWeight: 800 }}>Michigan Ongoing Compliance</h3>
      <div style={{ overflow: "hidden", borderRadius: 18, border: "1px solid #dce1e7", fontSize: 18 }}>
...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function MichiganCorpPage() {
      ...
      <NavigationWrapper>
        ...
        <main style={{ width: "100%", maxWidth: 1040, padding: "36px 32px 96px", margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 56, display: "inline-flex", alignItems: "center", gap: 20, borderRadius: 12, background: "#f5f6f8", padding: "16px 24px", fontSize: 16, color: "#1b2944" }}>
            ...
            <span style={{ color: "#ff4b14" }}>Michigan</span>
          </div>

          <h1 style={{ maxWidth: 760, fontSize: 54, fontWeight: 800, lineHeight: 1.08, letterSpacing: -1.4 }}>How to Incorporate in Michigan</h1>
          ...
          <p style={{ marginTop: 28, fontSize: 18, fontWeight: 800 }}>Learn how to form a Michigan corporation yourself</p>
          ...
          <section style={{ marginTop: 64 }}>
            <SectionTitle>Why Start a Michigan Corporation?</SectionTitle>
            <Para>Michigan offers financing, workforce support and incentive programs that may help qualifying corporations invest, expand and create jobs.</Para>
            <Para>Program availability and eligibility requirements can change, so review current guidance from the appropriate Michigan agency.</Para>
            <Para>For most entrepreneurs looking to start a larger business, creating a Michigan corporation may be the best choice. As a corporation, your business is able to buy and trade stock, and when it comes to excess profits, corporations offer more flexibility than a limited liability company (LLC). A corporation is allowed to pass income and losses to its shareholders, who report taxes on an individual tax return at ordinary levels.</Para>
            ...
            <Para>Learn more about forming a <TextLink>Michigan LLC</TextLink> so you can decide which business entity is right for you.</Para>
            <SubTitle>Benefits of Forming a Michigan C Corporation</SubTitle>
            ...
            <SubTitle>Benefits of Forming a Michigan S Corporation</SubTitle>
          ...
          <section id="section-0" style={{ marginTop: 64, scrollMarginTop: 112 }}>
            ...
            <CTANameCard text="We Can Check Michigan Corporation Name Availability for You" buttonText="Check Name Availability" />

            <SubTitle>Step 2: Provide an Official Address for Your Corporation</SubTitle>
            <Para>A Michigan corporation must have a designated address. That could be your home address (if you're running the company from your residence), where your office is located or any physical address of your preference. The address can be outside the state of Michigan and can be a P.O. Box.</Para>
            <Para>Some people establish companies outside of the state they live in and will use a Resident Agent service to provide an address for receiving legal documentation in the state. The Resident Agent address is listed in public records on the Michigan Michigan Department of Licensing and Regulatory Affairs (LARA) website. If you do not want your own name and Michigan address to be registered, you should use a Resident Agent service.</Para>

            <SubTitle>Step 3: Assign a Resident Agent</SubTitle>
            <Para>Every Michigan corporation is required to have a Resident Agent — someone who receives official correspondence and is responsible for filing reports with the Michigan Michigan Department of Licensing and Regulatory Affairs (LARA).</Para>
            <Para>You can fill this position, assign another manager in your business or use a Resident Agent service. The Resident Agent must be present or available during normal business hours to receive important documents on behalf of your company.</Para>
            <Para>You'll appoint your Resident Agent when you file your Articles of Incorporation with the Michigan Michigan Department of Licensing and Regulatory Affairs (LARA) and officially create your corporation.</Para>
            <Para>All of Incorp Bay's business formation packages include Resident Agent service. It's free for the first year and just $149 per year after that. You can also access a digital dashboard to view any document we've received on your behalf. You can also change to a new Resident Agent later by filing the correct form and paying a fee of $50.</Para>
            <div style={{ marginBottom: 40, display: "flex", alignItems: "center", justifyContent: "space-between", borderLeft: "4px solid #677184", background: "#f3f5f7", padding: "24px", fontSize: 20, fontWeight: 800, cursor: "pointer" }}>
              <span>Get a Free Resident Agent with Incorp Bay</span>
              <ExternalIcon />
            </div>

            <SubTitle>Step 4: File Your Articles of Incorporation with the Michigan Michigan Department of Licensing and Regulatory Affairs (LARA)</SubTitle>
            <Para>Once you've gathered all the information for your corporation, you'll need to file a form with the Michigan SOS Corporations Division. Once they process the filing, you will have officially created your business.</Para>
            <FilingBox />
            <div style={{ marginBottom: 40, display: "flex", alignItems: "center", justifyContent: "space-between", borderLeft: "4px solid #677184", background: "#f3f5f7", padding: "24px", fontSize: 20, fontWeight: 800, cursor: "pointer" }}>
              <span>Download Form Here</span><ExternalIcon />
            </div>
            <Para>Your Articles of Incorporation can be uploaded online via the state's digital portal. You can also mail the form to the Office of the Corporations Division, or Incorp Bay can file it on your behalf. The Michigan corporation filing fee is $60.</Para>
            <div style={{ margin: "40px 0", borderRadius: 18, border: "1px solid #dce1e7", padding: 32, fontSize: 18 }}>
              ...
              <div style={{ marginTop: 12, color: "#333", lineHeight: 1.6 }}>
                Submit the Articles of Incorporation using the official Michigan Department of Licensing and Regulatory Affairs (LARA) filing system or follow the agency's current mail and in-person instructions.
              </div>
            </div>

            <Para>You only need to submit the Articles of Incorporation once to form the corporation. After formation, file the annual report annually with the Michigan Department of Licensing and Regulatory Affairs (LARA) and maintain the corporation's other required registrations.</Para>
            <CTANameCard text="Let Incorp Bay Handle All the Michigan Corporation Formation Paperwork for You for $0 + the State Fee" buttonText="Get Started" />
            <FeesTable />

            <SubTitle>Step 5: Get an Employer Identification Number (EIN) from the Internal Revenue Service</SubTitle>
            <Para>You'll need an <TextLink>EIN</TextLink> to identify your business to the IRS. You use this number when filing and paying taxes, when submitting payroll information and payments for your employees and for opening a business bank account. You can obtain one directly from the IRS, or Incorp Bay can get one for you as part of the Michigan corporation formation process.</Para>
          ...
          <section id="section-1" style={{ marginTop: 64, scrollMarginTop: 112 }}>
            <SectionTitle>Michigan Corporation Types</SectionTitle>
            ...
            <Para>If you want your Michigan C Corporation to be treated as a Michigan S Corporation, file the IRS <TextLink>Election by a Small Business Corporation</TextLink> form, also known as Form 2553 or an <TextLink>S Corp Election form.</TextLink> Any Michigan S Corporations formed through Incorp Bay will also include a prepared Form 2553 that will be delivered with the state formation documents.</Para>
            ...
            <Para>Michigan may permit licensed professionals to form a professional corporation or another professional entity. Eligibility and ownership rules depend on the profession and applicable licensing board.</Para>
            <div style={{ margin: "40px 0", borderRadius: 12, border: "1px solid #d5dde7", background: "#f5f7f9", padding: 48, boxShadow: "0 4px 14px rgba(0,0,0,0.07)" }}>
              <h4 style={{ marginBottom: 40, fontSize: 18, fontWeight: 800, lineHeight: 1.45 }}>The professions permitted to form a Michigan Professional Corporation include, but may not be limited to:</h4>
            ...
            <Para>Check with the Michigan Michigan Department of Licensing and Regulatory Affairs (LARA) to confirm whether your business should and can be a Professional Corporation.</Para>
            ...
            <Para>If your business operates in another state and you want to expand into Michigan — or vice versa — you'll need to form a Foreign Corporation. Before you can bring an arm of your business from another state into Michigan, you must request Foreign Qualification in Michigan by completing a Qualification Certificate and paying the applicable state filing fee.</Para>
            <Para>Learn more about <TextLink>Michigan Foreign Corporation registration.</TextLink></Para>
            ...
            <Para>A <TextLink>Michigan LLC</TextLink> is usually a better option for a smaller business. It's easier to set up, but it still offers you certain advantages you'd get from a corporation. You can even have your LLC treated as an S Corporation for tax purposes to save you money.</Para>
            <Para>Regardless of which direction you decide to go, we can help you with your Michigan business registration.</Para>
          ...
          <section id="section-2" style={{ marginTop: 64, scrollMarginTop: 112 }}>
            <SectionTitle>Helpful Resources from the State of Michigan</SectionTitle>
            <ResourceLinks />
          </section>
          ...
          <section id="section-3" style={{ marginTop: 56, scrollMarginTop: 112 }}>
            ...
            {[
              ["Michigan Corporation Names","How to search the state business registry and find the right name. Includes information on naming rules, fictitious names, reserving names for Michigan corporations and more."],
              ["Michigan Resident Agent Service","How to appoint, change and search for Resident Agents. Also includes the duties they fulfill and the rules they're required to follow."],
              ["Michigan Incorporation Fees and Requirements","Details the various fees you'll need to pay and the state and federal requirements you'll need to meet. Includes details about Employer Identification Numbers (EINs), state and federal business licenses, annual reports and franchise tax."],
              ["Michigan Corporation Taxes","Covers the various taxes you'll have to pay to the state and federal governments. Includes details about the Michigan Franchise Tax, and federal taxes such as income and self-employment."],
            ].map(([h,p]) => (
