...
const BRAND_GRADIENT = "linear-gradient(90deg,#244EB6 0%,#2B93C9 50%,#33D1CC 100%)";
...
const gradientButtonStyle: React.CSSProperties = {
  ...
  border: "none",
  cursor: "pointer",
  boxShadow: "0 10px 28px rgba(43,147,201,0.28)",
};
...
const toc = [
  "How to Form a Pennsylvania Corporation Yourself in Six Steps",
  "Pennsylvania Corporation Types",
  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: "28px 32px 32px" }}>
        <div style={{
          borderRadius: 10, background: "linear-gradient(90deg,rgba(36,78,182,.12),rgba(51,209,204,.16))", padding: "8px 16px",
          fontSize: 15, color: "#244EB6", marginBottom: 10, fontWeight: 500,
        }}>
          Pennsylvania Corp
        </div>
        ...
        <nav style={{ marginTop: 10 }}>
          {toc.map((item, i) => (
            <div key={item} onClick={() => scrollTo(`section-${i}`)} style={{
              ...
              borderLeft: activeIdx === i ? "3px solid #2B93C9" : "3px solid transparent",
        ...
        <div style={{ marginTop: 14, display: "flex", flexDirection: "column", gap: 18 }}>
          {["Business Names", "Registered Office", "Filing Fees & Requirements", "Start a Corporation"].map(label => (
        ...
        <div style={{
          ...
          <p style={{ marginTop: 8, fontSize: 13, lineHeight: 1.4 }}>
            Form for $0 (+ State Fee) with a Free 1st Year of Registered Office
          </p>
          <button style={{
            marginTop: 14, width: "100%", borderRadius: 50,
            ...gradientButtonStyle, padding: "12px 18px",
  ...
  return (
    <div style={{ marginTop: 32, overflow: "hidden", borderRadius: 12, background: "#e9edf2" }}>
      <div style={{ display: "flex", height: 420, alignItems: "center", justifyContent: "center", padding: 40 }}>
        <div style={{
          ...
          <div style={{ position: "absolute", left: 95, top: 150, width: 50, height: 92,
            backgroundImage: "radial-gradient(#2B93C9 3px,transparent 3px)", backgroundSize: "12px 12px" }} />
          {/* form card */}
          <div style={{
      ...
      <div style={{ borderTop: "1px solid #d5dbe3", padding: "24px 44px", fontSize: 16, lineHeight: 1.6, color: "#1f2c45" }}>
        Incorp Bay can take care of all your Pennsylvania corporation formation paperwork — and we'll do it for free. Just pay the required Pennsylvania state fee ($125).
      </div>
    </div>
  );
}
...
function VideoBox() {
  return (
    <div style={{ marginTop: 40, overflow: "hidden", borderRadius: "18px 18px 0 0", border: "10px solid #d7dde6", borderBottom: "none", background: "linear-gradient(135deg,rgba(36,78,182,.08),rgba(51,209,204,.12))" }}>
      ...
      <div style={{ position: "relative", display: "flex", height: 420, alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ fontSize: 56, fontWeight: 900, lineHeight: 1, color: "#2B93C9" }}>CORPORATION?</div>
        </div>
        <div style={{
  ...
  return (
    <div style={{
      ...
      <button style={{
        ...
        ...gradientButtonStyle, padding: "15px 28px",
...
function FilingBox() {
  const items = [
    ...
    "The Registered Office's name and eligible Pennsylvania address",
    "The corporation's authorized share structure",
    "The corporation's purpose, when required",
    "The names and addresses of the incorporators",
    "The signature of an authorized incorporator or filer",
  ];
  return (
    <div style={{ margin: "40px 0", borderRadius: 12, border: "1px solid #d5dde7", background: "#f5f7f9", padding: "36px", boxShadow: "0 2px 8px rgba(0,0,0,0.05)" }}>
      <h4 style={{ marginBottom: 32, fontSize: 18, fontWeight: 800 }}>Here's what is required by the Pennsylvania Department of State, Bureau of Corporations and Charitable Organizations:</h4>
...
function FeesTable() {
  const complianceRows = [
    ...
    ["Filing Authority", "Pennsylvania Department of State, Bureau of Corporations and Charitable Organizations"],
    ["Registered Office", "Required under applicable Pennsylvania rules"],
    ["Important", "Fees, forms and processing times can change. Confirm current requirements before filing."],
  ];
  return (
    <>
      <h3 style={{ marginBottom: 24, marginTop: 64, fontSize: 26, fontWeight: 800 }}>What are the Fees and Requirements to Incorporate in Pennsylvania?</h3>
      <div style={{ overflow: "hidden", borderRadius: 18, border: "1px solid #dce1e7", fontSize: 18 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", background: "#fff" }}>
          <div style={{ padding: 18, fontWeight: 700, color: "#2B93C9" }}>$125*</div>
          <div style={{ padding: 18 }}>Standard State Processing</div>
          <div style={{ padding: 18 }}>Expedited Service (if available)</div>
        </div>
      </div>
      <p style={{ marginTop: 10, fontSize: 14, color: "#555" }}>*Additional fees may apply depending on the number of authorized shares. Same-day, 2-hour and 1-hour expedited options are also available for higher fees.</p>

      <h3 style={{ marginBottom: 24, marginTop: 48, fontSize: 24, fontWeight: 800 }}>Pennsylvania Ongoing Compliance</h3>
      <div style={{ overflow: "hidden", borderRadius: 18, border: "1px solid #dce1e7", fontSize: 18 }}>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
      {resources.map(r => (
        <div key={r} style={{
          ...
          borderLeft: "4px solid #2B93C9", background: "linear-gradient(90deg,rgba(36,78,182,.05),rgba(51,209,204,.08))",
...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function PennsylvaniaCorpPage() {
      ...
      <NavigationWrapper>
        ...
        <main style={{ width: "100%", maxWidth: 1040, padding: "36px 32px 96px", margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 56, display: "inline-flex", alignItems: "center", gap: 20, borderRadius: 12, background: "#f5f6f8", padding: "16px 24px", fontSize: 16, color: "#1b2944" }}>
            ...
            <span style={{ ...gradientTextStyle, fontWeight: 700 }}>Pennsylvania</span>
          </div>

          <h1 style={{ maxWidth: 760, fontSize: 54, fontWeight: 800, lineHeight: 1.08, letterSpacing: -1.4, color: "#1E293B" }}>How to Incorporate in <span style={gradientTextStyle}>Pennsylvania</span></h1>
          <p style={{ marginTop: 24, fontSize: 18, fontWeight: 800 }}>Have Incorp Bay do the work for you $0 + state fee</p>
          <button style={{ marginTop: 28, borderRadius: 50, ...gradientButtonStyle, padding: "16px 26px", fontSize: 16, fontWeight: 800 }}>
            INCORPORATE NOW
          </button>
          <p style={{ marginTop: 28, fontSize: 18, fontWeight: 800 }}>Learn how to form a Pennsylvania corporation yourself</p>
          ...
          <section style={{ marginTop: 64 }}>
            <SectionTitle>Why Start a Pennsylvania Corporation?</SectionTitle>
            <Para>The State of Pennsylvania has implemented several incentives and tax credits that may help businesses secure new capital or keep more revenue. Your corporation may be able to take advantage of these incentives, provided it meets the qualifying criteria.</Para>
            <Para>For example, the <TextLink>Angel Investor Tax Credit</TextLink> provides a refundable tax credit for qualified investors in innovative, Pennsylvania-based small businesses.</Para>
            <Para>For most entrepreneurs looking to start a larger business, creating a Pennsylvania corporation may be the best choice. As a corporation, your business is able to buy and trade stock, and when it comes to excess profits, corporations offer more flexibility than a limited liability company (LLC). A corporation is allowed to pass income and losses to its shareholders, who report taxes on an individual tax return at ordinary levels.</Para>
            ...
            <Para>Learn more about forming a <TextLink>Pennsylvania LLC</TextLink> so you can decide which business entity is right for you.</Para>
            <SubTitle>Benefits of Forming a Pennsylvania C Corporation</SubTitle>
            ...
            <SubTitle>Benefits of Forming a Pennsylvania S Corporation</SubTitle>
            ...
            <Para>In this guide, you'll find information on naming your corporation, getting a Registered Office, the fees you'll need to pay, and other requirements. To help you along the way, use our <TextLink>Starting a Business</TextLink> checklist to keep track of everything you need to do to get your business up and running.</Para>
          </section>

          {/* SECTION 0 — 6 STEPS */}
          <section id="section-0" style={{ marginTop: 64, scrollMarginTop: 112 }}>
            <SectionTitle>How to Form a Pennsylvania Corporation Yourself in 6 Steps</SectionTitle>
            <VideoBox />

            <SubTitle>Step 1: Choose a Unique Business Name and Complete a State Business Search</SubTitle>
            <Para>Every Pennsylvania business must have a unique name that hasn't already been claimed by another business in the state. If you're having difficulty coming up with a name, try using our <TextLink>Business Name Generator</TextLink> to gather ideas. You'll need to follow a few naming rules, which you can read about in detail on the <TextLink>Pennsylvania Business Names</TextLink> page.</Para>
            <Para>Once you've chosen a name, you'll need to make sure it's available in Pennsylvania. See the name is available by searching for it on the <TextLink>Pennsylvania Department of State, Bureau of Corporations and Charitable Organizations</TextLink> website.</Para>
            ...
            <CTANameCard text="We Can Check Pennsylvania Corporation Name Availability for You" buttonText="Check Name Availability" />

            <SubTitle>Step 2: Provide an Official Address for Your Corporation</SubTitle>
            <Para>A Pennsylvania corporation must have a designated address. That could be your home address (if you're running the company from your residence), where your office is located or any physical address of your preference. The address can be outside the state of Pennsylvania and can be a P.O. Box.</Para>
            <Para>Some people establish companies outside of the state they live in and will use a Registered Office service to provide an address for receiving legal documentation in the state. The Registered Office address is listed in public records on the Pennsylvania Department of State, Bureau of Corporations and Charitable Organizations website. If you do not want your own name and Pennsylvania address to be registered, you should use a Registered Office service.</Para>

            <SubTitle>Step 3: Assign a Registered Office</SubTitle>
            <Para>Every Pennsylvania corporation is required to have a Registered Office — someone who receives official correspondence and is responsible for filing reports with the Pennsylvania Department of State, Bureau of Corporations and Charitable Organizations.</Para>
            <Para>You can fill this position, assign another manager in your business or use a Registered Office service. The Registered Office must be present or available during normal business hours to receive important documents on behalf of your company.</Para>
            <Para>You'll appoint your Registered Office when you file your Articles of Incorporation with the Pennsylvania Department of State, Bureau of Corporations and Charitable Organizations and officially create your corporation.</Para>
            <Para>All of Incorp Bay's business formation packages include Registered Office service. It's free for the first year and just $149 per year after that. You can also access a digital dashboard to view any document we've received on your behalf. You can also change to a new Registered Office later by filing the correct form and paying a fee of $50.</Para>
            <div style={{ marginBottom: 40, display: "flex", alignItems: "center", justifyContent: "space-between", borderLeft: "4px solid #2B93C9", background: "linear-gradient(90deg,rgba(36,78,182,.05),rgba(51,209,204,.08))", padding: "24px", fontSize: 20, fontWeight: 800, cursor: "pointer" }}>
              <span>Get a Free Registered Office with Incorp Bay</span>
              <ExternalIcon />
            </div>

            <SubTitle>Step 4: File Your Articles of Incorporation with the Pennsylvania Department of State, Bureau of Corporations and Charitable Organizations</SubTitle>
            <Para>Once you've gathered all the information for your corporation, you'll need to file a form with the Pennsylvania Department of State, Bureau of Corporations and Charitable Organizations. Once they process the filing, you will have officially created your business.</Para>
            <FilingBox />
            <div style={{ marginBottom: 40, display: "flex", alignItems: "center", justifyContent: "space-between", borderLeft: "4px solid #2B93C9", background: "linear-gradient(90deg,rgba(36,78,182,.05),rgba(51,209,204,.08))", padding: "24px", fontSize: 20, fontWeight: 800, cursor: "pointer" }}>
              <span>Download Form Here</span><ExternalIcon />
            </div>
            <Para>Your Articles of Incorporation can be uploaded online via the state's digital portal. You can also mail the form to the Office of the Corporations Division, or Incorp Bay can file it on your behalf. The Pennsylvania Corporation filing fee is $125.</Para>
            <div style={{ margin: "40px 0", display: "grid", gridTemplateColumns: "1fr 1fr", borderRadius: 18, border: "1px solid #dce1e7", padding: 32, fontSize: 18, gap: 24 }}>
              <div>
                ...
                <div style={{ marginTop: 12, color: "#333" }}>
                  Pennsylvania Department of State, Bureau of Corporations and Charitable Organizations<br />
                  <span style={{ color: BRAND_BLUE }}>John G. Townsend Building</span><br />
            ...
            <Para>You only need to file your Articles of Incorporation in Pennsylvania once, but you'll also need to file an annual report with the Pennsylvania SOS by March 1 of each year following the calendar year in which your Articles of Incorporation becomes effective. Corporate taxes and the PA Franchise Tax, which are also due at the time of filing of the report, are based on the stock listed in the Articles of Incorporation. Incorp Bay can remind you about this every year, or we can do it for you if you have us handle the paperwork.</Para>
            <CTANameCard text="Let Incorp Bay Handle All the Pennsylvania Corporation Formation Paperwork for You for $0 + the State Fee" buttonText="Get Started" />
            <FeesTable />

            <SubTitle>Step 5: Get an Employer Identification Number (EIN) from the Internal Revenue Service</SubTitle>
            <Para>You'll need an <TextLink>EIN</TextLink> to identify your business to the IRS. You use this number when filing and paying taxes, when submitting payroll information and payments for your employees and for opening a business bank account. You can obtain one directly from the IRS, or Incorp Bay can get one for you as part of the Pennsylvania corporation formation process.</Para>
            ...
            <Para>You are required to have Pennsylvania corporation bylaws per Title 8, Chapter 1, Subchapter 1, § 109 of the state's legal code. You're not required to file them with the Pennsylvania Department of State, Bureau of Corporations and Charitable Organizations but must store them on the business premises.</Para>
          ...
          <section id="section-1" style={{ marginTop: 64, scrollMarginTop: 112 }}>
            <SectionTitle>Pennsylvania Corporation Types</SectionTitle>
            ...
            <Para>If you want your Pennsylvania C Corporation to be treated as a Pennsylvania S Corporation, file the IRS <TextLink>Election by a Small Business Corporation</TextLink> form, also known as Form 2553 or an <TextLink>S Corp Election form.</TextLink> Any Pennsylvania S Corporations formed through Incorp Bay will also include a prepared Form 2553 that will be delivered with the state formation documents.</Para>
            ...
            <Para>Some states, including Pennsylvania, allow certain occupations to form Professional Corporations and offer professional services. The state's professional corporation statute defines these services as:</Para>
            <Para>"In addition, and by way of example without limiting the generality thereof, the personal services which come within this chapter are the personal services rendered by architects, certified or other public accountants, chiropodists, chiropractors, doctors of dentistry, doctors of medicine, optometrists, doctors of osteopathy, doctors of podiatric medicine, professional engineers, veterinarians, and, subject to the Rules of the Supreme Court, attorneys-at-law."</Para>
            <div style={{ margin: "40px 0", borderRadius: 12, border: "1px solid #d5dde7", background: "#f5f7f9", padding: 48, boxShadow: "0 4px 14px rgba(0,0,0,0.07)" }}>
              <h4 style={{ marginBottom: 40, fontSize: 18, fontWeight: 800, lineHeight: 1.45 }}>The professions permitted to form a Pennsylvania Professional Corporation include, but may not be limited to:</h4>
            ...
            <Para>Check with the Pennsylvania Department of State, Bureau of Corporations and Charitable Organizations to confirm whether your business should and can be a Professional Corporation.</Para>
            ...
            <Para>If your business operates in another state and you want to expand into Pennsylvania — or vice versa — you'll need to form a Foreign Corporation. Before you can bring an arm of your business from another state into Pennsylvania, you must request Foreign Qualification in Pennsylvania by completing a Qualification Certificate and paying a processing fee of $245.</Para>
            <Para>Learn more about <TextLink>Pennsylvania Foreign Corporation registration.</TextLink></Para>
            ...
            <Para>A <TextLink>Pennsylvania LLC</TextLink> is usually a better option for a smaller business. It's easier to set up, but it still offers you certain advantages you'd get from a corporation. You can even have your LLC treated as an S Corporation for tax purposes to save you money.</Para>
            <Para>Regardless of which direction you decide to go, we can help you with your Pennsylvania business registration.</Para>
          ...
          <section id="section-2" style={{ marginTop: 64, scrollMarginTop: 112 }}>
            <SectionTitle>Helpful Resources from the State of Pennsylvania</SectionTitle>
            <ResourceLinks />
          </section>
          ...
          <section id="section-3" style={{ marginTop: 56, scrollMarginTop: 112 }}>
            ...
            {[
              ["Pennsylvania Corporation Names","How to search the state business registry and find the right name. Includes information on naming rules, fictitious names, reserving names for Pennsylvania corporations and more."],
              ["Pennsylvania Registered Office Service","How to appoint, change and search for Registered Offices. Also includes the duties they fulfill and the rules they're required to follow."],
              ["Pennsylvania Incorporation Fees and Requirements","Details the various fees you'll need to pay and the state and federal requirements you'll need to meet. Includes details about Employer Identification Numbers (EINs), state and federal business licenses, annual reports and franchise tax."],
              ["Pennsylvania Corporation Taxes","Covers the various taxes you'll have to pay to the state and federal governments. Includes details about the Pennsylvania Franchise Tax, and federal taxes such as income and self-employment."],
            ].map(([h,p]) => (
            ...
            <button style={{ marginTop: 32, borderRadius: 50, ...gradientButtonStyle, padding: "16px 28px", fontSize: 17, fontWeight: 800 }}>
