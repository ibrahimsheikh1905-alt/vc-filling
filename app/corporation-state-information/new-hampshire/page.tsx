...
const toc = [
  "How to Form a New Hampshire Corporation Yourself in Six Steps",
          ...
          {toc.map((item, i) => (
            <div
              ...
              style={{
                ...
                paddingLeft: 14,
                marginBottom: 16,
                borderLeft: activeIdx === i ? `3px solid ${ORANGE}` : "3px solid transparent",
...
function TextLink({ children }: { children: React.ReactNode }) {
  return <span style={{ color: ORANGE, cursor: "pointer" }}>{children}</span>;
}
  ...
  return (
    <div style={{ marginTop: 32, overflow: "hidden", borderRadius: 12, background: "#e9edf2" }}>
        ...
        >
          <div
            style={{
              ...
              height: "100%",
              opacity: 0.8,
              backgroundImage: "radial-gradient(#d7dde6 2px,transparent 2px)",
          ...
          <div
            style={{
              ...
              width: 50,
              height: 92,
              backgroundImage: "radial-gradient(#ff8a64 3px,transparent 3px)",
              backgroundSize: "12px 12px",
            }}
          />
          ...
          <div
            style={{
              ...
              top: 82,
              width: 360,
              borderRadius: "28px 90px 28px 28px",
              background: "#fff",
              padding: 30,
              boxShadow: "0 10px 30px rgba(0,0,0,0.12)",
            }}
          >
            <div style={{ position: "absolute", right: 32, top: 28, fontSize: 20, fontWeight: 900, fontStyle: "italic", color: "#FF4A00" }}>incorp bay</div>
      ...
      <div style={{ borderTop: "1px solid #d5dbe3", padding: "24px 44px", fontSize: 16, lineHeight: 1.6, color: "#1f2c45" }}>
        Incorp Bay can take care of all your New Hampshire corporation formation paperwork — and we'll do it for free. Just pay the required New Hampshire state fee ($100).
      </div>
    </div>
  );
}
...
export default function NewHampshireCorpPage(): JSX.Element {
        ...
        <div style={{ display: "flex", alignItems: "flex-start", width: "100%" }}>
          ...
          <main style={{ width: "100%", maxWidth: 1040, padding: "36px 32px 96px", margin: "0 auto" }}>
            ...
            >
              ...
              <span style={{ color: "#bbb" }}>›</span>
              <span style={{ color: ORANGE }}>New Hampshire</span>
            </div>

            <h1 style={{ maxWidth: 760, fontSize: 54, fontWeight: 800, lineHeight: 1.08, letterSpacing: -1.4 }}>How to Incorporate in New Hampshire</h1>
            <p style={{ marginTop: 24, fontSize: 18, fontWeight: 800 }}>Have Incorp Bay do the work for you $0 + state fee</p>
            <button style={{ marginTop: 28, borderRadius: 50, background: ORANGE, padding: "16px 26px", fontSize: 16, fontWeight: 800, color: "#fff", border: "none", cursor: "pointer" }}>
              INCORPORATE NOW
            </button>
            ...
            <section style={{ marginTop: 64 }}>
              <SectionTitle>Why Start a New Hampshire Corporation?</SectionTitle>
              <Para>New Hampshire offers business assistance, workforce resources and economic development programs for eligible companies.</Para>
              <Para>
                Program availability and eligibility requirements can change, so review current guidance from the appropriate New Hampshire agency.
              </Para>
              <Para>
                For most entrepreneurs looking to start a larger business, creating a New Hampshire corporation may be the best choice. As a corporation, your business is able to buy and trade stock, and when it comes to excess profits, corporations offer more flexibility than a limited liability company (LLC).
              </Para>

              <SubTitle>Benefits of Forming a New Hampshire C Corporation</SubTitle>
              ...
              <SubTitle>Benefits of Forming a New Hampshire S Corporation</SubTitle>
              ...
              <Para>
                In this guide, you'll find information on naming your corporation, getting a Registered Agent, the fees you'll need to pay, and other requirements.
              </Para>
            </section>

            <section id="section-0" style={{ marginTop: 64, scrollMarginTop: 112 }}>
              <SectionTitle>How to Form a New Hampshire Corporation Yourself in 6 Steps</SectionTitle>
              <Para>
            ...
            <section id="section-1" style={{ marginTop: 64, scrollMarginTop: 112 }}>
              <SectionTitle>New Hampshire Corporation Types</SectionTitle>
              <SubTitle>C Corporation</SubTitle>
              <Para>When you file to start a corporation, by default, it's a C Corp.</Para>
              ...
              <div style={{ margin: "40px 0", borderRadius: 12, border: "1px solid #d5dde7", background: "#f5f7f9", padding: 48, boxShadow: "0 4px 14px rgba(0,0,0,0.07)" }}>
                <h4 style={{ marginBottom: 40, fontSize: 18, fontWeight: 800, lineHeight: 1.45 }}>The professions permitted to form a New Hampshire Professional Corporation include, but may not be limited to:</h4>
            ...
            <section id="section-2" style={{ marginTop: 64, scrollMarginTop: 112 }}>
              <SectionTitle>Helpful Resources from the State of New Hampshire</SectionTitle>
              <ResourceLinks />
            </section>
