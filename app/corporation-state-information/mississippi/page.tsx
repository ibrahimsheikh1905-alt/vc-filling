...
const toc = [
  "How to Form a Mississippi Corporation Yourself in Six Steps",
  "Mississippi Corporation Types",
  "Helpful Resources from the State of Mississippi",
];
  ...
  return (
    <div style={{ marginTop: 32, overflow: "hidden", borderRadius: 12, background: "#e9edf2" }}>
      ...
      <div style={{ borderTop: "1px solid #d5dbe3", padding: "24px 44px", fontSize: 16, lineHeight: 1.6, color: "#1f2c45" }}>
        Incorp Bay can take care of all your Mississippi corporation formation paperwork — and we'll do it for free. Just pay the required Mississippi state fee ($50).
      </div>
    </div>
  );
}
...
function FilingBox() {
  const items = [
    "The corporation's name and entity type",
    "The authorized share structure",
    "The Mississippi county where the corporation is located",
  ...
  return (
    <div style={{ margin: "40px 0", borderRadius: 12, border: "1px solid #d5dde7", background: "#f5f7f9", padding: "36px", boxShadow: "0 2px 8px rgba(0,0,0,0.05)" }}>
      <h4 style={{ marginBottom: 32, fontSize: 18, fontWeight: 800 }}>Here's what is required by the Mississippi Mississippi Secretary of State:</h4>
...
function FeesTable() {
  const complianceRows = [
    ...
    ["Registered Agent", "Required with an eligible physical address in Mississippi"],
    ["Important", "Fees, forms and processing times can change. Confirm current requirements before filing."],
  ];
  return (
    <>
      <h3 style={{ marginBottom: 24, marginTop: 64, fontSize: 26, fontWeight: 800 }}>What are the Fees and Requirements to Incorporate in Mississippi?</h3>
      ...
      <h3 style={{ marginBottom: 24, marginTop: 48, fontSize: 24, fontWeight: 800 }}>Mississippi Ongoing Compliance</h3>
      <div style={{ overflow: "hidden", borderRadius: 18, border: "1px solid #dce1e7", fontSize: 18 }}>
...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function MississippiCorpPage() {
      ...
      <NavigationWrapper>
        ...
        <main style={{ width: "100%", maxWidth: 1040, padding: "36px 32px 96px", margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 56, display: "inline-flex", alignItems: "center", gap: 20, borderRadius: 12, background: "#f5f6f8", padding: "16px 24px", fontSize: 16, color: "#1b2944" }}>
            ...
            <span style={{ color: "#ff4b14" }}>Mississippi</span>
          </div>

          <h1 style={{ maxWidth: 760, fontSize: 54, fontWeight: 800, lineHeight: 1.08, letterSpacing: -1.4 }}>How to Incorporate in Mississippi</h1>
          ...
          <p style={{ marginTop: 28, fontSize: 18, fontWeight: 800 }}>Learn how to form a Mississippi corporation yourself</p>
          ...
          <section style={{ marginTop: 64 }}>
            <SectionTitle>Why Start a Mississippi Corporation?</SectionTitle>
            <Para>Mississippi offers economic development programs, workforce assistance and tax incentives that may benefit qualifying corporations.</Para>
            <Para>Program availability and eligibility requirements can change, so review current guidance from the appropriate Mississippi agency.</Para>
            <Para>For most entrepreneurs looking to start a larger business, creating a Mississippi corporation may be the best choice. As a corporation, your business is able to buy and trade stock, and when it comes to excess profits, corporations offer more flexibility than a limited liability company (LLC). A corporation is allowed to pass income and losses to its shareholders, who report taxes on an individual tax return at ordinary levels.</Para>
            ...
            <Para>Learn more about forming a <TextLink>Mississippi LLC</TextLink> so you can decide which business entity is right for you.</Para>
            <SubTitle>Benefits of Forming a Mississippi C Corporation</SubTitle>
            ...
            <SubTitle>Benefits of Forming a Mississippi S Corporation</SubTitle>
          ...
          <section id="section-0" style={{ marginTop: 64, scrollMarginTop: 112 }}>
            <SectionTitle>How to Form a Mississippi Corporation Yourself in 6 Steps</SectionTitle>
            <VideoBox />

            <SubTitle>Step 1: Choose a Unique Business Name and Complete a State Business Search</SubTitle>
            <Para>Every Mississippi business must have a unique name that hasn't already been claimed by another business in the state. If you're having difficulty coming up with a name, try using our <TextLink>Business Name Generator</TextLink> to gather ideas. You'll need to follow a few naming rules, which you can read about in detail on the <TextLink>Mississippi Business Names</TextLink> page.</Para>
            <Para>Once you've chosen a name, you'll need to make sure it's available in Mississippi. See the name is available by searching for it on the <TextLink>Mississippi Mississippi Secretary of State</TextLink> website.</Para>
            ...
            <CTANameCard text="We Can Check Mississippi Corporation Name Availability for You" buttonText="Check Name Availability" />

            <SubTitle>Step 2: Provide an Official Address for Your Corporation</SubTitle>
            <Para>A Mississippi corporation must have a designated address. That could be your home address (if you're running the company from your residence), where your office is located or any physical address of your preference. The address can be outside the state of Mississippi and can be a P.O. Box.</Para>
            <Para>Some people establish companies outside of the state they live in and will use a Registered Agent service to provide an address for receiving legal documentation in the state. The Registered Agent address is listed in public records on the Mississippi Mississippi Secretary of State website. If you do not want your own name and Mississippi address to be registered, you should use a Registered Agent service.</Para>

            <SubTitle>Step 3: Assign a Registered Agent</SubTitle>
            <Para>Every Mississippi corporation is required to have a Registered Agent — someone who receives official correspondence and is responsible for filing reports with the Mississippi Mississippi Secretary of State.</Para>
            ...
            <Para>You'll appoint your Registered Agent when you file your Articles of Incorporation with the Mississippi Mississippi Secretary of State and officially create your corporation.</Para>
            ...
            <SubTitle>Step 4: File Your Articles of Incorporation with the Mississippi Mississippi Secretary of State</SubTitle>
            <Para>Once you've gathered all the information for your corporation, you'll need to file a form with the Mississippi SOS Corporations Division. Once they process the filing, you will have officially created your business.</Para>
            <FilingBox />
            <div style={{ marginBottom: 40, display: "flex", alignItems: "center", justifyContent: "space-between", borderLeft: "4px solid #677184", background: "#f3f5f7", padding: "24px", fontSize: 20, fontWeight: 800, cursor: "pointer" }}>
              <span>Download Form Here</span><ExternalIcon />
            </div>
            <Para>Your Articles of Incorporation can be uploaded online via the state's digital portal. You can also mail the form to the Office of the Corporations Division, or Incorp Bay can file it on your behalf. The Mississippi corporation filing fee is $50.</Para>
            <div style={{ margin: "40px 0", borderRadius: 18, border: "1px solid #dce1e7", padding: 32, fontSize: 18 }}>
              ...
              <div style={{ marginTop: 12, color: "#333", lineHeight: 1.6 }}>
                Submit the Articles of Incorporation using the official Mississippi Secretary of State filing system or follow the agency's current mail and in-person instructions.
              </div>
            </div>

            <Para>You only need to submit the Articles of Incorporation once to form the corporation. After formation, file the annual report annually with the Mississippi Secretary of State and maintain the corporation's other required registrations.</Para>
            <CTANameCard text="Let Incorp Bay Handle All the Mississippi Corporation Formation Paperwork for You for $0 + the State Fee" buttonText="Get Started" />
            <FeesTable />

            <SubTitle>Step 5: Get an Employer Identification Number (EIN) from the Internal Revenue Service</SubTitle>
            <Para>You'll need an <TextLink>EIN</TextLink> to identify your business to the IRS. You use this number when filing and paying taxes, when submitting payroll information and payments for your employees and for opening a business bank account. You can obtain one directly from the IRS, or Incorp Bay can get one for you as part of the Mississippi corporation formation process.</Para>
          ...
          <section id="section-1" style={{ marginTop: 64, scrollMarginTop: 112 }}>
            <SectionTitle>Mississippi Corporation Types</SectionTitle>
            ...
            <Para>If you want your Mississippi C Corporation to be treated as a Mississippi S Corporation, file the IRS <TextLink>Election by a Small Business Corporation</TextLink> form, also known as Form 2553 or an <TextLink>S Corp Election form.</TextLink> Any Mississippi S Corporations formed through Incorp Bay will also include a prepared Form 2553 that will be delivered with the state formation documents.</Para>
            ...
            <Para>Mississippi may permit licensed professionals to form a professional corporation or another professional entity. Eligibility and ownership rules depend on the profession and applicable licensing board.</Para>
            <div style={{ margin: "40px 0", borderRadius: 12, border: "1px solid #d5dde7", background: "#f5f7f9", padding: 48, boxShadow: "0 4px 14px rgba(0,0,0,0.07)" }}>
              <h4 style={{ marginBottom: 40, fontSize: 18, fontWeight: 800, lineHeight: 1.45 }}>The professions permitted to form a Mississippi Professional Corporation include, but may not be limited to:</h4>
            ...
            <Para>Check with the Mississippi Mississippi Secretary of State to confirm whether your business should and can be a Professional Corporation.</Para>
            ...
            <Para>If your business operates in another state and you want to expand into Mississippi — or vice versa — you'll need to form a Foreign Corporation. Before you can bring an arm of your business from another state into Mississippi, you must request Foreign Qualification in Mississippi by completing a Qualification Certificate and paying the applicable state filing fee.</Para>
            <Para>Learn more about <TextLink>Mississippi Foreign Corporation registration.</TextLink></Para>
            ...
            <Para>A <TextLink>Mississippi LLC</TextLink> is usually a better option for a smaller business. It's easier to set up, but it still offers you certain advantages you'd get from a corporation. You can even have your LLC treated as an S Corporation for tax purposes to save you money.</Para>
            <Para>Regardless of which direction you decide to go, we can help you with your Mississippi business registration.</Para>
          ...
          <section id="section-2" style={{ marginTop: 64, scrollMarginTop: 112 }}>
            <SectionTitle>Helpful Resources from the State of Mississippi</SectionTitle>
            <ResourceLinks />
          </section>
          ...
          <section id="section-3" style={{ marginTop: 56, scrollMarginTop: 112 }}>
            ...
            {[
              ["Mississippi Corporation Names","How to search the state business registry and find the right name. Includes information on naming rules, fictitious names, reserving names for Mississippi corporations and more."],
              ["Mississippi Registered Agent Service","How to appoint, change and search for Registered Agents. Also includes the duties they fulfill and the rules they're required to follow."],
              ["Mississippi Incorporation Fees and Requirements","Details the various fees you'll need to pay and the state and federal requirements you'll need to meet. Includes details about Employer Identification Numbers (EINs), state and federal business licenses, annual reports and franchise tax."],
              ["Mississippi Corporation Taxes","Covers the various taxes you'll have to pay to the state and federal governments. Includes details about the Mississippi Franchise Tax, and federal taxes such as income and self-employment."],
            ].map(([h,p]) => (
