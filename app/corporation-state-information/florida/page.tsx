...
const toc = [
  "How to Form a Florida Corporation Yourself in Six Steps",
  ...
  return (
    <div style={{ marginTop: 32, overflow: "hidden", borderRadius: 12, background: "#e9edf2" }}>
      ...
      <div style={{ borderTop: "1px solid #d5dbe3", padding: "24px 44px", fontSize: 16, lineHeight: 1.6, color: "#1f2c45" }}>
        Incorp Bay can take care of all your Florida corporation formation paperwork — and we'll do it for free. Just pay the required Florida state fee ($70).
      </div>
    </div>
  );
}
...
function FilingBox() {
  const items = [
    ...
    "The principal office address and mailing address of the corporation",
    "The number of shares the corporation is authorized to issue",
    "The name and Florida street address of the Registered Agent, along with their signature accepting the appointment",
  ...
  return (
    <div style={{ margin: "40px 0", borderRadius: 12, border: "1px solid #d5dde7", background: "#f5f7f9", padding: "36px", boxShadow: "0 2px 8px rgba(0,0,0,0.05)" }}>
      <h4 style={{ marginBottom: 32, fontSize: 18, fontWeight: 800 }}>Here's what is required in your Florida Articles of Incorporation:</h4>
...
function FeesTable() {
  const complianceRows = [
    ...
    ["Filing Fee", "$150"],
    ["Important", "A late fee of $400 applies to any annual report filed after May 1. Failing to file can result in administrative dissolution of your corporation."],
  ];
  return (
    <>
      <h3 style={{ marginBottom: 24, marginTop: 64, fontSize: 26, fontWeight: 800 }}>What are the Fees and Requirements to Incorporate in Florida?</h3>
      <div style={{ overflow: "hidden", borderRadius: 18, border: "1px solid #dce1e7", fontSize: 18 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", background: "#fff" }}>
          <div style={{ padding: 18, fontWeight: 700, color: "#ff4b14" }}>$70</div>
          <div style={{ padding: 18 }}>2–5 Business Days</div>
          <div style={{ padding: 18 }}>Rush Fee Available</div>
        </div>
      </div>
      <p style={{ marginTop: 10, fontSize: 14, color: "#555" }}>*Florida does not offer state-run expedited filing for standard processing, but Incorp Bay can internally prioritize your order for the fastest possible delivery to the state.</p>

      <h3 style={{ marginBottom: 24, marginTop: 48, fontSize: 24, fontWeight: 800 }}>Florida Annual Report</h3>
      <div style={{ overflow: "hidden", borderRadius: 18, border: "1px solid #dce1e7", fontSize: 18 }}>
...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function FloridaCorpPage() {
      ...
      <NavigationWrapper>
        ...
        <main style={{ width: "100%", maxWidth: 1040, padding: "36px 32px 96px", margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 56, display: "inline-flex", alignItems: "center", gap: 20, borderRadius: 12, background: "#f5f6f8", padding: "16px 24px", fontSize: 16, color: "#1b2944" }}>
            ...
            <span style={{ color: "#ff4b14" }}>Florida</span>
          </div>

          <h1 style={{ maxWidth: 760, fontSize: 54, fontWeight: 800, lineHeight: 1.08, letterSpacing: -1.4 }}>How to Incorporate in Florida</h1>
          ...
          <p style={{ marginTop: 28, fontSize: 18, fontWeight: 800 }}>Learn how to form a Florida corporation yourself</p>
          ...
          <section style={{ marginTop: 64 }}>
            <SectionTitle>Why Start a Florida Corporation?</SectionTitle>
            <Para>The state offers several business incentives related to job creation, investments, renewable energy production and more. Your corporation may be able to take advantage of one or more of these incentives, provided it meets qualifying criteria.</Para>
            <Para>For example, there are <TextLink>Rural and Urban Job Tax Credits</TextLink> made available as an incentive for eligible businesses located within one of 15 rural areas or 13 urban areas to create new jobs. The tax credit ranges from $500 to $2,000 per qualified employee.</Para>
            <Para>For most entrepreneurs looking to start a larger business, creating a Florida corporation may be the best choice. As a corporation, your business is able to buy and trade stock, and when it comes to excess profits, corporations offer more flexibility than a limited liability company (LLC). A corporation is allowed to pass income and losses to its shareholders, who report taxes on an individual tax return at ordinary levels.</Para>
            ...
            <Para>Learn more about forming a <TextLink>Florida LLC</TextLink> so you can decide which business entity is right for you.</Para>
            <SubTitle>Benefits of Forming a Florida C Corporation</SubTitle>
            ...
            <SubTitle>Benefits of Forming a Florida S Corporation</SubTitle>
          ...
          <section id="section-0" style={{ marginTop: 64, scrollMarginTop: 112 }}>
            <SectionTitle>How to Form a Florida Corporation Yourself in 6 Steps</SectionTitle>
            <VideoBox />

            <SubTitle>Step 1: Choose a Unique Business Name and Complete a State Business Search</SubTitle>
            <Para>Every Florida business must have a unique name that hasn't already been claimed by another business in the state. If you're having difficulty coming up with a name, try using our <TextLink>Business Name Generator</TextLink> to gather ideas. You'll need to follow a few naming rules, which you can read about in detail on the <TextLink>Florida Business Names</TextLink> page.</Para>
            <Para>Once you've chosen a name, you'll need to make sure it's available in Florida. To find out whether another company in the state is using your chosen business name, use our tool to do a Florida entity search. You can also carry out a name search on <TextLink>Sunbiz</TextLink>, the online portal provided by the Florida Division of Corporations.</Para>
            <Para>If you don't want to form your corporation right away, you can reserve the business name by submitting an application to the Department of State. The name will be reserved for 120 days.</Para>
            <CTANameCard text="We Can Search the Florida Business Registry for You" buttonText="Check Name Availability" />

            <SubTitle>Step 2: Provide an Official Address for Your Corporation</SubTitle>
            <Para>Every Florida corporation must have a designated street address. That could be your home address (if you're running the company from your residence), your company's office building, or any other physical address. The address can be outside the state of Florida, but it cannot be a P.O. Box.</Para>
            <Para>You may also be able to use a virtual mailbox for your business address. Incorp Bay can provide you with a Florida virtual mailbox, where we'll receive your mail and scan it for your online review.</Para>

            <SubTitle>Step 3: Assign a Registered Agent</SubTitle>
            <Para>Someone who receives official correspondence and is responsible for filing reports with the Florida Department of State is known as a Registered Agent. Every Florida corporation is required to have a Registered Agent.</Para>
            ...
            <Para>You'll appoint your Registered Agent when you file your Articles of Incorporation with the DOS, Division of Corporations and officially form your corporation, and they must formally accept the appointment.</Para>
            ...
            <SubTitle>Step 4: File Your Articles of Incorporation with the Florida Department of State</SubTitle>
            <Para>Once you've gathered all the information for your corporation, you'll need to file your Articles of Incorporation with the Department of State, Division of Corporations. Once they process the filing, you will have officially created your business.</Para>
            <FilingBox />
            <div style={{ marginBottom: 40, display: "flex", alignItems: "center", justifyContent: "space-between", borderLeft: "4px solid #677184", background: "#f3f5f7", padding: "24px", fontSize: 20, fontWeight: 800, cursor: "pointer" }}>
              <span>Download Form Here</span><ExternalIcon />
            </div>
            <Para>Your Articles of Incorporation can be filed online via Sunbiz. You can also mail the form to the Office of the Division of Corporations, or Incorp Bay can file it on your behalf. The Florida corporation filing fee is $70.</Para>
            <div style={{ margin: "40px 0", display: "grid", gridTemplateColumns: "1fr 1fr", borderRadius: 18, border: "1px solid #dce1e7", padding: 32, fontSize: 18, gap: 24 }}>
              <div>
                ...
                <div style={{ marginTop: 12, color: "#333" }}>
                  ...
                  <span style={{ color: ORANGE }}>Florida Department of State</span><br />
            ...
            <Para>You only need to file your Articles of Incorporation in Florida once, but every year you'll also need to file an annual report with the Department of State between January 1st and May 1st. Incorp Bay can remind you about this every year, or we can do it for you if you have us handle the paperwork.</Para>
            <CTANameCard text="Let Incorp Bay Handle All the Florida Corporation Formation Paperwork for You for $0 + the State Fee" buttonText="Get Started" />
            <FeesTable />

            <SubTitle>Step 5: Get an Employer Identification Number (EIN) from the Internal Revenue Service</SubTitle>
            <Para>You'll need an <TextLink>EIN</TextLink> to identify your business to the IRS. You use this number for filing and paying taxes, submitting payroll information and payments for your employees and opening a business bank account. You can obtain one directly from the IRS, or Incorp Bay can get one for you as part of the Florida corporation formation process.</Para>
            ...
            <Para>The state of Florida requires corporations to have bylaws per the Florida Business Corporation Act. Although you are legally required to have bylaws, you are not required to file them with the Department of State — simply keep them at the principal address of your corporation and continue to follow them.</Para>
            <Para>Drafting a set of bylaws can be extremely helpful in making sure you're organized and can help protect your business from any future changes and events.</Para>
          </section>

          {/* SECTION 1 — CORP TYPES */}
          <section id="section-1" style={{ marginTop: 64, scrollMarginTop: 112 }}>
            <SectionTitle>Florida Corporation Types</SectionTitle>
            ...
            <Para>A Florida C Corporation will offer you several liability protections, but it will also be required to adhere to numerous strict rules and regulations. Florida requires corporations to hold annual shareholders' meetings.</Para>
            ...
            <Para>If you want your Florida C Corporation to be treated as a Florida S Corporation, file the IRS <TextLink>Election by a Small Business Corporation</TextLink> form, also known as Form 2553 or an <TextLink>S Corp Election form.</TextLink> Any Florida S Corporations formed through Incorp Bay will also include a prepared Form 2553 that will be delivered with the state formation documents.</Para>
            ...
            <Para>Some states, including Florida, allow certain occupations to form Professional Corporations. However, the Florida Secretary of State does not provide a defined list of qualifying professions. Instead, the state advises:</Para>
            <Para>"Before submitting the completed form, contact the Florida state board or agency that controls your profession to find out if your profession is authorized to be a corporation in Florida and if there are any specific corporate name style rules."</Para>
            <Para>Check with the relevant Florida licensing board or agency for your profession to confirm whether your business should and can be a Professional Corporation.</Para>

            <SubTitle>Foreign Corporation</SubTitle>
            <Para>If your business operates in another state and you want to expand into Florida — or vice versa — you'll need to form a Foreign Corporation. Before you can bring an arm of your business from another state into Florida, you must request Foreign Qualification in Florida.</Para>
            <Para>Learn more about <TextLink>Florida Foreign Corporation registration.</TextLink></Para>
            ...
            <Para>A <TextLink>Florida LLC</TextLink> is usually a better option for a smaller business. It's easier to set up, but it still offers you certain advantages you'd get from a corporation. You can even have your LLC treated as an S Corporation for tax purposes to save you money.</Para>
            <Para>Regardless of which direction you decide to go, we can help you with your Florida business registration.</Para>
          ...
          <section id="section-2" style={{ marginTop: 64, scrollMarginTop: 112 }}>
            <SectionTitle>Helpful Resources from the State of Florida</SectionTitle>
            <ResourceLinks />
          </section>
          ...
          <section id="section-3" style={{ marginTop: 56, scrollMarginTop: 112 }}>
            ...
            {[
              ["Florida Corporation Names","How to search the state business registry and find the right name. Includes information on naming rules, fictitious names, reserving names for Florida corporations and more."],
              ["Florida Registered Agent Service","How to appoint, change and search for Registered Agents. Also includes the duties they fulfill and the rules they're required to follow."],
              ["Florida Incorporation Fees and Requirements","Details the various fees you'll need to pay and the state and federal requirements you'll need to meet. Includes details about Employer Identification Numbers (EINs), state and federal business licenses, annual reports and more."],
              ["Florida Corporation Taxes","Covers the various taxes you'll have to pay to the state and federal governments. Includes details about state taxes such as sales and use, and federal taxes such as income and self-employment."],
            ].map(([h,p]) => (
