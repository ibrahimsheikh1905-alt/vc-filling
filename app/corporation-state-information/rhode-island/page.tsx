...
const toc = [
  "How to Form a Rhode Island Corporation Yourself in Six Steps",
  "Rhode Island Corporation Types",
  ...
  return (
    <div style={{ marginTop: 32, overflow: "hidden", borderRadius: 12, background: "#e9edf2" }}>
      ...
      <div style={{ borderTop: "1px solid #d5dbe3", padding: "24px 44px", fontSize: 16, lineHeight: 1.6, color: "#1f2c45" }}>
        Incorp Bay can take care of all your Rhode Island corporation formation paperwork — and we'll do it for free. Just pay the required Rhode Island state fee ($230).
      </div>
    </div>
  );
}
...
function FilingBox() {
  const items = [
    ...
    "The Registered Agent's name and eligible Rhode Island address",
  ...
  return (
    <div style={{ margin: "40px 0", borderRadius: 12, border: "1px solid #d5dde7", background: "#f5f7f9", padding: "36px", boxShadow: "0 2px 8px rgba(0,0,0,0.05)" }}>
      <h4 style={{ marginBottom: 32, fontSize: 18, fontWeight: 800 }}>Here's what is required by the Rhode Island Department of State, Business Services Division:</h4>
...
function FeesTable() {
  const complianceRows = [
    ...
    ["Formation Filing Fee", "$230"],
    ["Filing Authority", "Rhode Island Department of State, Business Services Division"],
    ["Registered Agent", "Required under applicable Rhode Island rules"],
    ["Important", "Fees, forms and processing times can change. Confirm current requirements before filing."],
  ];
  return (
    <>
      <h3 style={{ marginBottom: 24, marginTop: 64, fontSize: 26, fontWeight: 800 }}>What are the Fees and Requirements to Incorporate in Rhode Island?</h3>
      <div style={{ overflow: "hidden", borderRadius: 18, border: "1px solid #dce1e7", fontSize: 18 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", background: "#fff" }}>
          <div style={{ padding: 18, fontWeight: 700, color: "#2B93C9" }}>$230*</div>
      ...
      <h3 style={{ marginBottom: 24, marginTop: 48, fontSize: 24, fontWeight: 800 }}>Rhode Island Ongoing Compliance</h3>
      <div style={{ overflow: "hidden", borderRadius: 18, border: "1px solid #dce1e7", fontSize: 18 }}>
...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function RhodeIslandCorpPage() {
      ...
      <NavigationWrapper>
        ...
        <main style={{ width: "100%", maxWidth: 1040, padding: "36px 32px 96px", margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 56, display: "inline-flex", alignItems: "center", gap: 20, borderRadius: 12, background: "#f5f6f8", padding: "16px 24px", fontSize: 16, color: "#1b2944" }}>
            ...
            <span style={{ ...gradientTextStyle, fontWeight: 700 }}>Rhode Island</span>
          </div>

          <h1 style={{ maxWidth: 760, fontSize: 54, fontWeight: 800, lineHeight: 1.08, letterSpacing: -1.4, color: "#1E293B" }}>How to Incorporate in <span style={gradientTextStyle}>Rhode Island</span></h1>
          ...
          <p style={{ marginTop: 28, fontSize: 18, fontWeight: 800 }}>Learn how to form a Rhode Island corporation yourself</p>
          ...
          <section style={{ marginTop: 64 }}>
            <SectionTitle>Why Start a Rhode Island Corporation?</SectionTitle>
            <Para>The State of Rhode Island has implemented several incentives and tax credits that may help businesses secure new capital or keep more revenue. Your corporation may be able to take advantage of these incentives, provided it meets the qualifying criteria.</Para>
            <Para>For example, the <TextLink>Angel Investor Tax Credit</TextLink> provides a refundable tax credit for qualified investors in innovative, Rhode Island-based small businesses.</Para>
            <Para>For most entrepreneurs looking to start a larger business, creating a Rhode Island corporation may be the best choice. As a corporation, your business is able to buy and trade stock, and when it comes to excess profits, corporations offer more flexibility than a limited liability company (LLC). A corporation is allowed to pass income and losses to its shareholders, who report taxes on an individual tax return at ordinary levels.</Para>
            ...
            <Para>Learn more about forming a <TextLink>Rhode Island LLC</TextLink> so you can decide which business entity is right for you.</Para>
            <SubTitle>Benefits of Forming a Rhode Island C Corporation</SubTitle>
            ...
            <SubTitle>Benefits of Forming a Rhode Island S Corporation</SubTitle>
          ...
          <section id="section-0" style={{ marginTop: 64, scrollMarginTop: 112 }}>
            <SectionTitle>How to Form a Rhode Island Corporation Yourself in 6 Steps</SectionTitle>
            <VideoBox />

            <SubTitle>Step 1: Choose a Unique Business Name and Complete a State Business Search</SubTitle>
            <Para>Every Rhode Island business must have a unique name that hasn't already been claimed by another business in the state. If you're having difficulty coming up with a name, try using our <TextLink>Business Name Generator</TextLink> to gather ideas. You'll need to follow a few naming rules, which you can read about in detail on the <TextLink>Rhode Island Business Names</TextLink> page.</Para>
            <Para>Once you've chosen a name, you'll need to make sure it's available in Rhode Island. See the name is available by searching for it on the <TextLink>Rhode Island Department of State, Business Services Division</TextLink> website.</Para>
            ...
            <CTANameCard text="We Can Check Rhode Island Corporation Name Availability for You" buttonText="Check Name Availability" />

            <SubTitle>Step 2: Provide an Official Address for Your Corporation</SubTitle>
            <Para>A Rhode Island corporation must have a designated address. That could be your home address (if you're running the company from your residence), where your office is located or any physical address of your preference. The address can be outside the state of Rhode Island and can be a P.O. Box.</Para>
            <Para>Some people establish companies outside of the state they live in and will use a Registered Agent service to provide an address for receiving legal documentation in the state. The Registered Agent address is listed in public records on the Rhode Island Department of State, Business Services Division website. If you do not want your own name and Rhode Island address to be registered, you should use a Registered Agent service.</Para>

            <SubTitle>Step 3: Assign a Registered Agent</SubTitle>
            <Para>Every Rhode Island corporation is required to have a Registered Agent — someone who receives official correspondence and is responsible for filing reports with the Rhode Island Department of State, Business Services Division.</Para>
            ...
            <Para>You'll appoint your Registered Agent when you file your Articles of Incorporation with the Rhode Island Department of State, Business Services Division and officially create your corporation.</Para>
            ...
            <SubTitle>Step 4: File Your Articles of Incorporation with the Rhode Island Department of State, Business Services Division</SubTitle>
            <Para>Once you've gathered all the information for your corporation, you'll need to file a form with the Rhode Island Department of State, Business Services Division. Once they process the filing, you will have officially created your business.</Para>
            <FilingBox />
            <div style={{ marginBottom: 40, display: "flex", alignItems: "center", justifyContent: "space-between", borderLeft: "4px solid #2B93C9", background: "linear-gradient(90deg,rgba(36,78,182,.05),rgba(51,209,204,.08))", padding: "24px", fontSize: 20, fontWeight: 800, cursor: "pointer" }}>
              <span>Download Form Here</span><ExternalIcon />
            </div>
            <Para>Your Articles of Incorporation can be uploaded online via the state's digital portal. You can also mail the form to the Office of the Corporations Division, or Incorp Bay can file it on your behalf. The Rhode Island Corporation filing fee is $230.</Para>
            <div style={{ margin: "40px 0", display: "grid", gridTemplateColumns: "1fr 1fr", borderRadius: 18, border: "1px solid #dce1e7", padding: 32, fontSize: 18, gap: 24 }}>
              <div>
                ...
                <div style={{ marginTop: 12, color: "#333" }}>
                  Rhode Island Department of State, Business Services Division<br />
            ...
            <Para>You only need to file your Articles of Incorporation in Rhode Island once, but you'll also need to file an annual report with the Rhode Island SOS by March 1 of each year following the calendar year in which your Articles of Incorporation becomes effective. Corporate taxes and the RI Franchise Tax, which are also due at the time of filing of the report, are based on the stock listed in the Articles of Incorporation. Incorp Bay can remind you about this every year, or we can do it for you if you have us handle the paperwork.</Para>
            <CTANameCard text="Let Incorp Bay Handle All the Rhode Island Corporation Formation Paperwork for You for $0 + the State Fee" buttonText="Get Started" />
            <FeesTable />

            <SubTitle>Step 5: Get an Employer Identification Number (EIN) from the Internal Revenue Service</SubTitle>
            <Para>You'll need an <TextLink>EIN</TextLink> to identify your business to the IRS. You use this number when filing and paying taxes, when submitting payroll information and payments for your employees and for opening a business bank account. You can obtain one directly from the IRS, or Incorp Bay can get one for you as part of the Rhode Island corporation formation process.</Para>
            ...
            <Para>You are required to have Rhode Island corporation bylaws per Title 8, Chapter 1, Subchapter 1, § 109 of the state's legal code. You're not required to file them with the Rhode Island Department of State, Business Services Division but must store them on the business premises.</Para>
          ...
          <section id="section-1" style={{ marginTop: 64, scrollMarginTop: 112 }}>
            <SectionTitle>Rhode Island Corporation Types</SectionTitle>
            ...
            <Para>If you want your Rhode Island C Corporation to be treated as a Rhode Island S Corporation, file the IRS <TextLink>Election by a Small Business Corporation</TextLink> form, also known as Form 2553 or an <TextLink>S Corp Election form.</TextLink> Any Rhode Island S Corporations formed through Incorp Bay will also include a prepared Form 2553 that will be delivered with the state formation documents.</Para>
            ...
            <Para>Some states, including Rhode Island, allow certain occupations to form Professional Corporations and offer professional services. The state's professional corporation statute defines these services as:</Para>
            ...
            <div style={{ margin: "40px 0", borderRadius: 12, border: "1px solid #d5dde7", background: "#f5f7f9", padding: 48, boxShadow: "0 4px 14px rgba(0,0,0,0.07)" }}>
              <h4 style={{ marginBottom: 40, fontSize: 18, fontWeight: 800, lineHeight: 1.45 }}>The professions permitted to form a Rhode Island Professional Corporation include, but may not be limited to:</h4>
            ...
            <Para>Check with the Rhode Island Department of State, Business Services Division to confirm whether your business should and can be a Professional Corporation.</Para>
            ...
            <Para>A <TextLink>Rhode Island LLC</TextLink> is usually a better option for a smaller business. It's easier to set up, but it still offers you certain advantages you'd get from a corporation. You can even have your LLC treated as an S Corporation for tax purposes to save you money.</Para>
            <Para>Regardless of which direction you decide to go, we can help you with your Rhode Island business registration.</Para>
          ...
          <section id="section-2" style={{ marginTop: 64, scrollMarginTop: 112 }}>
            <SectionTitle>Helpful Resources from the State of Rhode Island</SectionTitle>
            <ResourceLinks />
          </section>
          ...
          <section id="section-3" style={{ marginTop: 56, scrollMarginTop: 112 }}>
            ...
            {[
              ["Rhode Island Corporation Names","How to search the state business registry and find the right name. Includes information on naming rules, fictitious names, reserving names for Rhode Island corporations and more."],
              ["Rhode Island Registered Agent Service","How to appoint, change and search for Registered Agents. Also includes the duties they fulfill and the rules they're required to follow."],
              ["Rhode Island Incorporation Fees and Requirements","Details the various fees you'll need to pay and the state and federal requirements you'll need to meet. Includes details about Employer Identification Numbers (EINs), state and federal business licenses, annual reports and franchise tax."],
              ["Rhode Island Corporation Taxes","Covers the various taxes you'll have to pay to the state and federal governments. Includes details about the Rhode Island Franchise Tax, and federal taxes such as income and self-employment."],
            ].map(([h,p]) => (
