  ...
  try {
    ...
    try {
      ...
      if (userResponse.user) {
        ...
        await handleUsers(userResponse.user, "annual_report");
      }
    } catch (error) {
    ...
    const values = [
      ...
      data.members ?? null,
      data.sameAsCompanyAddress ?? null,
      data.mailStreetAddress ?? null,
      data.mailAddressLine2 ?? null,
      data.mailCity ?? null,
      data.mailState ?? null,
      data.mailZipCode ?? null,
      getFormattedDate(),
    ];
