...
function PrimaryButton({ children, href }: { children: React.ReactNode; href?: string }) {
  if (href) {
    return (
      <Link href={href} className="rounded-full bg-[linear-gradient(90deg,#244EB6_0%,#2B93C9_50%,#33D1CC_100%)] px-8 py-3.5 text-sm font-bold text-white shadow-lg transition-all duration-300 hover:brightness-110 hover:scale-[1.03] hover:shadow-[0_10px_35px_rgba(43,147,201,0.45)]">
        {children}
      </Link>
    );
  }
  return (
    <button className="rounded-full bg-[linear-gradient(90deg,#244EB6_0%,#2B93C9_50%,#33D1CC_100%)] px-8 py-3.5 text-sm font-bold text-white shadow-lg transition-all duration-300 hover:brightness-110 hover:scale-[1.03] hover:shadow-[0_10px_35px_rgba(43,147,201,0.45)]">
      {children}
    </button>
  );
}
  ...
  return (
    <section className="relative grid grid-cols-1 items-center gap-12 overflow-hidden px-6 py-16 md:grid-cols-2 md:px-16 md:py-24">
      ...
      <div className="relative z-10">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-4">
          <button onClick={handleGetStarted} className="rounded-full bg-[linear-gradient(90deg,#244EB6_0%,#2B93C9_50%,#33D1CC_100%)] px-8 py-3.5 text-sm font-bold text-white shadow-lg transition-all duration-300 hover:brightness-110 hover:scale-[1.03] hover:shadow-[0_10px_35px_rgba(43,147,201,0.45)]">
            GET STARTED
          </button>
          <GhostButton>LEARN MORE</GhostButton>
        </div>
...
function CTASection() {
  ...
  return (
    <section className="px-6 py-16 md:px-16">
      <div 
        className="relative mx-auto max-w-4xl rounded-[40px] overflow-hidden py-14 px-8 sm:px-12 text-center shadow-2xl border border-white/5" 
        style={{ background: 'linear-gradient(135deg,#244EB6 0%,#2B93C9 50%,#33D1CC 100%)' }}
      >
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr] gap-6 p-2 md:p-6 items-center">
          ...
          <div className="relative z-10 flex flex-col items-start text-left w-full pt-2 space-y-4">
            ...
            <button onClick={handleGetStarted} className="group relative bg-[linear-gradient(90deg,#244EB6_0%,#2B93C9_50%,#33D1CC_100%)] px-6 py-3 text-xs font-bold uppercase tracking-wider text-white shadow-lg transition-all duration-300 hover:brightness-110 hover:scale-[1.03] active:scale-[0.98] rounded-xl">
              <div className="absolute inset-0 bg-gradient-to-br from-[#06B6D4] to-[#0891b2] opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 rounded-xl" />
              GET STARTED
            </button>
          </div>
