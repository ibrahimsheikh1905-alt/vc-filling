...
useEffect(() => {
    ...
    // Fetch user data to pre-fill director information
        ...
        if (parts.length >= 2) {
          ...
          if (userId) {
            ...
            if (response.data.success && response.data.user) {
              ...
              // Pre-fill first director with user data
              if (formData.memberNumber === "" || formData.memberNumber === "1") {
                ...
                setValue("members", updatedMembers as Member[]);
              }
            }
          }
        }
