...
const StepOne = () => {
  ...
  const {
    ...
    // watch,
    formState: { errors },
  } = useForm<Inputs>({ defaultValues: { notifyStateOfService : "No"} });
  const onSubmit: SubmitHandler<Inputs> = (data) => {
    updateFormData(data);
    router.push("/virtual-address/step-2");
  };
        ...
        <div className="container my-10 ">
          <div className="md:flex gap-10 ">
            <div className="max-w-4xl grow mx-auto">
              <h1 className="text-3xl font-bold">Virtual Address</h1>
              <p className="text-gray-500 text-sm mt-3">
                VC Filling currently provides virtual mailboxes in 48 different
              ...
              {/* Virtual company address info */}
              {formData.companyName !== "" &&
                formData.designator !== "" &&
                formData.stateOfService !== "" &&
                  ...
                  <div className="bg-white rounded-3xl  mx-auto max-w-4xl shadow-lg px-16 py-12 my-8">
                    ...
                    <div className="border rounded-lg p-4 border-primary">
                      ...
                      <p className="text-lg font-bold mt-2 text-gray-800">
                        602 VIRGINIA ST STE 100, CHARLESTON,{" "}
                        {formData.stateOfService} 25301
                      </p>
                      ...
                      <ul className="mt-4 space-y-2 text-sm text-gray-700">
                        <li className="flex items-start">
                          <span className="text-primary mr-2">✓</span> Maintain
                          privacy by using a commercial address
                        </li>
                        <li className="flex items-start">
                          <span className="text-primary mr-2">✓</span> Unlimited
                          scanned incoming mail
                        </li>
                        <li className="flex items-start">
                          <span className="text-primary mr-2">✓</span> A
                          physical address for your business (not P.O. Box)
                        </li>
                        <li className="flex items-start">
                          <span className="text-primary mr-2">✓</span> Instant
                          alerts with 24/7 access to your mail online
                        </li>
                      </ul>
                    </div>
                    <div className="mt-6">
                      <p className="mb-2">
                        Would you like us to notify the state of the update to
                      ...
                      <div className="flex space-x-4">
                        <label className="flex items-center">
                          <input
                            type="radio"
                            value="Yes"
                            {...register("notifyStateOfService", {
                              required: true,
                            })}
                            onChange={(e) =>
                              updateFormData({
                                notifyStateOfService: e.target.value,
                              })
                            }
                          />
