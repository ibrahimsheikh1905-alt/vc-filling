...
const StepOne = () => {
  ...
  useEffect(() => {
    ...
    const setServiceType = () => {
      localStorage.setItem("serviceType", "reinstatement");
    };
    setServiceType();
  }, []);
        ...
        <div className="container my-10 ">
          <div className="md:flex gap-10 ">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-3xl font-bold">Reinstatement</h1>
              <p className="text-gray-600 mt-3">
                A Reinstatement order restores an inactive, non-compliant, or
                dissolved company into good standing with the State of Formation
                as if the company was never deregistered.
              </p>
