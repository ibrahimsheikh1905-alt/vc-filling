...
import { businessTypeData, statesInUS } from "@/data";
...
const StepOne = () => {
  ...
  useEffect(() => {
    ...
    const setServiceType = () => {
      localStorage.setItem("serviceType", "business-license");
    };
    setServiceType();
  }, []);
          ...
          <div className="md:flex gap-10 ">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-gray-500 mt-4">
                A business license authorizes a company to &quot;do
                business&quot; in a certain geographical jurisdiction. It is a
                certificate that authenticates your company is properly
                registered with the particular county or city in which your
