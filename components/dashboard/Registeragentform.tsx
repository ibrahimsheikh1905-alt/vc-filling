  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] p-4 md:p-10 font-sans text-left">
      <div className="max-w-7xl mx-auto">
        ...
        <button 
          onClick={() => router.back()}
          className="flex items-center text-[13px] font-bold text-gray-900 mb-6 hover:text-cyan-600 transition-colors"
        >
        ...
        <div className="mb-10 max-w-4xl">
          <h1 className="text-2xl font-bold text-gray-900 mb-4 tracking-tight">Registered Agent</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-8 items-start">
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="col-span-full">
                   ...
                   <select className="w-full border border-gray-200 rounded-lg px-4 py-3 text-[14px] bg-white italic outline-none focus:border-cyan-500">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button 
                    ...
                    className={`p-4 border-2 rounded-xl flex items-center gap-3 transition-all ${transferAgent === 'Yes' ? 'border-cyan-500 bg-white' : 'border-gray-100 bg-gray-50'}`}
                  >
                    <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${transferAgent === 'Yes' ? 'border-cyan-500' : 'border-gray-300'}`}>
                      {transferAgent === 'Yes' && <div className={`${LOGO_GRADIENT} w-2 h-2 rounded-full`} />}
                    </div>
                    <span className="text-[13px] font-bold italic">Yes</span>
                  </button>
                  <button 
                    onClick={() => setTransferAgent('No')}
                    className={`p-4 border-2 rounded-xl flex items-center gap-3 transition-all ${transferAgent === 'No' ? 'border-cyan-500 bg-white' : 'border-gray-100 bg-gray-50'}`}
                  >
                    <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${transferAgent === 'No' ? 'border-cyan-500' : 'border-gray-300'}`}>
                      {transferAgent === 'No' && <div className={`${LOGO_GRADIENT} w-2 h-2 rounded-full`} />}
                    </div>
          ...
          <aside className="lg:sticky lg:top-8">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-xl p-8">
              <h3 className="text-[18px] font-bold text-gray-900 mb-8 italic">Order Summary</h3>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between items-center pt-4 border-t border-gray-50 mt-4">
                  ...
                  <span className="text-3xl font-bold text-gray-900 tracking-tighter">$119</span>
                </div>
              </div>

              <button className={`${LOGO_GRADIENT} group relative w-full overflow-hidden text-white font-bold py-4 rounded-full transition-all duration-300 hover:scale-[1.03] hover:brightness-110 shadow-md text-[14px] uppercase mb-6 tracking-widest`}>
              ...
              <div className="flex flex-col items-center opacity-70 mb-6 scale-90">
                ...
                <p className="text-[10px] font-bold italic text-gray-500 text-center">
                  ...
                  <span className="text-[#00B67A] font-bold uppercase tracking-tighter">Trustpilot</span>
                </p>
              </div>
