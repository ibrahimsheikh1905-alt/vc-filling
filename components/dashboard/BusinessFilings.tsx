  ...
  return (
    <div className="min-h-screen bg-slate-50 py-12 px-4 font-sans">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        {/* --- HEADER SECTION --- */}
        <div className="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm flex flex-col md:flex-row justify-between items-center w-full gap-8">
          <div className="text-left space-y-3 flex-1">
            <div className="flex items-center gap-2 text-slate-400 text-[11px] font-bold uppercase tracking-widest">
              <span className="text-cyan-500 text-lg">💼</span> State & IRS Filings
            </div>
            ...
            <p className="text-[14px] text-slate-500 max-w-lg leading-relaxed">
              As your business evolves, Incorp Bay ensures you have the tools and support to manage your ongoing requirements with ease and confidence.
            </p>
          </div>
        ...
        <div className="space-y-4 pt-4">
          <h2 className="text-xl font-bold text-slate-900 text-left pl-1">State Filings</h2>

          <div className="space-y-3">
            {stateFilings.map((filing, index) => (
              <div key={index} className="bg-white rounded-xl p-6 border border-slate-100 shadow-sm flex flex-row items-center justify-between gap-6 hover:border-cyan-100 transition-all group">
                <div className="flex items-start gap-5 text-left flex-1">
                  <div className="mt-1 w-6 h-6 rounded-lg border-2 border-cyan-100 flex items-center justify-center shrink-0 group-hover:bg-cyan-50 transition-colors">
                    <Check className="w-3.5 h-3.5 text-cyan-500 stroke-[3px]" />
                  </div>
                  <div className="space-y-1">
                    <h3 className="font-bold text-[15px] text-slate-900 leading-none">{filing.title}</h3>
                    <p className="text-[12px] text-slate-400 max-w-2xl leading-relaxed">{filing.desc}</p>
                  </div>
                </div>
        ...
        <div className="space-y-6 pt-10 text-left">
          <div className="space-y-2 pl-1">
            <h2 className="text-xl font-bold text-slate-900">Federal & IRS Filings</h2>
            <p className="text-[11px] text-slate-400 font-medium italic">
              Please note that Federal & IRS Filings are not included in the Incorp Bay State Filings Bundle.
            </p>
          </div>

          <div className="bg-white rounded-xl p-6 border border-slate-100 shadow-sm flex flex-row items-center justify-between gap-6">
            <div className="flex items-start gap-5 text-left flex-1">
              <div className="mt-1 w-6 h-6 rounded-lg border-2 border-cyan-100 flex items-center justify-center shrink-0">
                <Check className="w-3.5 h-3.5 text-cyan-500 stroke-[3px]" />
              </div>
              <div className="space-y-1">
                <h3 className="font-bold text-[15px] text-slate-900 leading-none">EIN / Tax ID Number</h3>
