  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] p-4 md:p-10 font-sans text-left">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10">
          <h1 className="text-xl font-bold text-gray-900 italic">Registration Of Fictitious Name</h1>
        </div>
          ...
          <div className="space-y-6 pb-20">
            ...
            <div className="bg-white rounded-xl p-8 border border-gray-100 shadow-sm">
              ...
              <div className="border-2 border-[#FF6B35] rounded-lg p-5 bg-white flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 text-[12px] uppercase tracking-wide">NEW COMPANY</h4>
            ...
            <div className="bg-white rounded-xl p-8 border border-gray-100 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="col-span-full">
                   <label className="block text-[12px] font-bold text-gray-700 mb-2 italic uppercase">Entity Type</label>
                ...
                <div>
                   <label className="block text-[12px] font-bold text-gray-700 mb-2 italic uppercase">State of Formation <Info className="w-3 h-3 inline text-gray-400"/></label>
                   <select className="w-full border border-gray-200 rounded-lg px-4 py-3 text-[14px] bg-white text-gray-400 outline-none">
                     <option>Select State</option>
                   </select>
                </div>
                <div>
                   <label className="block text-[12px] font-bold text-gray-700 mb-2 italic uppercase">State of Service</label>
                   <select className="w-full border border-gray-200 rounded-lg px-4 py-3 text-[14px] bg-white text-gray-400 outline-none">
                     <option>Select State</option>
                   </select>
                </div>
                <div>
                   <label className="block text-[12px] font-bold text-gray-700 mb-2 italic uppercase">Company Name</label>
                   <input type="text" className="w-full border border-gray-200 rounded-lg px-4 py-3 outline-none" />
                </div>
                <div>
                   <label className="block text-[12px] font-bold text-gray-700 mb-2 italic uppercase">Designator</label>
                   <select className="w-full border border-gray-200 rounded-lg px-4 py-3 text-[14px] bg-white text-gray-400 outline-none">
            ...
            {/* 3. Company Address */}
            <div className="bg-white rounded-xl p-8 border border-gray-100 shadow-sm">
              <h3 className="text-[16px] font-bold text-gray-800 mb-6 border-b border-gray-50 pb-4 italic">Company Address</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="col-span-full">
                  <label className="block text-[12px] font-bold text-gray-700 mb-2 italic uppercase">Street Address</label>
                  <input type="text" className="w-full border border-gray-200 rounded-lg px-4 py-3 outline-none" />
                </div>
                <div>
                  <label className="block text-[12px] font-bold text-gray-700 mb-2 italic uppercase">City</label>
                  <input type="text" className="w-full border border-gray-200 rounded-lg px-4 py-3 outline-none" />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[12px] font-bold text-gray-700 mb-2 italic uppercase">State</label>
                    <select className="w-full border border-gray-200 rounded-lg px-4 py-3 bg-white text-gray-400 outline-none">
                      <option>Select State</option>
                    </select>
                  </div>
                  <div>
                    <label className="block text-[12px] font-bold text-gray-700 mb-2 italic uppercase">Zip Code</label>
                    <input type="text" className="w-full border border-gray-200 rounded-lg px-4 py-3 outline-none" />
                  </div>
                </div>
              </div>
            ...
            {/* Fictitious Name Extra Field */}
            <div className="space-y-2">
              <label className="block text-[12px] font-bold text-gray-700 italic">Please enter the name exactly as you would like it filed</label>
              <input type="text" className="w-full border border-gray-200 rounded-lg px-4 py-3 bg-white outline-none" />
            </div>
...
export default Registrationoffictitious;