    ...
    <div className="min-h-screen bg-[#F9FAFB] p-4 md:p-10 font-sans text-left">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 max-w-4xl">
          <h1 className="text-3xl font-bold text-gray-900 mb-6 tracking-tight">Foreign Qualification</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-10 items-start">
          ...
          <div className="space-y-8 pb-20">
            ...
            <div className="bg-white rounded-[20px] p-8 md:p-10 border border-gray-100 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                <div
                  ...
                  className={`rounded-xl p-5 flex items-center gap-3 bg-white cursor-pointer transition-all border-2 ${
                    activeAgent === 'bizee' ? 'border-transparent bg-[linear-gradient(white,white)_padding-box,linear-gradient(90deg,#244EB6,#2B93C9,#33D1CC)_border-box] shadow-md shadow-[#2B93C9]/10' : 'border-gray-100 opacity-60'
                  }`}
                >
                  <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${activeAgent === 'bizee' ? 'border-[#2B93C9]' : 'border-gray-300'}`}>
                    {activeAgent === 'bizee' && <div className={`${LOGO_GRADIENT} w-2.5 h-2.5 rounded-full`}/>}
                  </div>
                ...
                <div
                  ...
                  className={`rounded-xl p-5 flex items-center gap-3 bg-white cursor-pointer transition-all border-2 ${
                    activeAgent === 'own' ? 'border-transparent bg-[linear-gradient(white,white)_padding-box,linear-gradient(90deg,#244EB6,#2B93C9,#33D1CC)_border-box] shadow-md shadow-[#2B93C9]/10' : 'border-gray-100 opacity-60'
                  }`}
                >
                  <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${activeAgent === 'own' ? 'border-[#2B93C9]' : 'border-gray-300'}`}>
                    {activeAgent === 'own' && <div className={`${LOGO_GRADIENT} w-2.5 h-2.5 rounded-full`}/>}
                  </div>
              ...
              <div className="mt-12 pt-8 border-t border-gray-50 space-y-8">
                <h4 className="text-[16px] font-bold text-gray-900 tracking-tight">Why use us as your registered agent?</h4>
          ...
          <aside className="lg:sticky lg:top-8 z-30">
            <div className="bg-white rounded-[24px] border border-gray-100 shadow-2xl p-8">
              <h3 className="text-[20px] font-bold text-gray-900 mb-8 tracking-tighter">Order Summary</h3>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between items-center pt-2">
                  <span className="text-[20px] font-bold text-gray-900 tracking-tighter">Total</span>
