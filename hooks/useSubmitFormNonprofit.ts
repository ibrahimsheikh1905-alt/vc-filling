...
export async function submitFormNonprofitData(paymentData: PaymentData, captureId: string, captureStatus: string) {
  const companyAddressData = JSON.parse(
    localStorage.getItem("/start-a-nonprofit/step-5") || "{}"
  );
  const agentInfoData = JSON.parse(
    localStorage.getItem("/start-a-nonprofit/step-8") || "{}"
  );
  const physicalStrtAddressData = JSON.parse(
    localStorage.getItem("/start-a-nonprofit/step-9") || "{}"
  );
  const licensePermitAddressData = JSON.parse(
    localStorage.getItem("/start-a-nonprofit/step-12") || "{}"
  );

  const formData: FormData = {
    entityType:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-1") || "{}")
        ?.entityType || "",
    packageType:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-1") || "{}")
        ?.packageType || "",
    ...
    companyName:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-2") || "{}")
        ?.companyName || "",
    designator:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-2") || "{}")
        ?.designator || "",
    ...
    industryKeyword:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-2") || "{}")
        ?.industryKeyword || "",
    stateFillingTime:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-3") || "{}")
        ?.stateFillingTime || "",
    clientEmail:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-4") || "{}")
        ?.clientEmail || "",
    clientFirstName:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-4") || "{}")
        ?.clientFirstName || "",
    ...
    companyAddressOption:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-5") || "{}")
        ?.addressOption || "",
    ...
    premiumServicePackage:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-6") || "{}")
        ?.premiumServicePackage === true
        ? 1
        : 0,
    memberNumber:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-7") || "{}")
        ?.memberNumber || 0,
    members: JSON.stringify(
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-7") || "{}")?.members ||
        ""
    ),
    president:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-7") || "{}")
    ...
    vicePresident:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-7") || "{}")
        ?.vicePresident || "",
    agentOption:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-8") || "{}")
        ?.agentOption || "",
    ...
    isForeign:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-9") || "{}")
        ?.isForeign === true
        ? 1
        : 0,
    einFirstName:
    ...
    einLastName:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-9") || "{}")
        ?.getLastName || "",
    idType:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-9") || "{}")?.idType ||
      "",
    idTypeNumber:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-9") || "{}")?.ein || "",
    ...
    useBank:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-10") || "{}")
        ?.useBank === true
        ? 1
        : 0,
    taxConsultationOption:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-11") || "{}")
        ?.taxConsultationOption || "",
    licenseType:
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-12") || "{}")
        ?.licenseType || "",
    ...
    sharePrice: JSON.parse(localStorage.getItem("/start-a-nonprofit/step-7-1") || "{}")
      ?.sharePrice || 0,
    shareNumber: JSON.parse(
      localStorage.getItem("/start-a-nonprofit/step-7-1") || "{}"
    )?.shareNumber || 0,
    shareholderNumber: JSON.parse(
      localStorage.getItem("/start-a-nonprofit/step-7-1") || "{}"
    ).memberNumber || 0,
    shareholderMembers: JSON.stringify(
      JSON.parse(localStorage.getItem("/start-a-nonprofit/step-7-1") || "{}")?.members ||
        ""
    ),
  };
  ...
  try {
    ...
    const step1Data = JSON.parse(localStorage.getItem("/start-a-nonprofit/step-1") || "{}");
    const step2Data = JSON.parse(localStorage.getItem("/start-a-nonprofit/step-2") || "{}");

    console.log("Nonprofit submit: starting core submit", { hasUserId: !!formDataWithUserId.userId });

    // 1) Always submit the core form first
    const formSubmitResponse = await axios.post(
      "/api/mysql/form-nonprofit",
      formDataWithUserId,
      {
        headers: {
    ...
    if (!formSubmitResponse || (formSubmitResponse.status && formSubmitResponse.status >= 400) || formSubmitResponse?.data?.success === false) {
      console.error("Nonprofit core submit failed; skipping payments/orders/applications:", formSubmitResponse);
    ...
    console.log("Nonprofit submit: clearing storage and returning success");
    localStorage.removeItem("/start-a-nonprofit/step-1");
    localStorage.removeItem("/start-a-nonprofit/step-2");
    localStorage.removeItem("/start-a-nonprofit/step-3");
    localStorage.removeItem("/start-a-nonprofit/step-4");
    localStorage.removeItem("/start-a-nonprofit/step-5");
    localStorage.removeItem("/start-a-nonprofit/step-6");
    localStorage.removeItem("/start-a-nonprofit/step-7");
    localStorage.removeItem("/start-a-nonprofit/step-7-1");
    localStorage.removeItem("/start-a-nonprofit/step-8");
    localStorage.removeItem("/start-a-nonprofit/step-9");
    localStorage.removeItem("/start-a-nonprofit/step-10");
    localStorage.removeItem("/start-a-nonprofit/step-11");
    localStorage.removeItem("/start-a-nonprofit/step-12");
